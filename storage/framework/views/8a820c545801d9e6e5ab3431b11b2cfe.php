...
<?php $__env->startSection('page-breadcrumb', __('Events,Publish')); ?>
...
<div class="card shadow-sm border-0">
    ...
    <div class="card-body">
        ...
        <form method="POST" action="<?php echo e(route('churchmeet.events.publishAction', $event->id)); ?>">
            <?php echo csrf_field(); ?>

            <div class="row">
                <!-- Ã¢Å“â€¦ Searchable Members -->
                ...
                <!-- Ã¢Å“â€¦ Searchable WhatsApp Groups -->
                <div class="col-md-6 mb-3">
                    <label class="form-label fw-bold">
...
<!-- Ã¢Å“â€¦ Select2 (CDN version, no extra setup needed) -->
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\ChurchMeet\src\Resources\views\attendance\events\publish.blade.php ENDPATH**/ ?>