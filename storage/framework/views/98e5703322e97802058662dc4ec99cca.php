                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <div class="d-flex align-items-center justify-content-between status-block">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($linkExists): ?>
                    ...
                    <div class="mb-4">
                        <div class="d-flex align-items-center justify-content-between status-block">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($targetExists): ?>
                                <span class="badge bg-success"><?php echo e(__('Exists')); ?></span>
                            <?php else: ?>
                                <span class="badge bg-warning text-dark"><?php echo e(__('Missing')); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            ...
                            <div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dbOk): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($logTail)): ?>
                        <hr class="section-divider"/>
                        <div class="small text-muted mb-1"><?php echo e(__('Last 100 log lines')); ?></div>
                        <pre class="small log-tail"><?php echo e($logTail); ?></pre>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\resources\views/superadmin/troubleshoot/index.blade.php ENDPATH**/ ?>