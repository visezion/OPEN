...
<?php $__env->startSection('page-action'); ?>
     <?php if (app('laratrust')->hasPermission('discipleship manage')) : ?>
...
<?php $__env->startSection('page-title', __('Discipleship Setup Wizard')); ?>
...
<div class="row">
    ...
    <div class="col-sm-9">
        <div class="card shadow-sm">
            <div class="card-body">
                <h5 class="mb-3"><i class="ti ti-flag text-primary"></i> <?php echo e(__('Setup Discipleship Pathway')); ?></h5>
                <p class="text-muted small mb-4">
                    <?php echo e(__('Create discipleship stages and their requirements. Each stage represents a key step in a member’s spiritual growth journey. You can add as many stages and requirements as your church needs.')); ?>

                </p>

                <form action="<?php echo e(route('discipleship.setup.save')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div id="wizard-stages">
                        ...
                        <div class="stage-template mb-4 border p-3 rounded bg-light">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h6 class="mb-2"><?php echo e(__('Stage')); ?> <span class="stage-number">1</span></h6>
                                <button type="button" class="btn btn-sm btn-outline-danger remove-stage d-none">
                                    <i class="ti ti-trash"></i> <?php echo e(__('Remove Stage')); ?>
                            ...
                            <div class="requirements">
                                ...
                                <div class="requirement-template mb-3 p-2 border rounded">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <small class="fw-bold"><?php echo e(__('Requirement')); ?></small>
                    ...
                    <button type="button" class="btn btn-outline-success mb-3" id="add-stage">
                        <i class="ti ti-plus"></i> <?php echo e(__('Add Stage')); ?>

                    </button>

                    <button type="submit" class="btn btn-primary w-100">
                        <i class="ti ti-check"></i> <?php echo e(__('Save Pathway')); ?>
    ...
    <div class="col-sm-3">
        <div class="card shadow-sm">
            <div class="card-body">
                <h6 class="fw-bold mb-2"><i class="ti ti-info-circle text-primary"></i> <?php echo e(__('How to Use the Wizard')); ?></h6>
                <p class="small text-muted">
                    <?php echo e(__('This wizard helps pastors and admins build a discipleship pathway tailored to their church. Each stage is a major milestone in spiritual growth, and each requirement defines what members must complete before progressing.')); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\discipleship\setup.blade.php ENDPATH**/ ?>