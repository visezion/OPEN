...
<head>
    ...
    <?php if(!empty($company_settings['site_rtl']) == 'on'): ?>
        <link rel="stylesheet" href="<?php echo e(asset('assets/css/style-rtl.css')); ?>">
    <?php endif; ?>
    <?php if(!empty($company_settings['cust_darklayout']) && $company_settings['cust_darklayout'] == 'on'): ?>
...
<body class=<?php echo e(!empty($company_settings['color']) ? $company_settings['color'] : 'theme-1'); ?>>
    ...
    <?php if(!empty($admin_settings['enable_cookie']) && $admin_settings['enable_cookie'] == 'on'): ?>
