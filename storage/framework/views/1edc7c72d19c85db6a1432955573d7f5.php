...
<head>
    <meta charset="utf-8">
    <title><?php echo e($event->title); ?> Ã¢â‚¬â€ Event Report</title>
    <style>
        /* ======== GLOBAL STYLES ======== */
        body {
...
<body>
    ...
    <div class="meta">
        ...
        <p><strong>Venue:</strong> <?php echo e($event->venue ?? '-'); ?></p>
         <p><strong>Date:</strong> <?php echo e($event->start_time ? date('d M Y', strtotime($event->start_time)) : 'Ã¢â‚¬â€'); ?></p>
        <p><strong>Start Time:</strong> <?php echo e($event->start_time ? date('h:i A', strtotime($event->start_time)) : 'Ã¢â‚¬â€'); ?></p>
        <p><strong>End Time:</strong> <?php echo e($event->end_time ? date('h:i A', strtotime($event->end_time)) : 'Ã¢â‚¬â€'); ?></p>
        <p><strong>Recurrence:</strong> <?php echo e(ucfirst($event->recurrence ?? 'none')); ?></p>
    ...
    <table>
        ...
        <tbody>
            ...
            ?>
            <?php $__currentLoopData = $event->programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <tr>
                    ...
                    <td><?php echo e($p->duration); ?> min</td>
