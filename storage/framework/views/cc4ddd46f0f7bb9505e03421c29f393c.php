...
<?php $__env->startSection('page-title'); ?>
    Review Event: <?php echo e($event->title); ?>
    ...
    <div class="card-body">
        ...
        <div class="mb-4">
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-6">
                    <p><strong>Start Time:</strong> <?php echo e($event->start_time ?? 'Not specified'); ?></p>
                    <p><strong>End Time:</strong> <?php echo e($event->end_time ?? 'Not specified'); ?></p>
        ...
        <div class="mb-5">
            ...
            <?php if($event->programs->count() > 0): ?>
                <table class="table table-hover table-bordered align-middle mt-2">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $event->programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
        ...
        <div class="mb-5">
            ...
            <form method="POST" action="<?php echo e(route('churchly.events.submitReview', $event->id)); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="text-end mt-4">
                    ...
                    <a href="<?php echo e(route('churchly.events.index')); ?>" class="btn btn-outline-secondary px-4 ms-2">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\attendance\events\review.blade.php ENDPATH**/ ?>