                ...
                <?php echo e(Form::model($department, ['route' => ['churchly.departments.update', $department->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate'])); ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                            <?php echo e(Form::select('branch_id', $branches, null, ['class' => 'form-control select', 'required'])); ?>
            ...
            <?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\departments\edit.blade.php ENDPATH**/ ?>