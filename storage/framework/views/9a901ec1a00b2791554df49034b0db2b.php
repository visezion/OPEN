<form method="POST" action="<?php echo e(route('app-builder.saveFeatures')); ?>">
    ...
    <div class="row">
        ...
        <?php $__currentLoopData = $featureList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
