                ...
                <div class="dashboard-card">
                    ...
                    <div class="card-inner">
                        <div class="card-content">
                            ...
                            <p><?php echo e(__('The keys to the kingdom are in your hands – welcome to your Super Admin Dashboard!')); ?></p>
                            <div class="btn-wrp d-flex gap-3">
                                <a href="javascript:" class="btn btn-primary d-flex align-items-center gap-1 cp_link" tabindex="0" data-link="<?php echo e(url('/')); ?>" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="" data-bs-original-title="Click to copy site link">
                                    <i class="ti ti-link text-white"></i>
                                <span> <?php echo e(__('Landing Page')); ?></span></a>
                ...
                <div class="dashboard-project-card">
                    <div class="card-inner  d-flex justify-content-between">
                        <div class="card-content">
                            ...
                            <a href="<?php echo e(route('users.index')); ?>"><h3 class="mt-3 mb-0 text-danger"><?php echo e(__('Total Customers')); ?></h3></a>
                            <h6 class="text-danger pt-3"><?php echo e(__('Paid Customers')); ?> </h6>
                            <h4 class="text-dark"><?php echo e($user['total_paid_user']); ?></h4>
                        </div>
                ...
                <div class="dashboard-project-card">
                    <div class="card-inner  d-flex justify-content-between">
                        <div class="card-content">
                            ...
                            <a href="<?php echo e(route('plan.order.index')); ?>"><h3 class="mt-3 mb-0"><?php echo e(__('Total Orders')); ?></h3></a>
                             <h6 class="text-primary pt-3"><?php echo e(__('Order Amount')); ?></h6>
                             <h4 class="text-dark"><?php echo e(super_currency_format_with_sym($user['total_orders_price'])); ?></h4>
                        </div>
                ...
                <div class="dashboard-project-card">
                    <div class="card-inner  d-flex justify-content-between">
                        <div class="card-content">
                            ...
                            <a href="<?php echo e(route('plan.list')); ?>"><h3 class="mt-3 mb-0"><?php echo e(__('Total Plans')); ?></h3></a>
                            <h6 class="text-warning mt-2"><?php echo e(__('Popular Plan')); ?></h6>
                            <h4 class="text-dark"><?php echo e(!empty($user->popular_plan) ? $user->popular_plan->name : ''); ?></h4>
                        </div>
                        <h3 class="mb-0"><?php echo e($user->total_plans); ?></h3>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>