...
<?php $__env->startSection('page-title', __('Create Church Member')); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group mb-3 text-center">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-primary" onclick="document.getElementById('profile-photo-input').click()">
                                <i class="ti ti-upload"></i> <?php echo e(__('Choose Photo')); ?>
...
<?php endif; ?>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <?php echo e(Form::date('dob', null, ['class' => 'form-control', 'max' => date('Y-m-d')])); ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                            <?php echo e(Form::select('gender', ['Male'=>'Male','Female'=>'Female','Other'=>'Other'], null, ['class'=>'form-control','required'])); ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                            <?php echo e(Form::text('emergency_contact', null, [
                        ...
                        <div class="form-group mb-3">
                            <?php echo e(Form::label('emergency_phone', __('Emergency Contact Phone Number'))); ?><?php if (isset($component)) { $__componentOriginalbba606fec37ea04333bc269e3e165587 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbba606fec37ea04333bc269e3e165587 = $attributes; } ?>
<?php $component = App\View\Components\Required::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                            <?php echo e(Form::text('emergency_phone', null, [
                                'class'=>'form-control','required',
                        ...
                        <div class="form-group mb-3">
                            ...
                            <?php echo e(Form::select('family_id', $members, null, [
                                'class'=>'form-control',
                        ...
                        <div class="form-group mb-3">
                            ...
                            <?php echo e(Form::select('spouse_id', $members, null, [
                                'class'=>'form-control',
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <?php echo e(Form::select('membership_status', ['Active'=>'Active','Inactive'=>'Inactive','Visitor'=>'Visitor','New Convert'=>'New Convert'], 'Active', ['class'=>'form-control'])); ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                            <?php echo e(Form::select('role', $role, null, ['class'=>'form-control','required','placeholder'=>'Select Role'])); ?>

                        </div>
                        <div class="form-group mb-3">
                            <?php echo e(Form::label('church_doj', __('Date of Joining'))); ?>

                            <?php echo e(Form::date('church_doj', now()->toDateString(), ['class'=>'form-control','max'=>date('Y-m-d')])); ?>

                        </div>
                        <div class="form-group mb-3">
                            <?php echo e(Form::label('is_active', __('Account Status'))); ?>

                            <?php echo e(Form::select('is_active', ['1'=>'Active','0'=>'Inactive'], '1', ['class'=>'form-control'])); ?>
                            ...
                            <?php $__currentLoopData = $customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <?php if($field->field_type == 'text'): ?>
                                        <?php echo e(Form::text("custom[{$field->field_key}]", null, ['class'=>'form-control'])); ?>

                                    <?php elseif($field->field_type == 'textarea'): ?>
                                        <?php echo e(Form::textarea("custom[{$field->field_key}]", null, ['class'=>'form-control','rows'=>2])); ?>

                                    <?php elseif($field->field_type == 'date'): ?>
                                        <?php echo e(Form::date("custom[{$field->field_key}]", null, ['class'=>'form-control'])); ?>
                                    ...
                                    <?php elseif($field->field_type == 'dropdown'): ?>
                                        <select name="custom[<?php echo e($field->field_key); ?>]" class="form-control">
                                            ...
                                            <?php $__currentLoopData = explode(',', $field->field_value); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e(trim($opt)); ?>"><?php echo e(trim($opt)); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    <?php elseif($field->field_type == 'checkbox'): ?>
                                        <div class="form-check">
                                            <input type="checkbox" name="custom[<?php echo e($field->field_key); ?>]" value="1" class="form-check-input">
                ...
                <div class="d-flex justify-content-between mt-4">
                    ...
                    <button type="submit" class="btn btn-primary"><?php echo e(__('Create Member')); ?></button>
                </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('add-department').addEventListener('click', function () {
            ...
            // If branch is already selected → fetch departments for new row
        ...
        // Branch change → reload all departments in all rows
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Providers/../Resources/views/members/create.blade.php ENDPATH**/ ?>