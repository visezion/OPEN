                                    ...
                                    <tr>
                                        <td>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event): ?>
                                                <a href="<?php echo e(route('churchmeet.events.show', optional($event)->public_view_key ?? $attendanceEvent->event_id)); ?>" 
                                                class="fw-semibold text-primary text-decoration-none">
                                                    <?php echo e($event->title ?? __('N/A')); ?>
            ...
            <div class="card-body small">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentAttendance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $att): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="alert alert-<?php echo e($att->mode == 'online' ? 'info' : ($att->mode == 'hybrid' ? 'warning' : 'success')); ?> py-2 mb-2">
                        ...
                        <strong><?php echo e($recentEvent->title ?? 'Unnamed Event'); ?></strong><br>
                        <span class="text-muted">
                            <?php echo e($recentEventDate ? __('Scheduled for :date', ['date' => $recentEventDate]) : __('Date not set')); ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\ChurchMeet\src\Providers/../Resources/views/attendance/attendance_events/index.blade.php ENDPATH**/ ?>