...
<body>
    ...
    <div class="meta">
        ...
        <p><strong>Venue:</strong> <?php echo e($event->venue ?? '-'); ?></p>
         <p><strong>Date:</strong> <?php echo e($event->start_time ? date('d M Y', strtotime($event->start_time)) : '—'); ?></p>
        <p><strong>Start Time:</strong> <?php echo e($event->start_time ? date('h:i A', strtotime($event->start_time)) : '—'); ?></p>
        <p><strong>End Time:</strong> <?php echo e($event->end_time ? date('h:i A', strtotime($event->end_time)) : '—'); ?></p>
