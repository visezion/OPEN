...
<?php $__env->startSection('page-breadcrumb', __('YouTube Sync')); ?>
...
<div class="row">
  <div class="col-lg-6">
    <div class="card shadow-sm mb-3">
      ...
      <div class="card-body">
        <form method="POST" action="<?php echo e(route('churchmeet.youtube.save')); ?>"><?php echo csrf_field(); ?>
          <div class="mb-3">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <select class="form-select" name="interval_minutes">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [5,15,30,60,120,360,720,1440]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  ...
  <div class="col-lg-6">
    <div class="card shadow-sm mb-3">
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="<?php echo e(url('api/v1/churchmeet/youtube/videos')); ?>" target="_blank" class="btn btn-sm btn-outline-secondary"><?php echo e(__('Open API')); ?></a>
      </div>
      <div class="card-body">
        <div class="list-group">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <a href="https://www.youtube.com/watch?v=<?php echo e($v->youtube_video_id); ?>" class="list-group-item list-group-item-action d-flex" target="_blank">
              <img src="<?php echo e($v->thumbnail_url); ?>" class="me-2 churchmeet-video-thumb" alt="thumb">
              <div>
                <div class="fw-semibold"><?php echo e($v->title); ?></div>
                <small class="text-muted"><?php echo e(optional($v->published_at)->diffForHumans()); ?> Ã¢â‚¬Â¢ <?php echo e($v->live_broadcast_content ?: 'video'); ?></small>
              </div>
            </a>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\ChurchMeet\src\Resources\views\integrations\youtube.blade.php ENDPATH**/ ?>