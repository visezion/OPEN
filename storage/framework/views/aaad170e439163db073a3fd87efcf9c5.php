...
<div class="card shadow-sm">
  <div class="card-body">
    ...
    <pre class="bg-light p-3 rounded small"><?php echo e(url('/')); ?>/api/v1/churchly</pre>
    ...
    <pre class="bg-dark text-white p-3 rounded small"><code>curl -X POST "<?php echo e(url('/api/v1/churchly/login')); ?>" \
...
# => { "status":"success", "token": "&lt;SANCTUM_TOKEN&gt;" }</code></pre>
    ...
    <pre class="bg-dark text-white p-3 rounded small"><code>curl "<?php echo e(url('/api/v1/churchly/churches')); ?>"
...
curl "<?php echo e(url('/api/v1/churchly/church/demo/config')); ?>"
...
curl "<?php echo e(url('/api/v1/churchly/church/demo/config')); ?>" \
  ...
  "data": {
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <pre class="bg-dark text-white p-3 rounded small"><code>curl "<?php echo e(url('/api/v1/churchly/theme')); ?>"</code></pre>
      </div>
      <div class="col-md-6">
        <p>Update theme (requires Bearer token):</p>
        <pre class="bg-dark text-white p-3 rounded small"><code>curl -X PUT "<?php echo e(url('/api/v1/churchly/theme')); ?>" \
  -H "Content-Type: application/json" \
  ...
  -d '{
    ...
    <pre class="bg-dark text-white p-3 rounded small"><code>curl "<?php echo e(url('/api/v1/churchly/layouts')); ?>"
curl "<?php echo e(url('/api/v1/churchly/layout/home')); ?>"</code></pre>
...
curl "<?php echo e(url('/api/v1/churchly/members')); ?>" -H "Authorization: Bearer &lt;SANCTUM_TOKEN&gt;"

# Update my profile
curl -X PUT "<?php echo e(url('/api/v1/churchly/member/profile')); ?>" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer &lt;SANCTUM_TOKEN&gt;" \
  ...
  "<?php echo e(url('/api/v1/churchly/attendance/gps-checkin')); ?>"</code></pre>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\api\docs.blade.php ENDPATH**/ ?>