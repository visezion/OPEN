<?php echo e(Form::open(array('url' => 'chart-of-account', 'class'=>'needs-validation', 'novalidate'))); ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
            <?php echo e(Form::number('code', '', array('class' => 'form-control','required'=>'required','placeholder' => 'Enter Code'))); ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
            <?php echo e(Form::select('sub_type', $account_type, null, ['class' => 'form-control select', 'placeholder' => 'Please select', 'required' => 'required'])); ?>
...
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Account\src\Resources\views\chartOfAccount\create.blade.php ENDPATH**/ ?>