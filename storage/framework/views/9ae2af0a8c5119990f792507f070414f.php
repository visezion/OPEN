        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <?php echo e(Form::textarea('feature_description', null, ['class' => 'summernote form-control', 'placeholder' => __('Enter Description'), 'id'=>'feature_des','required'=>'required'])); ?>
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <?php echo e(Form::text('feature_more_details_link',null, ['class' => 'form-control ', 'placeholder' => __('Enter Details Link'),'required'=>'required'])); ?>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <?php echo e(Form::text('feature_more_details_button_text',null, ['class' => 'form-control', 'placeholder' => __('Enter Button Text')])); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\LandingPage\src\Resources\views\landingpage\details\features\create.blade.php ENDPATH**/ ?>