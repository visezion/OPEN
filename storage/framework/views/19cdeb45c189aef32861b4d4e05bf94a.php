                                        ...
                                        <div class="dropdown-menu dropdown-menu-end pointer">
                                            ...
                                            <?php if(module_is_active('EInvoice')): ?>
                                                <?php if (app('laratrust')->hasPermission('download invoice')) : ?>
                                                    <?php echo $__env->make('einvoice::download.grid_generate_invoice',['invoice_id'=>$invoice->id], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <?php endif; // app('laratrust')->permission ?>
                                            <?php endif; ?>
                                            ...
                                            <?php endif; // app('laratrust')->permission ?>
                                            <?php if(module_is_active('ProductService') && $invoice->invoice_module == 'taskly' ? module_is_active('Taskly') : module_is_active('Account')): ?>
                                    ...
                                    <div class="project-card-content">
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex align-items-center gap-2 user-image">
                                                <?php if(\Auth::user()->type != 'client'): ?>
                                                    <?php if(!empty($invoice->customers)): ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\resources\views\invoice\grid.blade.php ENDPATH**/ ?>