        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(admin_setting('custome_package') == 'on' && admin_setting('plan_package') == 'on'): ?>
                <div class="tab-head-row">
                    <ul class="tabs d-flex justify-content-center">
                        <li>
                            <a href="<?php echo e(route('apps.pricing.plan')); ?>" class="nav-link " ><?php echo e(__('Pre-Packaged Subscription')); ?></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apps.pricing')); ?>" class="nav-link active" ><?php echo e(__('Usage Subscription')); ?></a>
                        </li>
                    </ul>
            </div>
                                                    ...
                                                    <div class="product-img">
                                                        <div class="theme-avtar">
                                                            <a
                                                                ...
                                                                <img src="<?php echo e(get_module_img($module->name)); ?>"
                                                        ...
                                                        <div class="checkbox-custom">
                                                            <input type="checkbox" id="<?php echo e('checkbox-' . $key); ?>"
                                                                ...
                                                                data-module-img="<?php echo e(get_module_img($module->name)); ?>"
                                                    ...
                                                    <div class="product-content">
                                                        ...
                                                        <div class="price d-flex justify-content-between">
                                                            <ins class="m-price-monthly"><span
                                                                    class="currency-type"><?php echo e(super_currency_format_with_sym($module->monthly_price)); ?></span>
                                                                <span
                                                                    class="time-lbl text-muted"><?php echo e(__('/Month')); ?></span></ins>
                                                            <ins class="m-price-yearly d-none"><span
                                                                    class="currency-type"><?php echo e(super_currency_format_with_sym($module->yearly_price)); ?></span>
                                                                <span
                                    ...
                                    <li>
                                        <span class="cart-sum-left">
                                            <h6 class="mb-0"><?php echo e(__('Workspace')); ?> <small
                                                    class="text-muted workspace-price"><?php echo e('( '. __('Per Workspace') . super_currency_format_with_sym($workspaceprice) . ' )'); ?></small>
                                            </h6>
                                        </span>
                                        <span class="cart-sum-right"><b
...
<?php echo $__env->make($layout, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\LandingPage\src\Resources\views\layouts\pricing.blade.php ENDPATH**/ ?>