<?php echo e(Form::open(['url' => 'bank-account', 'class'=>'needs-validation', 'novalidate'])); ?>

<div class=modal-body>
    <div class="row">
        <div class="form-group col-md-12">
            <label class="require form-label"><?php echo e(__('Bank Type')); ?></label><?php if (isset($component)) { $__componentOriginalbba606fec37ea04333bc269e3e165587 = $component; } ?>
                ...
                <?php $__currentLoopData = $chartAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $chartAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php $__currentLoopData = $subAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($key == $subAccount['account']): ?>
                            <option value="<?php echo e($subAccount['id']); ?>" class="ms-5"> &nbsp; &nbsp;&nbsp; <?php echo e($subAccount['code']); ?> - <?php echo e($subAccount['name']); ?></option>
                        <?php endif; ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                <?php echo e(Form::text('bank_name', null, ['class' => 'form-control', 'placeholder' => __('Enter Bank Name') , 'required' => 'required'])); ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                <?php echo e(Form::number('opening_balance', '', ['class' => 'form-control', 'required' => 'required','min' => '0','step'=>'0.1','placeholder' => __('Enter Opening Balance')])); ?>
...
<?php $component = App\View\Components\Mobile::resolve(['divClass' => 'col-lg-6 col-md-6 col-sm-6 bank','name' => 'contact_number','label' => ''.e(__('Contact Number')).'','placeholder' => ''.e(__('Enter Contact Number')).'','id' => 'contact_number','required' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                <?php echo e(Form::text('bank_branch', '', array('class' => 'form-control', 'required' => 'required', "min"=>"0",'placeholder' => __('Enter Bank Branch')))); ?>
        ...
        <div class="col-md-6 bank">
            <div class="form-group">
                ...
                <?php echo e(Form::text('swift', '', ['class' => 'form-control', 'id' => 'swift' ,'placeholder' => __('Enter Swift Number')])); ?>
...
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Account\src\Resources\views\bankAccount\create.blade.php ENDPATH**/ ?>