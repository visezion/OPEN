...
<?php switch($t):
  ...
  <?php case ('quick_links'): ?>
    <div class="row g-2">
      <div class="col-md-12"><textarea class="form-control" rows="2" name="widgets[<?php echo e($i); ?>][links_text]" placeholder="Title|ti ti-icon|target per line"><?php if(!empty($c['links']) && is_array($c['links'])): ?><?php $__currentLoopData = $c['links']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e(($l['title']??'')); ?>|<?php echo e(($l['icon_name']??'')); ?>|<?php echo e(($l['target']??'')); ?>

<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <?php endif; ?></textarea></div>
    </div>
    <?php break; ?>
