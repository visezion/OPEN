        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($requestEntry->delivery_preference === 'delivery'): ?>
                        <div class="mb-3">
                            <strong><?php echo e(__('Delivery address')); ?></strong>
                            <p><?php echo e($requestEntry->delivery_address ?? __('Not provided')); ?></p>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($requestEntry->delivery_map): ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\FoodBank\src\Resources\views\requests\show.blade.php ENDPATH**/ ?>