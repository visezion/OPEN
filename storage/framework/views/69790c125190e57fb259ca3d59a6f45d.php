<?php $__env->startSection('page-title', __('Church Events/Meetings')); ?>
...
<?php $__env->startSection('page-action'); ?>
    <a href="<?php echo e(route('churchmeet.events.create')); ?>" class="btn btn-sm btn-primary">
        <i class="ti ti-plus"></i> <?php echo e(__('Add New Events/Meetings')); ?>

    </a>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
<div class="row church-events-page">
    
    <div class="col-lg-9">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-light d-flex justify-content-between align-items-center py-3">
                <div>
                    <h5 class="mb-0 fw-bold"><?php echo e(__('Upcoming & Past Events/Meetings')); ?></h5>
                    <small class="text-muted"><?php echo e(__('View, manage, and organize all your church events and meetings in one place.')); ?></small>
                </div>
            ...
            <div class="card-body">
                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-inline-flex flex-wrap gap-1 justify-content-center" role="group" aria-label="<?php echo e(__('Event actions')); ?>">
                                            <a href="<?php echo e(route('churchmeet.events.approve', $event->id)); ?>" class="btn btn-sm btn-outline-success" title="<?php echo e(__('View Approval')); ?>">
                                            ...
                                            <a href="<?php echo e(route('churchmeet.events.edit', $event->id)); ?>" class="btn btn-sm btn-outline-secondary" title="<?php echo e(__('Edit Events/Meetings')); ?>">
                                                <i class="ti ti-pencil"></i>
                                            </a>
                                            <form action="<?php echo e(route('churchmeet.events.destroy', $event->id)); ?>" 
                                                method="POST" 
                ...
                <?php else: ?>
                    <div class="text-center py-5">
                        ...
                        <a href="<?php echo e(route('churchmeet.events.create')); ?>" class="btn btn-primary mt-2">
    ...
    <div class="col-lg-3 mt-4 mt-lg-0">
        ...
        <div class="card border-0 shadow-sm mb-3">
            <div class="card-header  text-white py-2">
                <h5 class="mb-0"><i class="ti ti-bulb"></i> <?php echo e(__('Instruction & Tips')); ?></h5>
            </div>
            <div class="card-body small text-muted">
                <ul class="ps-3 mb-0">
                    <li><?php echo e(__('Use the Filter bar to quickly find specific events by type or date.')); ?></li>
                    <li><?php echo e(__('Click View to open full event details including description and participants.')); ?></li>
                    <li><?php echo e(__('Use Edit to update the event date, time, or venue.')); ?></li>
                    <li><?php echo e(__('Only delete an event if it is canceled. This action cannot be undone.')); ?></li>
                    <li><?php echo e(__('Completed or past events are automatically archived in the database.')); ?></li>
                </ul>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-light py-2 d-flex align-items-center justify-content-between">
                    ...
                    <a href="<?php echo e(route('churchmeet.events.index')); ?>" class="text-muted small"><?php echo e(__('View All')); ?></a>
                </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="alert alert-<?php echo e($event->event_type == 'worship' ? 'info' : 
                            ...
                            <span class="text-muted">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event->time): ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\ChurchMeet\src\Providers/../Resources/views/attendance/events/index.blade.php ENDPATH**/ ?>