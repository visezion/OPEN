        ...
        <form id="setting-form" method="post" action="<?php echo e(route('bill.template.setting')); ?>"
            ...
            <div class="card-body p-3">
                <div class="row row-gap">
                    ...
                    <div class="col-md-8">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($settings['bill_template']) && !empty($settings['bill_color'])): ?>
