                ...
                <div class="row">
                    ...
                    <div class="col-xxl-8">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::textarea('bill_footer_notes', !empty($settings['bill_footer_notes']) ? $settings['bill_footer_notes'] : '', ['class' => 'form-control', 'rows' => '2', 'placeholder' => 'Enter Bill Footer Notes'])); ?>
                ...
                <div class="row row-gap">
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body p-2">
                                <div class="form-group d-flex align-items-center justify-content-between mb-0">
                                    <?php echo e(Form::label('bill_shipping_display', __('Shipping Display?'), ['class' => 'form-label mb-0'])); ?>

                                    <div class="text-end form-check form-switch d-inline-block">
                                        <input type="checkbox" class="form-check-input"
                                        name="bill_shipping_display" id="bill_shipping_display"
                                        <?php echo e((isset($settings['bill_shipping_display']) ? $settings['bill_shipping_display'] : 'off') == 'on' ? 'checked' : ''); ?>>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body p-2">
                                <div class="form-group d-flex align-items-center justify-content-between mb-0">
                                    <?php echo e(Form::label('bill_qr_display', __('QR Display?'), ['class' => 'form-label mb-0'])); ?>

                                    <div class="text-end form-check form-switch d-inline-block">
                                        <input type="checkbox" class="form-check-input"
                                        name="bill_qr_display" id="bill_qr_display"
                                        <?php echo e((isset($settings['bill_qr_display']) ? $settings['bill_qr_display'] : 'off') == 'on' ? 'checked' : ''); ?>>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body p-2">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('bill_template', Workdo\Account\Entities\AccountUtility::templateData()['templates'], !empty($settings['bill_template']) ? $settings['bill_template'] : null, ['class' => 'form-control', 'required' => 'required'])); ?>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-2">
                                <?php $__currentLoopData = Workdo\Account\Entities\AccountUtility::templateData()['colors']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="card">
                            <div class="card-header p-2">
                                <h3 class="h6 mb-0"><?php echo e(__('Bill Logo')); ?></h3>
                            </div>
                            <div class="card-body setting-card setting-logo-box p-3">
                                <div class="logo-content img-fluid logo-set-bg  text-center">
                                    <img alt="image" src="<?php echo e(isset($settings['bill_logo']) ? get_file($settings['bill_logo']) : get_file($logo_dark)); ?>" id="pre_default_logo4">
                                </div>
...
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Account\src\Resources\views\company\settings\index.blade.php ENDPATH**/ ?>