                ...
                <form method="POST" action="<?php echo e(route('churchly.care.communications.store')); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="channel" class="form-select" required>
                            <?php $__currentLoopData = ['email','sms','call','visit','other']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $channel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\care\communications\index.blade.php ENDPATH**/ ?>