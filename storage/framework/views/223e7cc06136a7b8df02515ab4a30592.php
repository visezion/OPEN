                ...
                <form method="POST" action="<?php echo e(route('churchly.care.notes.store')); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="visibility" class="form-select" required>
                            <?php $__currentLoopData = ['staff','pastoral','leaders','private']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\care\notes\index.blade.php ENDPATH**/ ?>