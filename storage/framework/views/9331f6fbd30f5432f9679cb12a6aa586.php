                                ...
                                <div class="">
                                    ...
                                    <div class="cart-footer-total-row bg-primary text-white rounded p-3 d-flex align-items-center justify-content-between">
                                        <div class="mini-total-price">
                                            <div class="price">
                                                <h3 class="text-white mb-0 total"><?php echo e(super_currency_format_with_sym($planprice)); ?></h3>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        $(document).ready(function() {
            ...
            $(".total").text(formatCurrency(planprice,'<?php echo e($currency_setting); ?>'));
        });
                    ...
                    success: function(data)
                    {
                        if (data != '' ) {
                            if (data.is_success == true) {
                                    ...
                                    planprice = '<?php echo e($planpriceyearly); ?>'; // Use yearly price if switch is ON
                                    }

                                    $('.total').html('<span class="original-price">' + formatCurrency(planprice,'<?php echo e($currency_setting); ?>')+ '</span> / ' + '<span class="">'+finalPrice + '</span>');
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\resources\views\plans\planpayment.blade.php ENDPATH**/ ?>