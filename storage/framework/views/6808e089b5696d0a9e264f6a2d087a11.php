...
<head>
    ...
    <meta name="title" content="<?php echo e(!empty(admin_setting('meta_title')) ? admin_setting('meta_title') : config('app.name', 'Openzion')); ?>">
    <meta name="keywords" content="<?php echo e(!empty(admin_setting('meta_keywords')) ? admin_setting('meta_keywords') : 'ministry platform,church operations,faith teams'); ?>">
    <meta name="description" content="<?php echo e(!empty(admin_setting('meta_description')) ? admin_setting('meta_description') : 'Faith-aligned platform for church administration, ministry teams, and accountable service workflows.'); ?>">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo e(env('APP_URL')); ?>">
    <meta property="og:title" content="<?php echo e(!empty(admin_setting('meta_title')) ? admin_setting('meta_title') : config('app.name', 'Openzion')); ?>">
    <meta property="og:description" content="<?php echo e(!empty(admin_setting('meta_description')) ? admin_setting('meta_description') : 'Faith-aligned platform for church administration, ministry teams, and accountable service workflows.'); ?> ">
    ...
    <meta property="twitter:title" content="<?php echo e(!empty(admin_setting('meta_title')) ? admin_setting('meta_title') : config('app.name', 'Openzion')); ?>">
    <meta property="twitter:description" content="<?php echo e(!empty(admin_setting('meta_description')) ? admin_setting('meta_description') : 'Faith-aligned platform for church administration, ministry teams, and accountable service workflows.'); ?> ">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('packages/workdo/LandingPage/src/Resources/assets/custom/custom.css')); ?>">
...
<body class="<?php echo e(!empty($themeColor)?$themeColor:'theme-1'); ?>">
            ...
            <div class="container">
                <div class="footer-top">
                    ...
                    <div class="footer-top-right">
                        <ul>
                            <li>
                                <a href="<?php echo e($settings['footer_live_demo_link']); ?>" class="btn-secondary"><?php echo e($settings['footer_gotoshop_button_text']); ?><svg
                            ...
                            <li>
                                <a href="<?php echo e($settings['footer_support_link']); ?>" class="btn-link"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                        ...
                                        <path
                                            ...
                                            fill="#6FD943" />
                                    </svg><?php echo e($settings['footer_support_button_text']); ?></a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(admin_setting('enable_cookie') == 'on'): ?>
...
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\LandingPage\src\Resources\views\layouts\marketplace.blade.php ENDPATH**/ ?>