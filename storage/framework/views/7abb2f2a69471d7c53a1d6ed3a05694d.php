                            ...
                            <div class="col-xl-10">
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        ...
                                        <?php echo e(Form::select('status', [''=>'Select Status']+$status,isset($_GET['status'])?$_GET['status']:'', array('class' => 'form-control '))); ?>
                            ...
                            <div class="col-auto">
                                <div class="row">
                                    <div class="col-auto mt-4">
                                        ...
                                        <a href="<?php echo e(route('report.invoice.summary')); ?>" class="btn btn-sm btn-danger"
        ...
        <div class="row mt-3">
            <div class="col">
                ...
                <div class="card p-4 mb-4">
                    ...
                    <h6 class="report-text mb-0 mt-1"><?php echo e(__('Invoice Summary')); ?></h6>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xl-4 col-md-6 col-lg-4">
                <div class="card p-4 mb-4">
                    ...
                    <h6 class="report-text mb-0"><?php echo e(currency_format_with_sym($totalInvoice)); ?></h6>
                </div>
            </div>
            <div class="col-xl-4 col-md-6 col-lg-4">
                <div class="card p-4 mb-4">
                    <h5 class="report-text gray-text mb-0"><?php echo e(__('Total Paid')); ?></h5>
                    <h6 class="report-text mb-0"><?php echo e(currency_format_with_sym($totalPaidInvoice)); ?></h6>
                </div>
            </div>
            <div class="col-xl-4 col-md-6 col-lg-4">
                <div class="card p-4 mb-4">
                    <h5 class="report-text gray-text mb-0"><?php echo e(__('Total Due')); ?></h5>
                    <h6 class="report-text mb-0"><?php echo e(currency_format_with_sym($totalDueInvoice)); ?></h6>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="tab-pane fade fade" id="invoices" role="tabpanel" aria-labelledby="profile-tab3">
                                        <table class="table table-flush" id="report-dataTable">
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <tr>
                                                    <td class="Id">
                                                        <a href="<?php echo e(route('invoice.show',\Crypt::encrypt($invoice->id))); ?>" class="btn btn-outline-primary"><?php echo e(\App\Models\Invoice::invoiceNumberFormat($invoice->invoice_id)); ?></a>
                                                    </td>

                                                    <td><?php echo e(company_date_formate($invoice->send_date)); ?></td>
                                                    ...
                                                    <td> <?php echo e(\currency_format_with_sym($invoice->getTotal()-$invoice->getDue())); ?></td>
                                                    <td> <?php echo e(\currency_format_with_sym($invoice->getDue())); ?></td>
                                                    <td><?php echo e(!empty($invoice->lastPayments)?company_date_formate($invoice->lastPayments->date):''); ?></td>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Account\src\Resources\views\report\invoice_report.blade.php ENDPATH**/ ?>