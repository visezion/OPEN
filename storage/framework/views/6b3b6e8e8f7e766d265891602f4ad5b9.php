        ...
        <div class="card-body p-3">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="form-check">
                    ...
                    data-payment-action="<?php echo e(route('boutique.pay.payment.with.paypal',[$slug])); ?>">
                </div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Paypal\src\Resources\views\payment\boutique_payment.blade.php ENDPATH**/ ?>