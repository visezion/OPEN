...
<head>
    ...
    <title><?php echo $__env->yieldContent('page-title'); ?> | <?php echo e(!empty($admin_settings['title_text']) ? $admin_settings['title_text'] :'WorkDo-Dash'); ?></title>
...
<body class="<?php echo e(!empty($admin_settings['color'])?$admin_settings['color']:'theme-1'); ?>" >
    <!-- header start here -->
            ...
            <div class="footer-row">
                <div class="footer-col  about-site">
                    ...
                    <p><?php echo e(__('All Rights Reserved to')); ?><br>
                        <a href="https://workdo.io/"><?php echo e('WorkDo.io'); ?></a>
                    </p>
                </div>
