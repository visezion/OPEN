...
<?php endif; ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php if($bill->account_type == 'Accounting'): ?>
...
<?php endif; ?>
                                        ...
                                        <?php endif; ?>
                                        <?php if(module_is_active('Taskly') && $bill->account_type == 'Projects'): ?>
                                ...
                                <?php if(module_is_active('CustomField') && !$customFields->isEmpty()): ?>
                                    <div class="col-md-12">
                                        <div class="tab-pane fade show" id="tab-2" role="tabpanel">
                                            <?php echo $__env->make('custom-field::formBuilder',['fildedata' => !empty($bill->customField) ? $bill->customField : ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        </div>
                                    </div>
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Account\src\Resources\views\bill\edit.blade.php ENDPATH**/ ?>