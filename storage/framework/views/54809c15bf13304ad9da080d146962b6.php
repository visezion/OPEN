    ...
    <div class="invoice-preview-main" id="boxes" style="border-right:40px solid var(--theme-color);">
        <div class="invoice-header">
            <table class="vertical-align-top">
                <tbody>
                    <tr>
                        <td >
                            <h3 style="text-transform: uppercase; font-size: 40px; font-weight: bold; color: var(--theme-color); margin-bottom: 10px;"><?php echo e(__('PURCHASE')); ?></h3>
        ...
        <div class="invoice-body" style="padding-right: 0;">
            ...
            <div class="invoice-footer">
                <p> <?php echo e($settings['purchase_footer_notes']); ?></p>
                <h6><?php echo e($settings['purchase_footer_title']); ?></h6>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\OPEN\resources\views\purchases\templates\template9.blade.php ENDPATH**/ ?>