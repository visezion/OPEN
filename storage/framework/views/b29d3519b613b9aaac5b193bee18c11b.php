    ...
    <div class="row">
        ...
        <div class="row justify-content-center">
            <div class="col-sm-12 col-md-10 col-xxl-12 col-md-12">
                <div class="p-3 card m-0 company-tabs-wrp">
                    <ul class="nav nav-pills nav-fill" id="pills-tab" role="tablist">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $users_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <div class="tab-pane text-capitalize fade show <?php echo e($loop->index == 0 ? 'active' : ''); ?>"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(module_is_active('LMS')): ?>
                                    <div class="row my-2 " data-workspace-id =<?php echo e($workspace->id); ?>>
                                        <?php
                                            $stores = \Workdo\LMS\Entities\Store::where('workspace_id', $workspace->id)->first();
                                        ?>
                                        <div class="col-md-6 my-2">
...
<?php /**PATH C:\xampp\htdocs\OPEN\resources\views\users\companyinfo.blade.php ENDPATH**/ ?>