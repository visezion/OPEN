...
<div class="card shadow-sm p-4 text-center">
    ...
    <?php elseif($attendanceEvent->online_platform === 'livekit'): ?>
        <p class="mt-3">Join LiveKit Room: <a href="<?php echo e(route('churchmeet.meetings.join', $attendanceEvent->id)); ?>" target="_blank">Click Here</a></p>
