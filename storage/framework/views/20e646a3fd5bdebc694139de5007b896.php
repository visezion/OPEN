...
<div class="card shadow-sm p-4 text-center">
    ...
    <form action="<?php echo e(route('churchmeet.attendance.onlineCheckIn', $attendanceEvent->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <button type="submit" class="btn btn-success btn-lg">Ã¢Å“â€¦ I Am Here</button>
    </form>

    <?php if($attendanceEvent->online_platform === 'zoom'): ?>
...
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\ChurchMeet\src\Resources\views\attendance\check_in.blade.php ENDPATH**/ ?>