    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            <div class="d-flex align-items-end gap-2" style="height: 130px;">
                <?php $__currentLoopData = $dailyUsage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col-lg-6">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="list-group list-group-flush">
                        <?php $__currentLoopData = $slowRoutes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="list-group-item d-flex justify-content-between">
                                <div>
                                    <strong><?php echo e($route->route ?? __('(unnamed)')); ?></strong>
                                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive mt-3">
                        <table class="table table-sm mb-0">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $browserStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive mt-3">
                        <table class="table table-sm mb-0">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $deviceStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e($label); ?></td>
                                        <td><?php echo e($count); ?></td>
                                    </tr>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive mt-2">
                        <table class="table table-sm mb-0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $functionStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $func): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        <?php $__currentLoopData = $latestErrors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col-xl-6">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        <?php $__currentLoopData = $workspaceStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $workspace): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\resources\views\superadmin\system_analytics.blade.php ENDPATH**/ ?>