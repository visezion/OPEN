...
<?php $__env->startSection('page-action'); ?>
    <a href="<?php echo e(route('churchmeet.attendance_events.create')); ?>" class="btn btn-sm btn-outline-success">
    ...
    <div class="col-lg-9">
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body p-4">
                <form method="POST" action="<?php echo e(route('churchmeet.attendance_events.update', $attendanceEvent->id)); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-semibold">
                            <i class="ti ti-calendar-event text-primary"></i> <?php echo e(__('Linked Event Date')); ?>

                        </label>
                        <input type="text" class="form-control" value="<?php echo e(($attendanceEvent->event->title ?? __('Untitled event')) . ' (' . $attendanceEvent->occurrence_label . ')'); ?>" disabled>
                        <small class="text-muted d-block mt-1">
                            <?php echo e(__('Attendance is linked to one specific occurrence in the recurring series.')); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['manual' => 'Manual', 'qr' => 'QR Code', 'kiosk' => 'Kiosk (Self Check-in)']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-md-6">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['face_ai' => 'Face AI Detection', 'zoom' => 'Zoom Integration', 'youtube' => 'YouTube Live Tracking']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="form-check">
                                        <input type="checkbox" name="enabled_methods[]" value="<?php echo e($value); ?>"
                                               id="method-<?php echo e($value); ?>" class="form-check-input"
                                               <?php echo e(in_array($value, $enabled ?? []) ? 'checked' : ''); ?>>
                    ...
                    <div id="online-config" class="mb-4">
                        ...
                        <small class="text-muted d-block mt-1">
                            <?php echo e(__('Only required if youÃ¢â‚¬â„¢re using Online or Hybrid mode.')); ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\ChurchMeet\src\Resources\views\attendance\attendance_events\edit.blade.php ENDPATH**/ ?>