    ...
    <ul class="nav nav-pills my-3" id="pills-tab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
               href="<?php echo e(route('reports.monthly.purchase')); ?>"
               onclick="window.location.href = '<?php echo e(route('reports.monthly.purchase')); ?>'" role="tab"
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class=" multi-collapse mt-2 " id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        <?php echo e(Form::open(['route' => ['reports.daily.purchase'], 'method' => 'GET', 'id' => 'daily_purchase_report_submit'])); ?>
                        ...
                        <div class="row d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-auto float-end ms-2 mt-4">
                                <a href="#" class="btn btn-sm btn-primary me-1"
                                   onclick="document.getElementById('daily_purchase_report_submit').submit(); return false;" data-toggle="tooltip" data-original-title="<?php echo e(__('apply')); ?>" title="<?php echo e(__('Apply')); ?>">
                                    <span class="btn-inner--icon"><i class="ti ti-search"></i></span>
                                </a>
                                <a href="<?php echo e(route('reports.daily.purchase')); ?>" class="btn btn-sm btn-danger" data-toggle="tooltip"      data-original-title="<?php echo e(__('Reset')); ?>">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\resources\views\report\daily_purchase.blade.php ENDPATH**/ ?>