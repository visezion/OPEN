...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="card p-4 mb-4">
            ...
            <?php if($group->branches->count()): ?>
                <ul class="list-unstyled ps-3">
                    <?php $__currentLoopData = $group->branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if($group->departments->count()): ?>
                <ul class="list-unstyled ps-3">
                    <?php $__currentLoopData = $group->departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if($group->designations->count()): ?>
                <ul class="list-unstyled ps-3">
                    <?php $__currentLoopData = $group->designations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $des): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\wa_group\show.blade.php ENDPATH**/ ?>