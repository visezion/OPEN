            ...
            <div class="card-body p-4">
                <div class="d-flex flex-wrap justify-content-between gap-3 align-items-start">
                    <div>
                        ...
                        <p class="section-copy mb-0"><?php echo e(__('Configure Zoom, Jitsi, and LiveKit from one place, then choose which platform ChurchMeet should prefer when admins create online events.')); ?></p>
                    </div>
    ...
    <div class="col-lg-7">
        <div class="card">
            <div class="card-header bg-white p-4">
                ...
                <p class="section-copy mb-0"><?php echo e(__('Jitsi works quickly with a public or self-hosted server. LiveKit adds a richer in-app room experience. Zoom remains available for scheduling and participant sync.')); ?></p>
            </div>
            <div class="card-body p-4">
                <form method="POST" action="<?php echo e(route('churchmeet.integrations.save')); ?>">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                <label class="platform-card d-block <?php echo e($preferredPlatform === 'jitsi' ? 'is-active' : ''); ?>">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="preferred_platform" value="jitsi" <?php echo e($preferredPlatform === 'jitsi' ? 'checked' : ''); ?>>
                                        <span class="fw-semibold ms-1"><?php echo e(__('Jitsi Meet')); ?></span>
                                    </div>
                                    <div class="text-muted mt-2"><?php echo e(__('Simple zero-cost browser meeting rooms with optional self-hosting.')); ?></div>
                                </label>
                            </div>
                            <div class="col-md-4">
                                <label class="platform-card d-block <?php echo e($preferredPlatform === 'livekit' ? 'is-active' : ''); ?>">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="preferred_platform" value="livekit" <?php echo e($preferredPlatform === 'livekit' ? 'checked' : ''); ?>>
                                        <span class="fw-semibold ms-1"><?php echo e(__('LiveKit')); ?></span>
                                    </div>
                                    <div class="text-muted mt-2"><?php echo e(__('Best when you want OPEN-hosted video rooms with camera, mic, and participant presence inside ChurchMeet.')); ?></div>
                                </label>
                            </div>
                            <div class="col-md-4">
                                <label class="platform-card d-block <?php echo e($preferredPlatform === 'zoom' ? 'is-active' : ''); ?>">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="preferred_platform" value="zoom" <?php echo e($preferredPlatform === 'zoom' ? 'checked' : ''); ?>>
                    ...
                    <div class="card mb-4">
                        <div class="card-header bg-white">
                            <h6 class="mb-0"><?php echo e(__('LiveKit Configuration')); ?></h6>
                        </div>
                        <div class="card-body">
                            <div class="form-check form-switch mb-3">
                                <input class="form-check-input" type="checkbox" name="livekit_enabled" value="1" <?php echo e(old('livekit_enabled', $setting->livekit_enabled) ? 'checked' : ''); ?>>
                                <label class="form-check-label"><?php echo e(__('Enable LiveKit in ChurchMeet')); ?></label>
                            </div>
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label"><?php echo e(__('Server URL')); ?></label>
                                    <input type="text" name="livekit_server_url" value="<?php echo e(old('livekit_server_url', $setting->livekit_server_url)); ?>" class="form-control" placeholder="https://your-project.livekit.cloud">
                                    <small class="text-muted d-block mt-1"><?php echo e(__('Use your LiveKit project URL or self-hosted server URL. ChurchMeet converts it to the proper WebSocket endpoint automatically.')); ?></small>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label"><?php echo e(__('Room Prefix')); ?></label>
                                    <input type="text" name="livekit_room_prefix" value="<?php echo e(old('livekit_room_prefix', $setting->livekit_room_prefix)); ?>" class="form-control" placeholder="churchmeet">
                                    <small class="text-muted d-block mt-1"><?php echo e(__('Optional prefix added to generated LiveKit room names.')); ?></small>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label"><?php echo e(__('API Key')); ?></label>
                                    <input type="text" name="livekit_api_key" value="<?php echo e(old('livekit_api_key', $setting->livekit_api_key)); ?>" class="form-control">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label"><?php echo e(__('API Secret')); ?></label>
                                    <input type="text" name="livekit_api_secret" value="<?php echo e(old('livekit_api_secret', $setting->livekit_api_secret)); ?>" class="form-control">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label"><?php echo e(__('Participant Token TTL')); ?></label>
                                    <select name="livekit_token_ttl_minutes" class="form-select">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [15,30,60,120,240,480,720,1440]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $minutes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($minutes); ?>" <?php echo e((int) old('livekit_token_ttl_minutes', $setting->livekit_token_ttl_minutes ?? 120) === $minutes ? 'selected' : ''); ?>>
                                                <?php echo e($minutes < 60 ? $minutes.' min' : ($minutes % 1440 === 0 ? 'Daily' : ($minutes / 60).' hr')); ?>

                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </select>
                                    <small class="text-muted d-block mt-1"><?php echo e(__('How long each browser join token should remain valid.')); ?></small>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="col-lg-5">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between mb-2"><span class="text-muted"><?php echo e(__('LiveKit')); ?></span><strong><?php echo e($livekitReady ? __('Configured') : __('Incomplete')); ?></strong></div>
                <div class="d-flex justify-content-between mb-2"><span class="text-muted"><?php echo e(__('LiveKit Server')); ?></span><strong><?php echo e($setting->livekit_server_url ?: __('Not set')); ?></strong></div>
                <div class="d-flex justify-content-between"><span class="text-muted"><?php echo e(__('Zoom Credentials')); ?></span><strong><?php echo e($zoomReady ? __('Configured') : __('Incomplete')); ?></strong></div>
            </div>
        </div>
                ...
                <ul class="list-group list-group-flush">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <li class="list-group-item px-0 d-flex justify-content-between align-items-center">
                            <div>
                                <div class="fw-semibold"><?php echo e($event->event->title ?? __('Events')); ?></div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\ChurchMeet\src\Resources\views\integrations\index.blade.php ENDPATH**/ ?>