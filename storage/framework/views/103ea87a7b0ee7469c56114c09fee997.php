        ...
        <div class="invoice-header">
            <table class="vertical-align-top">
                <tbody>
                    <tr>
                        <td style="width: 60%;">
                            <h3 style=" display: block; text-transform: uppercase; font-size: 30px; font-weight: bold; padding: 15px; background: var(--theme-color); color: <?php echo e($font_color); ?>;"><?php echo e(__('PURCHASE')); ?></h3>
...
<?php /**PATH C:\xampp\htdocs\OPEN\resources\views\purchases\templates\template5.blade.php ENDPATH**/ ?>