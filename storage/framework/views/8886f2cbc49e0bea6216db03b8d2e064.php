...
<?php $__env->startSection('page-breadcrumb', __('Zoom Integration')); ?>
...
<div class="row">
  <div class="col-lg-6">
    <div class="card shadow-sm mb-3">
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div>
          <a href="<?php echo e(route('churchmeet.zoom.test')); ?>" class="btn btn-sm btn-outline-secondary"><?php echo e(__('Test Connection')); ?></a>
          <a href="<?php echo e(route('churchmeet.zoom.sync')); ?>" class="btn btn-sm btn-outline-primary"><?php echo e(__('Sync Now')); ?></a>
        </div>
      </div>
      <div class="card-body">
        ...
        <form method="POST" action="<?php echo e(route('churchmeet.zoom.save')); ?>"><?php echo csrf_field(); ?>
          <div class="mb-3">
          ...
          <div class="row g-3">
            <div class="col-md-6">
              ...
              <select name="interval_minutes" class="form-select">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [5,10,15,30,60,120,360,720,1440]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  ...
  <div class="col-lg-6">
    <div class="card shadow-sm mb-3">
      ...
      <div class="card-body">
        <ul class="list-group">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <li class="list-group-item d-flex justify-content-between align-items-center">
              <div>
                <div class="fw-semibold">#<?php echo e($ev->id); ?> Ã¢â‚¬â€ <?php echo e($ev->event->title ?? 'Events'); ?></div>
                <small class="text-muted">Meeting ID: <?php echo e($ev->meeting_id ?? '-'); ?></small>
              </div>
              <a href="<?php echo e(route('churchmeet.attendance_events.edit', $ev->id)); ?>" class="btn btn-sm btn-outline-secondary"><?php echo e(__('Open')); ?></a>
            </li>
    ...
    <div class="card shadow-sm">
      ...
      <div class="card-body">
        <div class="list-group">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentParticipants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="list-group-item">
              <div class="fw-semibold"><?php echo e($p->user_name); ?> <small class="text-muted"><?php echo e($p->user_email); ?></small></div>
              <small class="text-muted"><?php echo e(__('Join')); ?>: <?php echo e(optional($p->join_time)->toDateTimeString()); ?> Ã¢â‚¬Â¢ <?php echo e(__('Duration')); ?>: <?php echo e($p->duration); ?>s</small>
            </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\ChurchMeet\src\Resources\views\integrations\zoom.blade.php ENDPATH**/ ?>