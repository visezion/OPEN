                                ...
                                <?php if (app('laratrust')->hasPermission('user manage')) : ?>
                                    <div class="btn-group card-option">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end">
                                            ...
                                            <?php if(admin_setting('email_verification') == 'on' && $user->email_verified_at == null): ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\resources\views\users\index.blade.php ENDPATH**/ ?>