    ...
    <div class="d-flex">
        <?php if (app('laratrust')->hasPermission('user logs history')) : ?>
            <a href="<?php echo e(route('users.userlog.history')); ?>" class="btn btn-sm btn-primary me-2" data-bs-toggle="tooltip"
                data-bs-placement="top" title="<?php echo e(__('User Logs History')); ?>"><i class="ti ti-user-check"></i>
            </a>
        <?php endif; // app('laratrust')->permission ?>
        <?php if (app('laratrust')->hasPermission('user import')) : ?>
            <a href="#" class="btn btn-sm btn-primary me-2" data-ajax-popup="true" data-title="<?php echo e(__('Import Customers')); ?>"
                data-url="<?php echo e(route('users.file.import')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Import Customers')); ?>"><i
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->type == 'super admin'): ?>
            <?php if (app('laratrust')->hasPermission('user create')) : ?>
                <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md"
                    data-title="<?php echo e(__('Create New Customer')); ?>" data-url="<?php echo e(route('users.create')); ?>"
...
<?php $__env->startSection('content'); ?>
                        ...
                        <div class="row d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                <div class="btn-box">
                                    ...
                                    <?php echo e(Form::select('role', $roles, isset($_GET['role']) ? $_GET['role'] : '', ['class' => 'form-control select text-capitalize', 'placeholder' => __('All')])); ?>
                            ...
                            <div class="col-auto float-end mt-4 d-flex">
                                ...
                                <a href="<?php echo e(route('users.index')); ?>" id="clearfilter" class="btn btn-sm btn-danger"
                    ...
                    <div class="card-header p-3 border border-bottom h-100">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->type == 'super admin'): ?>
                            <div class="d-flex align-items-center">
                                <span class="badge bg-primary p-2 px-3"><?php echo e(ucfirst($user->type)); ?></span>
                            </div>
                                    ...
                                    <div class="btn-group card-option">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end">
                                            <?php if (app('laratrust')->hasPermission('user edit')) : ?>
                                                <a href="#!" data-url="<?php echo e(route('users.edit', $user->id)); ?>"
                                                    data-ajax-popup="true" data-size="md" class="dropdown-item"
                                                    data-title="<?php echo e(__('Update Customer')); ?>"
                                            ...
                                            <?php if (app('laratrust')->hasPermission('user delete')) : ?>
                                                ...
                                                <a href="#!" class="dropdown-item bs-pass-para show_confirm"
                                                    data-bs-placement="top" data-bs-original-title="<?php echo e(__('Delete')); ?>" aria-label="Delete"
                                            ...
                                            <a href="<?php echo e(route('login.with.company', $user->id)); ?>" class="dropdown-item"
                                                ...
                                                <span class="ms-2"><?php echo e(__('Login As Company')); ?></span>
                                            </a>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(admin_setting('email_verification') == 'on' && $user->email_verified_at == null): ?>
                                                <a href="<?php echo e(route('user.verified', $user->id)); ?>" class="dropdown-item"
                                                    data-bs-toggle="tooltip"
                                                    data-bs-original-title="<?php echo e(__('Verified Now')); ?>">
                                                    <i class="ti ti-checks me-1"></i>
                                                    <span class="ms-2"><?php echo e(__('Verified Now')); ?></span>
                                                </a>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            ...
                                            <a href="#!" data-url="<?php echo e(route('upgrade.plan', $user->id)); ?>"
                                                ...
                                                <span class="ms-2"><?php echo e(__('Upgrade Plan')); ?></span>
                                            </a>
                                            ...
                                            <?php if (app('laratrust')->hasPermission('user login manage')) : ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->is_enable_login == 1): ?>
                                                    <a href="<?php echo e(route('users.login', \Crypt::encrypt($user->id))); ?>"
                                                        ...
                                                        <span class="text-danger ms-2"> <?php echo e(__('Login Disable')); ?></span>
                                                    </a>
                                                <?php elseif($user->is_enable_login == 0 && $user->password == null): ?>
                                                    <a href="#"
                                                        ...
                                                        <i class="ti ti-road-sign"></i>
                                                        <span class="text-success ms-2"> <?php echo e(__('Login Enable')); ?></span>
                                                    </a>
                                                <?php else: ?>
                                                    <a href="<?php echo e(route('users.login', \Crypt::encrypt($user->id))); ?>"
                                                        class="dropdown-item">
                        ...
                        <?php else: ?>
                            <div class="user-img-wrp d-flex align-items-center">
                                ...
                                <div class="user-content">
                                    ...
                                    <span class="text-dark text-md"><?php echo e($user->email); ?></span>
                                </div>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <div class="card-body p-3  text-center">
                            ...
                            <div class="mt-4">
                                <div class="row justify-content-between align-items-center">
                                    <div class="col-6 text-center">
                                        <span
                                            class="d-block font-bold mb-0"><?php echo e(!empty($user->plan) ? (!empty($user->plan->name) ? $user->plan->name : 'Basic Plan') : 'Plan Not Activated'); ?></span>
                                    </div>
                                    ...
                                    <div class="col-12 text-center pb-2">
                                        <span class="text-dark text-md"><?php echo e(__('Plan Expired :')); ?>

                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($user->plan)): ?>
                        ...
                        <?php else: ?>
                            <div class="bottom-icons d-flex flex-wrap align-items-center justify-content-between">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->is_disable == 1): ?>
                                    <div class="edit-btn-wrp d-flex flex-wrap align-items-center">
                                        <?php if (app('laratrust')->hasPermission('user edit')) : ?>
                                            <a href="#!" data-url="<?php echo e(route('users.edit', $user->id)); ?>"
                                                data-ajax-popup="true" data-size="md"
                                                data-title="<?php echo e(__('Update User')); ?>"
                                                data-bs-original-title="<?php echo e(__('Edit')); ?>" data-bs-toggle="tooltip"
                                        ...
                                        <?php if (app('laratrust')->hasPermission('user delete')) : ?>
                                            ...
                                            <?php echo method_field('DELETE'); ?>
                                            <a href="#!" aria-label="Delete" data-confirm="<?php echo e(__('Are You Sure?')); ?>"
                                                data-text="<?php echo e(__('This action can not be undone. Do you want to continue?')); ?>"
                                                data-confirm-yes="delete-form-<?php echo e($user->id); ?>" data-bs-toggle="tooltip"
                                                data-bs-placement="top" data-bs-original-title="<?php echo e(__('Delete')); ?>"
                                        ...
                                        <?php if (app('laratrust')->hasPermission('user reset password')) : ?>
                                            <a href="#!"
                                                ...
                                                data-title="<?php echo e(__('Reset Password')); ?>"
                                                data-bs-original-title="<?php echo e(__('Reset Password')); ?>" data-bs-toggle="tooltip"
                                        ...
                                        <?php endif; // app('laratrust')->permission ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(admin_setting('email_verification') == 'on' && $user->email_verified_at == null): ?>
                                            <a href="<?php echo e(route('user.verified', $user->id)); ?>" class="btn btn-sm border"
                                                data-bs-original-title="<?php echo e(__('Verified Now')); ?>"
                                                data-bs-toggle="tooltip" data-bs-placement="top">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    viewBox="0 0 16 16" fill="none">
                                ...
                                <?php else: ?>
                                    <a class="btn btn-sm border" data-title="<?php echo e(__('Lock')); ?>"
                                        data-bs-original-title="<?php echo e(__('User Is Disable')); ?>" data-bs-toggle="tooltip">
            ...
            <?php if (app('laratrust')->hasPermission('user create')) : ?>
                <div class="col-xxl-3 col-xl-4 col-md-6">
                    <a href="#" class="btn-addnew-project border-primary p-4" data-ajax-popup="true" data-size="md"
                        ...
                        <p class="text-muted text-center mb-0"><?php echo e(__('Click here to Create New Customer')); ?></p>
                    </a>
                </div>
            <?php endif; // app('laratrust')->permission ?>
        <?php else: ?>
            <?php if (app('laratrust')->hasPermission('user create')) : ?>
                <div class="col-xxl-3 col-xl-4 col-md-6">
                    <a href="#" class="btn-addnew-project border-primary p-4" data-ajax-popup="true" data-size="md"
                        ...
                        <p class="text-muted text-center mb-0"><?php echo e(__('Click here to Create New User')); ?></p>
                    </a>
                </div>
            <?php endif; // app('laratrust')->permission ?>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="users-pagination-wrap">
        <?php echo $users->links('vendor.pagination.global-pagination'); ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\resources\views/users/index.blade.php ENDPATH**/ ?>