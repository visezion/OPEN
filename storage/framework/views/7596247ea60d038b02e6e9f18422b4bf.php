...
<?php $__env->startSection('page-action'); ?>
    <a href="<?php echo e(route('churchmeet.events.index')); ?>" class="btn btn-sm btn-outline-primary">
        <i class="ti ti-calendar"></i> <?php echo e(__('View All Events/Meetings')); ?>
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body p-4">
                <div class="alert alert-info border-start border-4 border-info shadow-sm mb-4">
                    <strong><i class="ti ti-info-circle"></i> <?php echo e(__('Attendance Flow')); ?>:</strong>
                    <?php echo e(__('You can attach attendance to both upcoming and past event dates. If an attendance session already exists for the selected occurrence, ChurchMeet will reopen that same session automatically so records stay in one place.')); ?>
                ...
                <form method="POST" action="<?php echo e(route('churchmeet.attendance_events.store')); ?>">
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-semibold">
                            <i class="ti ti-calendar-event text-primary"></i> <?php echo e(__('Select Event Date')); ?>

                        </label>
                        <select name="occurrence_id" class="form-select" required>
                            <option value="" disabled <?php echo e(empty($selectedOccurrenceValue) ? 'selected' : ''); ?>><?php echo e(__('-- Choose an Event Date --')); ?></option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($upcomingOccurrences->isNotEmpty()): ?>
                                <optgroup label="<?php echo e(__('Upcoming Dates')); ?>">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $upcomingOccurrences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $occurrence): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($occurrence->id); ?>" <?php echo e((string) $selectedOccurrenceValue === (string) $occurrence->id ? 'selected' : ''); ?>>
                                            <?php echo e($occurrence->title); ?> (<?php echo e($occurrence->date_label); ?>)
                                            <?php echo e($occurrence->has_session ? ' - ' . __('Attendance already linked') : ''); ?>

                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </optgroup>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pastOccurrences->isNotEmpty()): ?>
                                <optgroup label="<?php echo e(__('Past Dates')); ?>">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $pastOccurrences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $occurrence): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($occurrence->id); ?>" <?php echo e((string) $selectedOccurrenceValue === (string) $occurrence->id ? 'selected' : ''); ?>>
                                            <?php echo e($occurrence->title); ?> (<?php echo e($occurrence->date_label); ?>)
                                            <?php echo e($occurrence->has_session ? ' - ' . __('Attendance already linked') : ''); ?>
                        ...
                        <small class="text-muted d-block mt-1">
                            <?php echo e(__('The attendance session will be linked to one dated occurrence of the event. Past dates are allowed, and existing attendance sessions are reused automatically.')); ?>
    ...
    <div class="col-lg-3 mt-4 mt-lg-0">
        <div class="card border-0 shadow-sm h-100">
            ...
            <div class="card-body small text-muted">
                ...
                <ul class="ps-3 mb-3">
                    <li><strong><?php echo e(__('Select Event Date:')); ?></strong> Choose the exact recurring date you want attendance to track.</li>
