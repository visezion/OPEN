        ...
        <form action="<?php echo e(route('members.import.confirm')); ?>" method="POST">
            ...
            <div class="table-responsive">
                <table class="table table-bordered align-middle">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $cleanRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                    <?php echo e($row['name']); ?>
                                ...
                                <td>
                                    <?php if($row['branch']['name'] === 'Unknown'): ?>
                                ...
                                <td>
                                    <select name="rows[<?php echo e($i); ?>][role_id]" 
                                        ...
                                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if(!in_array($name, ['Super Admin', 'Company'])): ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\members\import_preview.blade.php ENDPATH**/ ?>