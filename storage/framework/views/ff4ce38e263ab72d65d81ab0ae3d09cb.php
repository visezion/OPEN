<div class="tab-pane fade" id="bankaccount-payment" role="tabpanel" aria-labelledby="bankaccount-payment">
    <form method="post" action="<?php echo e(route('invoice.pay.with.bankaccount')); ?>" class="require-validation" id="payment-form"
        enctype="multipart/form-data">
        <input type="hidden" name="payment_type" id="payment_type" value="Bank Account">
        <?php echo csrf_field(); ?>
        <?php if($type == 'invoice'): ?>
            <input type="hidden" name="type" value="invoice">
        <?php elseif($type == 'salesinvoice'): ?>
        ...
        <div class="row">
            <div class="row mt-2">
                <div class="col-sm-8">
                    <div class="form-group" id="bankaccount-box">
                        <?php echo e(Form::label('customer_id', __('Bank Account'), ['class' => 'form-label'])); ?>

                        <?php echo e(Form::select('customer_id', $bank_accounts, $bankaccountId, ['class' => 'form-control bank_account', 'id' => 'account', 'data-url' => route('bankaccount.details'), 'required' => 'required', 'placeholder' => 'Select Customer'])); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="choose-files">
                            ...
                            <p class="text-danger error_msg d-none" id="payment_validation">
                                <?php echo e(__('This field is required')); ?></p>
                ...
                <small
                    class="text-danger"><?php echo e(__('first, make a payment and take a screenshot or download the receipt and upload it.')); ?></small>
                <div class="form-group col-md-12">
                    <label for="amount"><?php echo e(__('Amount')); ?></label>
                    <div class="input-group">
                        <span class="input-group-prepend"><span
                                class="input-group-text"><?php echo e(!empty(company_setting('defult_currancy', $invoice->created_by, $invoice->workspace)) ? company_setting('defult_currancy', $invoice->created_by, $invoice->workspace) : '$'); ?></span>
                        </span>
            ...
            <div class="text-end">
                <button type="button" class="btn btn-secondary me-2" data-bs-dismiss="modal"><?php echo e(__('Cancel')); ?></button>
                <button class="btn btn-primary" type="submit" id="submit"><?php echo e(__('Make Payment')); ?></button>
            </div>
        </div>
    </form>
</div>
<?php $__env->startPush('scripts'); ?>
    <script>
        $(document).ready(function() {
            var bankaccountId = '<?php echo e($bankaccountId); ?>';
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Account\src\Resources\views\payment\nav_containt_div.blade.php ENDPATH**/ ?>