...
<div class="row">
    ...
    <div class="card-body">
        ...
        <div class="mb-5">
            ...
            <form method="POST" action="<?php echo e(route('churchmeet.events.submitReview', $event->id)); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="text-end mt-4">
                    ...
                    <a href="<?php echo e(route('churchmeet.events.index')); ?>" class="btn btn-outline-secondary px-4 ms-2">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\ChurchMeet\src\Resources\views\attendance\events\review.blade.php ENDPATH**/ ?>