...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Review Events/Meetings')); ?>: <?php echo e($event->title); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-breadcrumb'); ?>
   <?php echo e(__('Review Events/Meetings')); ?>
        ...
        <div class="card shadow-sm border-0">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h6 class="text-muted mb-0"><?php echo e(__('Events/Meetings Workflow')); ?></h6>
    ...
    <div class="card-body">
        ...
        <div class="mb-4">
            <h6 class="text-uppercase fw-bold border-bottom pb-2">
                <i class="ti ti-calendar-event"></i> <?php echo e(__('Events/Meetings Details')); ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\ChurchMeet\src\Resources\views\attendance\events\review.blade.php ENDPATH**/ ?>