                                            ...
                                            <div class="row gy-4">
                                                <div class="col-md-12">
                                                    <div class="form-group mb-0">
                                                        <?php echo $__env->make('landingpage::landingpage.details.topbar.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row gy-4">
                                                <div class="col-md-12 mt-3">
                                                    <div class="form-group">
                                                        <?php echo $__env->make('landingpage::landingpage.details.banner.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="collapse3" class="accordion-collapse collapse" aria-labelledby="heading-3"
                                        ...
                                        <div class="accordion-body">
                                            <div class="row gy-4">
                                                <div class="col-md-12 mt-3">
                                                    <div class="form-group">
                                                        <?php echo $__env->make('landingpage::landingpage.details.features.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="collapse4" class="accordion-collapse collapse" aria-labelledby="heading-4"
                                        ...
                                        <div class="accordion-body">
                                            <div class="row gy-4">
                                                <div class="col-md-12 mt-3">
                                                    <div class="form-group">
                                                        <?php echo $__env->make('landingpage::landingpage.details.reviews.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="collapse5" class="accordion-collapse collapse" aria-labelledby="heading-5"
                                        ...
                                        <div class="accordion-body">
                                            <div class="row gy-4">
                                                <div class="col-md-12 mt-3">
                                                    <div class="form-group">
                                                        <?php echo $__env->make('landingpage::landingpage.details.screenshots.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="collapse6" class="accordion-collapse collapse" aria-labelledby="heading-6"
                                        ...
                                        <div class="accordion-body">
                                            <div class="row gy-4">
                                                <div class="col-md-12 mt-3">
                                                    <div class="form-group">
                                                        <?php echo $__env->make('landingpage::landingpage.details.dedicated.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="collapse7" class="accordion-collapse collapse" aria-labelledby="heading-7"
                                        ...
                                        <div class="accordion-body">
                                            <div class="row gy-4">
                                                <div class="col-md-12 mt-3">
                                                    <div class="form-group">
                                                        <?php echo $__env->make('landingpage::landingpage.details.packagedetails.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="collapse8" class="accordion-collapse collapse" aria-labelledby="heading-8"
                                        ...
                                        <div class="accordion-body">
                                            <div class="row gy-4">
                                                <div class="col-md-12 mt-3">
                                                    <div class="form-group">
                                                        <?php echo $__env->make('landingpage::landingpage.details.faq.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="collapse9" class="accordion-collapse collapse" aria-labelledby="heading-9"
                                        ...
                                        <div class="accordion-body">
                                            <div class="row gy-4">
                                                <div class="col-md-12 mt-3">
                                                    <div class="form-group">
                                                        <?php echo $__env->make('landingpage::landingpage.details.buildtech.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\LandingPage\src\Resources\views\landingpage\details\index.blade.php ENDPATH**/ ?>