...
<?php if(module_is_active('Signature')): ?>
                                            ...
                                            <div class="row row-gap">
                                                <div class="col-lg-4 col-sm-6">
                                                    <div class="invoice-billed-inner">
                                                        ...
                                                        <div class="billed-content-bottom">
                                                            ...
                                                            <?php if(module_is_active('Signature')): ?>
                                                                <p>
                                                                    <?php if($purchase->company_signature): ?>
                                                                        <div class="mb-2">
                                                                            <img width="100px"
                                                ...
                                                <div class="col-lg-4 col-sm-6">
                                                    <div class="invoice-billed-inner">
                                                        ...
                                                        <?php endif; ?>
                                                        <div class="billed-content-top">
                                                            <?php if(!empty($company_settings['purchase_shipping_display']) && $company_settings['purchase_shipping_display'] == 'on'): ?>
                                                        ...
                                                        <div class="billed-content-bottom">
                                                            <?php if(module_is_active('Signature')): ?>
                                                                <div class="vendor-signature-content">
                                                                    <p>
                                                                        <?php if($purchase->vendor_signature != ''): ?>
                                                                            <div class="mb-2">
                                                                                <img width="100px"
                                                ...
                                                <?php if(!empty($company_settings['purchase_qr_display']) && $company_settings['purchase_qr_display'] == 'on'): ?>
                                                    <div class="col-lg-2 col-sm-6">
                                            ...
                                            <table class="table mb-0 pc-dt-simple" id="debit_summary">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-dark"><?php echo e(__('Amount')); ?></th>
                                                        <th class="text-dark"><?php echo e(__('Description')); ?></th>
                                                        <?php if(Laratrust::hasPermission('purchase debitnote edit') || Laratrust::hasPermission('purchase debitnote delete')): ?>
                                                            <th class="text-dark"><?php echo e(__('Action')); ?></th>
                                                        <?php endif; ?>
                                                    </tr>
                                                </thead>
                                                <?php $__empty_1 = true; $__currentLoopData = $purchase->debitNote; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$debitNote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    <tr>
                                    ...
                                    <div class="card-body table-border-style">
                                        <div class="table-responsive">
                                            <table class="table mb-0 pc-dt-simple" id="attachment">
                                                ...
                                                <?php $__empty_1 = true; $__currentLoopData = $purchase_attachment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    <tr>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\resources\views\purchases\view.blade.php ENDPATH**/ ?>