        ...
        <div class="invoice-header">
            ...
            <table class="vertical-align-top">
                <tbody>
                    <tr>
                        <td>
                            <h3 style="text-transform: uppercase; font-size: 25px; font-weight: bold; margin-bottom: 15px; color: <?php echo e($color); ?>;"><?php echo e(__('PURCHASE')); ?></h3>
...
<?php /**PATH C:\xampp\htdocs\OPEN\resources\views\purchases\templates\template2.blade.php ENDPATH**/ ?>