    ...
    <div class="d-flex">
        ...
        <?php if (app('laratrust')->hasPermission('customer import')) : ?>
            <a href="#" class="btn btn-sm btn-primary me-2" data-size="md" data-ajax-popup="true"
                data-title="<?php echo e(__('Customer Import')); ?>" data-url="<?php echo e(route('customer.file.import')); ?>" data-toggle="tooltip"
                title="<?php echo e(__('Import')); ?>"><i class="ti ti-file-import"></i>
            </a>
        <?php endif; // app('laratrust')->permission ?>
        <a href="<?php echo e(route('customer.index')); ?>" class="btn btn-sm btn-primary me-2" data-bs-toggle="tooltip"
        ...
        <?php if (app('laratrust')->hasPermission('customer create')) : ?>
            <a class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Create New Customer')); ?>"
                data-url="<?php echo e(route('customer.create')); ?>" data-bs-toggle="tooltip" data-bs-original-title="<?php echo e(__('Create')); ?>">
...
<?php $__env->startSection('content'); ?>
    <div class="row row-gap-2 mb-4">
                    ...
                    <div class="card-header border border-bottom h-100 p-3">
                        <div class="user-img-wrp d-flex align-items-center">
                            <div class="user-image rounded border-2 border border-primary">
                                <a href="<?php echo e(check_file($customer->avatar) ? get_file($customer->avatar) : 'uploads/users-avatar/avatar.png'); ?>"
                                    target="_blank">
                                    <img src="<?php echo e(check_file($customer->avatar) ? get_file($customer->avatar) : 'uploads/users-avatar/avatar.png'); ?>"
                                        alt="user-image" class=" h-100 w-100">
                                </a>
                            </div>
                            <div class="user-content">
                                <?php if (app('laratrust')->hasPermission('customer show')) : ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($customer->is_disable == 1 && !empty($customer['customer_id'])): ?>
                                        <a href="<?php echo e(route('customer.show', \Crypt::encrypt($customer['id']))); ?>">
                                            <h4 class="mb-2 text-break"><?php echo e(!empty($customer->name) ? $customer->name : ''); ?></h4>
                                        </a>
                                    <?php else: ?>
                                        <h4 class="mb-2 text-break"><?php echo e(!empty($customer->name) ? $customer->name : ''); ?></h4>
                                ...
                                <?php else: ?>
                                    <h4 class="mb-2 text-break"><?php echo e(!empty($customer->name) ? $customer->name : ''); ?></h4>
                                <?php endif; // app('laratrust')->permission ?>
                            <span class="text-dark text-md"><?php echo e($customer->email); ?></span>
                        </div>
                        </div>
                    </div>
                    <div class="card-body text-center p-3">
                        <div class="bottom-icons d-flex flex-wrap align-items-center justify-content-between">
                            <div class="edit-btn-wrp d-flex flex-wrap align-items-center">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($customer->is_disable == 1): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Laratrust::hasPermission('customer show') ||
                                            Laratrust::hasPermission('customer edit') ||
                                            Laratrust::hasPermission('customer delete')): ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($customer['customer_id'])): ?>

                                            <?php if (app('laratrust')->hasPermission('customer show')) : ?>
                                                <a href="<?php echo e(route('customer.show', \Crypt::encrypt($customer['id']))); ?>"
                                                    data-title="<?php echo e(__('View')); ?>"
                                                    data-bs-original-title="<?php echo e(__('View')); ?>" data-bs-toggle="tooltip"
                                            ...
                                            <?php if (app('laratrust')->hasPermission('customer edit')) : ?>
                                                <a href="#!" data-url="<?php echo e(route('customer.edit', $customer['id'])); ?>"
                                                    data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Edit')); ?>"
                                            ...
                                            <?php if (app('laratrust')->hasPermission('customer delete')) : ?>
                                                ...
                                                <a href="#!" aria-label="Delete" data-confirm="<?php echo e(__('Are You Sure?')); ?>"
                                                    ...
                                                    data-bs-original-title="<?php echo e(__('Delete')); ?>" data-bs-toggle="tooltip"
                                ...
                                <?php else: ?>
                                    <a class="btn btn-sm border" data-title="<?php echo e(__('Lock')); ?>"
                                        data-bs-original-title="<?php echo e(__('Customer Is Disable')); ?>" data-bs-toggle="tooltip">
        ...
        <div class="col-xxl-3 col-xl-4 col-md-6">
            <a href="#" class="btn-addnew-project border-primary p-4" data-ajax-popup="true" data-size="lg"
                ...
                <h6 class="my-2 text-center"><?php echo e(__('New Customer')); ?></h6>
    ...
    <?php echo $customers->links('vendor.pagination.global-pagination'); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Account\src\Resources\views\customer\grid.blade.php ENDPATH**/ ?>