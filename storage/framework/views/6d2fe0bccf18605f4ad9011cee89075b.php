                    ...
                    <div class="card-header border border-bottom h-100 p-3">
                        <div class="user-img-wrp d-flex align-items-center">
                            ...
                            <div class="user-content">
                                ...
                                <?php if($customer->is_disable == 1 && !empty($customer['customer_id'])): ?>
                        ...
                        <div class="bottom-icons d-flex flex-wrap align-items-center justify-content-between">
                            <div class="edit-btn-wrp d-flex flex-wrap align-items-center">
                                <?php if($customer->is_disable == 1): ?>
                                    <?php if(Laratrust::hasPermission('customer show') ||
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Account\src\Resources\views\customer\grid.blade.php ENDPATH**/ ?>