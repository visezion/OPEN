                                        ...
                                        <table class="table  mb-0" id="dataTable-manual">
                                            ...
                                            <tbody>
                                                ...
                                                <?php if(!empty($billExpenseArray)): ?>
                                                    ...
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                                                <?php if(!empty($salExpenseArray) && module_is_active('Hrm') || !empty($salExpenseArray) && module_is_active('Hrm') && !empty($TrainingCostExpenseArray) && module_is_active('Training')): ?>
                                                    <?php $__currentLoopData = $salExpenseArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $salexpensearray): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td><?php echo e(__('Employee Salary :')); ?></td>
                                                            <?php $__currentLoopData = $salexpensearray['amount']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j => $amount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <td width="15%">
                                                    ...
                                                    <?php if(module_is_active('Training')): ?>
                                                        <?php $__currentLoopData = $TrainingCostExpenseArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $trainingcostexpensearray): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td><?php echo e(__('Training Cost :')); ?></td>
                                                                <?php $__currentLoopData = $trainingcostexpensearray['amount']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j => $amount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <td width="15%">
                                                                        <?php echo e(currency_format_with_sym($amount)); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Account\src\Resources\views\report\profit_loss_summary.blade.php ENDPATH**/ ?>