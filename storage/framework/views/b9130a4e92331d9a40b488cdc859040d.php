    ...
    <div class="row g-2 section-details">
      ...
      <div class="col-md-3">
        <select class="form-select" name="sections[<?php echo e($i); ?>][align]">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['left','center','right']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
