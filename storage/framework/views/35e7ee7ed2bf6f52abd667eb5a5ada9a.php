            ...
            <table class="table mb-0 pc-dt-simple" id="credir-note">
                <thead>
                    <tr>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Laratrust::hasPermission('creditnote edit') || Laratrust::hasPermission('creditnote delete')): ?>
