                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php $__currentLoopData = $purchaseExpenseTotal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if(module_is_active('Hrm')): ?>
                                        <tr>
                                            ...
                                            <?php $__currentLoopData = $EmpSalary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empsalary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if(module_is_active('Training')): ?>
                                        <tr>
                                            ...
                                            <?php $__currentLoopData = $TrainingCost; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trainingcost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Account\src\Resources\views\report\income_vs_expense_summary.blade.php ENDPATH**/ ?>