    ...
    <div class="d-flex">
        ...
        <?php if((module_is_active('ProductService') && module_is_active('Account')) || module_is_active('Taskly')): ?>
            <?php if (app('laratrust')->hasPermission('invoice manage')) : ?>
                <a href="<?php echo e(route('invoice.grid.view')); ?>"  data-bs-toggle="tooltip" data-bs-original-title="<?php echo e(__('Grid View')); ?>" class="btn btn-sm btn-primary btn-icon me-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row d-flex align-items-center justify-content-end">
                        ...
                        <div class="col-auto float-end mt-4 d-flex">
                            ...
                            <a href="<?php echo e(route('invoice.index')); ?>" class="btn btn-sm btn-danger" data-bs-toggle="tooltip" title="<?php echo e(__('Reset')); ?>" id="clearfilter"
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\resources\views\invoice\index.blade.php ENDPATH**/ ?>