...
<div class="container text-center">
    ...
    <h4 class="text-muted mb-3"><?php echo e(__('Scan a member’s QR code to mark attendance.')); ?></h4>
    ...
    <div class="offline-banner" id="offlineBanner"><?php echo e(__('⚠️ Offline Mode: Scans will sync later')); ?></div>
...
<script>
const markUrl = "<?php echo e(route('churchly.attendance_events.mark', $event->id)); ?>";
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\attendance\scanner.blade.php ENDPATH**/ ?>