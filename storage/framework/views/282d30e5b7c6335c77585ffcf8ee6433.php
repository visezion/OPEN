    ...
    <div class="invoice-preview-main" id="boxes" style="border-right:40px solid var(--theme-color);">
        ...
        <div class="invoice-body" style="padding-right: 0;">
            ...
            <div class="invoice-footer">
                <p> <?php echo e($settings['proposal_footer_notes']); ?></p>
                <h6><?php echo e($settings['proposal_footer_title']); ?></h6>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\OPEN\resources\views\proposal\templates\template9.blade.php ENDPATH**/ ?>