...
<?php $__env->startPush('scripts'); ?>
    ...
    <?php if(module_is_active('Account') || module_is_active('CMMS')): ?>
        <script>
    ...
    <?php endif; ?>
    <script>
        var projectsid = '<?php echo e($projectsid); ?>';
...
<?php $component = $__componentOriginalbba606fec37ea04333bc269e3e165587; ?>
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?> <?php echo e(Form::select('project', $projects, $projectsid, ['class' => 'form-control ', 'required' => 'required'])); ?>`
                $(".proposal_div").append(label);
                $("#proposal_type").val('project');
                var project_id = $("#project").val();
                if (projectsid != '') {
                    $("#project").val(<?php echo e($projectsid); ?>).trigger('change');
                }
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <?php echo e(Form::open(['url' => 'proposal', 'class' => 'w-100', 'enctype' => 'multipart/form-data', 'class' => 'needs-validation', 'novalidate'])); ?>

        <input type="hidden" name="_token" id="token" value="<?php echo e(csrf_token()); ?>">
        <input type="hidden" name="redirect_route"
            value="<?php echo e(isset($_GET['redirect_route']) ? $_GET['redirect_route'] : null); ?>">
        <?php if(module_is_active('Account')): ?>
...
<?php endif; ?>
                                    <select
                                        ...
                                        <?php if(module_is_active('Account')): ?>
                                            <option value="Accounting" <?php if(!empty($customerId) && $customerId != 0): ?> selected <?php endif; ?>>
                                                <?php echo e(__('Accounting')); ?></option>
                                        <?php endif; ?>
                                        <?php if(module_is_active('Taskly')): ?>
                                            <option value="Projects" <?php if($type == 'project'): ?> selected <?php endif; ?>>
                                                <?php echo e(__('Projects')); ?></option>
                                        <?php endif; ?>
                                ...
                                <div class="form-group col-md-6">
                                    <?php echo e(Form::label('customer_id', __('Customer/Client'), ['class' => 'form-label'])); ?></label><?php if (isset($component)) { $__componentOriginalbba606fec37ea04333bc269e3e165587 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbba606fec37ea04333bc269e3e165587 = $attributes; } ?>
<?php $component = App\View\Components\Required::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                                    <?php echo e(Form::select('customer_id', $customers, $customerId, ['class' => 'form-control', 'id' => 'customer', 'data-url' => route('proposal.customer'), 'required' => 'required', 'placeholder' => 'Please Select'])); ?>
...
<?php endif; ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?php echo e(Form::label('issue_date', __('Issue Date'), ['class' => 'form-label'])); ?></label><?php if (isset($component)) { $__componentOriginalbba606fec37ea04333bc269e3e165587 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbba606fec37ea04333bc269e3e165587 = $attributes; } ?>
<?php $component = App\View\Components\Required::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php endif; ?>
                                        <div class="form-icon-user">
                                            <?php echo e(Form::date('issue_date', date('Y-m-d'), ['class' => 'form-control', 'required' => 'required', 'placeholder' => 'Select Date'])); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group proposal_div">
                                        <?php if(module_is_active('Account')): ?>
                                            <?php echo e(Form::label('category_id', __('Category'), ['class' => 'form-label'])); ?></label><?php if (isset($component)) { $__componentOriginalbba606fec37ea04333bc269e3e165587 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbba606fec37ea04333bc269e3e165587 = $attributes; } ?>
<?php $component = App\View\Components\Required::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php endif; ?>
                                            ...
                                            <?php endif; ?>
                                        <?php elseif(module_is_active('Taskly')): ?>
                                            <?php echo e(Form::label('project', __('Project'), ['class' => 'form-label'])); ?></label>
        ...
        <div class="modal-footer">
            <input type="button" value="<?php echo e(__('Cancel')); ?>" onclick="location.href = '<?php echo e(route('proposal.index')); ?>';"
                class="btn btn-light">
            <input type="submit" value="<?php echo e(__('Create')); ?>" class="btn btn-primary mx-2">
        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\resources\views\proposal\create.blade.php ENDPATH**/ ?>