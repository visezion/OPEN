...
<head>
    ...
    <title><?php echo e(\Workdo\Account\Entities\Bill::billNumberFormat($bill->bill_id, $bill->created_by, $bill->workspace)); ?> |
    ...
    <div class="invoice-preview-main" id="boxes">
                    ...
                    <tr>
                        ...
                        <td>
                            <table class="no-space" style="width: 45%;margin-left: auto;">
                                <tbody>
                                    <tr>
                                        <td style="color: var(--theme-color);"><?php echo e(__('Number: ')); ?></td>
                                        <td class="text-right">
                                            <?php echo e(Workdo\Account\Entities\Bill::billNumberFormat($bill->bill_id, $bill->created_by, $bill->workspace)); ?>

                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="color: var(--theme-color);"><?php echo e(__('Issue Date:')); ?></td>
                                        <td class="text-right">
                                    ...
                                    <tr>
                                        <td style="color: var(--theme-color);"><?php echo e(__('Due Date')); ?>:</td>
                                        <td class="text-right">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($customFields) && count($bill->customField) > 0): ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td style="color: var(--theme-color);"><?php echo e($field->name); ?> :</td>
        ...
        <div class="invoice-body">
            ...
            <div class="invoice-footer">
                <p>
                    <?php echo e($settings['bill_footer_title']); ?> <br>
                    <?php echo e($settings['bill_footer_notes']); ?>
...
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Account\src\Resources\views\bill\templates\template10.blade.php ENDPATH**/ ?>