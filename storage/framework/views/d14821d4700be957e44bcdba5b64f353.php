    ...
    <div class="row">
        ...
        <div class="<?php if($hasManual && $hasQr): ?> col-md-4 <?php elseif($hasManual || $hasQr): ?>  col-md-8 <?php else: ?> col-md-12 <?php endif; ?>">
            <div class="card shadow-sm p-4 mb-4">
                ...
                <div class="mb-3">
                    <strong><?php echo e(__('Date:')); ?></strong> <?php echo e($eventDate); ?> <br>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\ChurchMeet\src\Providers/../Resources/views/attendance/attendance_events/show.blade.php ENDPATH**/ ?>