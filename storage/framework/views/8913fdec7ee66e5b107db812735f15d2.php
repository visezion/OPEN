            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="form-check form-switch custom-switch-v1">
                    <input type="checkbox" name="paymentoption[]" id="stripeLabel" data-target="Stripe"
                            class="paymentButton form-check-input input-primary" value="stripe" data-payment-action="<?php echo e(route('vcard.enable.stripe',$id)); ?>"
                            <?php echo e(isset($cardPayment_content->stripe) && is_object($cardPayment_content->stripe) && $cardPayment_content->stripe->status === 'on' ? 'checked' : ''); ?>>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Stripe\src\Resources\views\payment\vcard_theme_payment.blade.php ENDPATH**/ ?>