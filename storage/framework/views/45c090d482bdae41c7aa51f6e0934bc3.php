        ...
        <div class="invoice-header" style="border-top: 15px solid var(--theme-color);">
            <table>
                <tbody>
                    <tr>
                        <td >
                            <h3 style="text-transform: uppercase; font-size: 40px; font-weight: bold; color: <?php echo e($color); ?>;"><?php echo e(__('BILL')); ?></h3>
                        </td>
                        <td class="text-right">
...
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Account\src\Resources\views\bill\templates\template6.blade.php ENDPATH**/ ?>