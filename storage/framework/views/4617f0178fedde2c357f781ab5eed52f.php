...
<?php endif; ?>
            <div class="form-icon-user">
                <select class="form-control select" required="required" id="debit_note" name="debit_note">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $debitNotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $debitNote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Account\src\Resources\views\debitNote\create.blade.php ENDPATH**/ ?>