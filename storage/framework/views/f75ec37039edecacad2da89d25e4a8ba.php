...
<div class="d-grid gap-3">
    <div class="card shadow-sm">
        <div class="card-header">
            <h5 class="mb-0"><?php echo e(__('Weekly Report Overview')); ?></h5>
        </div>
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="border rounded-3 p-3 bg-light">
                        <div class="text-muted small"><?php echo e(__('Report Recipient')); ?></div>
                        <div class="fw-semibold"><?php echo e($feedback->recipient?->name ?? __('Department / standard inbox')); ?></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Providers/../Resources/views/feedback/_report_sections.blade.php ENDPATH**/ ?>