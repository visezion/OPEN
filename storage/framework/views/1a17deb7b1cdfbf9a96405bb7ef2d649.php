        ...
        <?php if(@$attachment[2] == 'image'): ?>
            <div>
                <div class="message-card">
                    <div class="image-file chat-image" style="width: 250px; height: 150px;background-image: url('<?php echo e(get_file('/uploads/attachments/' . $attachment[0])); ?>')">
                    </div>
                </div>
            </div>
        <?php endif; ?>
...
<?php if($viewType == 'sender'): ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\OPEN\resources\views\vendor\Chatify\layouts\messageCard.blade.php ENDPATH**/ ?>