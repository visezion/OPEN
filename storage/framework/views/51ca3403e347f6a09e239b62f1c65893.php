...
<?php $__env->startSection('content'); ?>
    ...
    <div class="wrapper pricing-advanced">
                            ...
                            <div class="basic-plan-card d-flex direction-column">
                                ...
                                <ul class="basic-plan-ul compare-plan-opction">
                                    <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <?php if(!isset($module->display) || $module->display == true): ?>
                                            <?php if(in_array($module->name, $plan_modules)): ?>
                                                <li>
                                                    <a href="#">
                                    ...
                                    <li class="plan-btn">
                                        <div class="d-flex flex-column gap-2">
                                            ...
                                            <?php if($single_plan->trial == 1 && $single_plan->is_free_plan != 1): ?>
        ...
        <section class="review-section padding-bottom">
            <div class="container">
                <div class="review-slider">
                    <?php if(is_array(json_decode($settings['reviews'], true)) || is_object(json_decode($settings['reviews'], true))): ?>
        ...
        <?php if($settings['is_faq_section_active'] == 'on'): ?>
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\LandingPage\src\Resources\views\layouts\pricing-plans.blade.php ENDPATH**/ ?>