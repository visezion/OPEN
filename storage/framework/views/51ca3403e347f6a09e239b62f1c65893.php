...
<?php $__env->startSection('content'); ?>
    ...
    <div class="wrapper pricing-advanced">
            ...
            <div class="container">
                <div class="tab-head-row">
                    <ul class="tabs d-flex justify-content-center">
                        <li>
                            <a href="<?php echo e(route('apps.pricing.plan')); ?>"
                                class="nav-link active"><?php echo e(__('Pre-Packaged Subscription')); ?></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apps.pricing')); ?>" class="nav-link"><?php echo e(__('Usage Subscription')); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="container">
                <div class="basic-plan-card-wrap d-flex no-wrap">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $plan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $single_plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($single_plan->status == 1): ?>
                            <?php
                            ...
                            <div class="basic-plan-card d-flex direction-column">
                                <div class="basic-plan text-center">
                                    ...
                                    <div class="price justify-content-center">
                                        ...
                                        <ins class="per_year_price d-none"><?php echo e(super_currency_format_with_sym($single_plan->package_price_yearly)); ?><span
                                ...
                                <ul class="basic-plan-ul compare-plan-opction">
                                    ...
                                    <li class="plan-btn">
                                        <div class="d-flex flex-column gap-2">
                                            ...
                                            <a class="btn btn-primary user-register-btn" data-id="<?php echo e(Crypt::encrypt($single_plan->id)); ?>"><?php echo e(__('Subscription')); ?></a>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($single_plan->trial == 1 && $single_plan->is_free_plan != 1): ?>
                                            <a data-id="<?php echo e(Crypt::encrypt($single_plan->id)); ?>" class="btn btn-outline-dark user-trial"><?php echo e(__('Start Free Trial')); ?></a>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
        ...
        <section class="review-section padding-bottom">
            <div class="container">
                <div class="review-slider">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array(json_decode($settings['reviews'], true)) || is_object(json_decode($settings['reviews'], true))): ?>
                            ...
                            <div class="review-content-itm">
                                <div class="review-content">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <a href="<?php echo $value['review_live_demo_link']; ?>" class="link-btn"><?php echo $value['review_live_demo_button_text']; ?><svg
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['is_faq_section_active'] == 'on'): ?>
            <section class="faq-section padding-top padding-bottom">
                <div class="container">
                    <div class="section-title text-center">
                        <h2>
                            <?php echo !empty($settings['faq_heading']) ? $settings['faq_heading'] : ''; ?>

                        </h2>
                        <p>
                            <?php echo !empty($settings['faq_description']) ? $settings['faq_description'] : ''; ?>

                        </p>
                    </div>
                    <div class="faq-list">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array(json_decode($settings['faqs'], true)) || is_object(json_decode($settings['faqs'], true))): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = json_decode($settings['faqs'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="set has-children">
                                    <a href="javascript:;" class="acnav-label">
                                        ...
                                        <span><?php echo isset($value['faq_questions']) ? $value['faq_questions'] : ''; ?></span>
                                    </a>
                                    <div class="acnav-list">
                                        <p>
                                            <?php echo isset($value['faq_answer']) ? $value['faq_answer'] : ''; ?>
...
<?php echo $__env->make($layout, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\LandingPage\src\Resources\views\layouts\pricing-plans.blade.php ENDPATH**/ ?>