...
<div class="modal-body">
    <div class="text-end">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(module_is_active('AIAssistant')): ?>
            <?php echo $__env->make('aiassistant::ai.generate_ai_btn',['template_module' => 'transfer','module'=>'Account'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="row mt-2">
        <div class="form-group col-md-6">
            ...
            <select class="form-control"
                ...
                <option value="bank" <?php if($transfer->from_type == 'bank'): ?> selected <?php endif; ?>>
                    <?php echo e(__('Bank')); ?></option>
                <option value="wallet" <?php if($transfer->from_type == 'wallet'): ?> selected <?php endif; ?>>
                    <?php echo e(__('Wallet')); ?></option>
            </select>
        </div>
        ...
        <div class="form-group col-md-6">
            ...
            <select class="form-control"
                ...
                <option value=""><?php echo e(__('Select Type')); ?></option>
                <option value="bank" <?php if($transfer->to_type == 'bank'): ?> selected <?php endif; ?>><?php echo e(__('Bank')); ?></option>
                <option value="wallet"  <?php if($transfer->to_type == 'wallet'): ?> selected <?php endif; ?> ><?php echo e(__('Wallet')); ?></option>
            </select>
        </div>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                <?php echo e(Form::number('amount',null, array('class' => 'form-control bank_amount','required'=>'required',"min"=>"0",'placeholder' => __('Enter Amount')))); ?>
...
<?php endif; ?>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <?php echo e(Form::text('reference',null, array('class' => 'form-control','placeholder' => 'Enter Reference'))); ?>
...
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Account\src\Resources\views\transfer\edit.blade.php ENDPATH**/ ?>