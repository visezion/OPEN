...
<div class="row">
  ...
  <div class="col-md-6 mb-3"><label class="form-label"><?php echo e(__('Logo')); ?></label><input type="file" name="logo_path" class="form-control"><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($theme->logo_path): ?><img src="<?php echo e(asset(Storage::url($theme->logo_path))); ?>" class="img-thumbnail mt-2" width="120"><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\cms\theme.blade.php ENDPATH**/ ?>