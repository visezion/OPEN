...
<head>
    ...
    <title><?php echo e(\Workdo\Account\Entities\Bill::billNumberFormat($bill->bill_id,$bill->created_by,$bill->workspace)); ?> | <?php echo e(!empty(company_setting('title_text',$bill->created_by,$bill->workspace)) ? company_setting('title_text',$bill->created_by,$bill->workspace) : (!empty(admin_setting('title_text')) ? admin_setting('title_text') :'WorkDo')); ?></title>
    <link
...
<body>
    <div class="invoice-preview-main" id="boxes" style="border-right:40px solid var(--theme-color);">
                ...
                <table class="no-space vertical-align-top">
                    <tbody>
                        <tr>
                            ...
                            <td class="text-right"><?php echo e(Workdo\Account\Entities\Bill::billNumberFormat($bill->bill_id,$bill->created_by,$bill->workspace)); ?></td>
                        </tr>
                        <tr>
                            <td><?php echo e(__('Issue Date:')); ?></td>
                            <td class="text-right"><?php echo e(company_date_formate($bill->bill_date,$bill->created_by,$bill->workspace)); ?></td>
                        </tr>
                        <tr>
                            <td><?php echo e(__('Due Date')); ?>:</td>
                            <td class="text-right"><?php echo e(company_date_formate($bill->due_date,$bill->created_by,$bill->workspace)); ?></td>
                        </tr>
                    ...
                    <tr>
                        <td>
                            <p>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($settings['company_zipcode'])): ?> - <?php echo e($settings['company_zipcode']); ?><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?><br>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['bill_qr_display'] == 'on'): ?>
                            <td>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <div class="view-qrcode" style="margin-top: 0;">
                                                    <p> <?php echo DNS2D::getBarcodeHTML(route('pay.billpay',\Illuminate\Support\Facades\Crypt::encrypt($bill->bill_id)), "QRCODE",2,2); ?>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['bill_shipping_display']=='on'): ?>
        ...
        <div class="invoice-body" style="padding-right: 0;">
            <table class="add-border invoice-summary">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($bill->itemData) && count($bill->itemData) > 0): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $bill->itemData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bill->bill_module == "account"): ?>
                                ...
                                <td><?php echo e(currency_format_with_sym($item->price,$bill->created_by,$bill->workspace)); ?></td>
                                <td><?php echo e(($item->discount!=0)?currency_format_with_sym($item->discount,$bill->created_by,$bill->workspace):'-'); ?></td>
                                <td>
                                ...
                                <td><?php echo e(currency_format_with_sym(($item->price * $item->quantity),$bill->created_by,$bill->workspace)); ?></td>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td><?php echo e(currency_format_with_sym($bill->totalDiscount,$bill->created_by,$bill->workspace)); ?></td>
                        <td><?php echo e(currency_format_with_sym($bill->totalTaxPrice,$bill->created_by,$bill->workspace)); ?></td>
                        <td><?php echo e(currency_format_with_sym($bill->getSubTotal(),$bill->created_by,$bill->workspace)); ?></td>
                    </tr>
                    <?php
                        $colspan = 4;
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="sub-total">
                            <table class="total-table">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bill->getTotalDiscount()): ?>
                                    <tr>
                                        <td><?php echo e(__('Discount')); ?>:</td>
                                        <td><?php echo e(currency_format_with_sym($bill->getTotalDiscount(),$bill->created_by,$bill->workspace)); ?></td>
                                    </tr>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($bill->taxesData)): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $bill->taxesData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taxName => $taxPrice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($taxName); ?> :</td>
                                            <td><?php echo e(currency_format_with_sym($taxPrice,$bill->created_by,$bill->workspace)); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <tr>
                                    <td><?php echo e(__('Total')); ?>:</td>
                                    <td><?php echo e(currency_format_with_sym(($bill->getSubTotal()-$bill->getTotalDiscount()+$bill->getTotalTax()),$bill->created_by,$bill->workspace)); ?></td>
                                </tr>
                                <tr>
                                    <td><?php echo e(__('Paid')); ?>:</td>
                                    <td><?php echo e(currency_format_with_sym(($bill->getTotal()-$bill->getDue())-($bill->billTotalDebitNote()),$bill->created_by,$bill->workspace)); ?></td>
                                </tr>
                                <tr>
                                    <td><?php echo e(__('Debit Note')); ?>:</td>
                                    <td><?php echo e(currency_format_with_sym($bill->billTotalDebitNote(),$bill->created_by,$bill->workspace)); ?></td>
                                </tr>
                                <tr>
                                    <td><?php echo e(__('Due Amount')); ?>:</td>
                                    <td><?php echo e(currency_format_with_sym($bill->getDue(),$bill->created_by,$bill->workspace)); ?></td>
                                </tr>
            ...
            <div class="invoice-footer">
                <p> <?php echo e($settings['bill_footer_notes']); ?></p>
                <h6><?php echo e($settings['bill_footer_title']); ?></h6>
            </div>
        </div>
    </div>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!isset($preview)): ?>
       <?php echo $__env->make('account::bill.script', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>;
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</body>

</html>
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Account\src\Resources\views\bill\templates\template9.blade.php ENDPATH**/ ?>