    ...
    <div class="invoice-preview-main" id="boxes">
        <div class="invoice-header">
            <table class="vertical-align-top">
                <tbody>
                    <tr>
                        <td >
                            <h3 style=" display: inline-block; text-transform: uppercase; font-size: 40px; font-weight: bold; border-top: 5px solid var(--theme-color); padding-top: 5px;"><?php echo e(__('PURCHASE')); ?></h3>
        ...
        <div class="invoice-body">
            ...
            <div class="invoice-footer">
                <p>
                    <?php echo e($settings['purchase_footer_title']); ?> <br>
                    <?php echo e($settings['purchase_footer_notes']); ?>
...
<?php /**PATH C:\xampp\htdocs\OPEN\resources\views\purchases\templates\template10.blade.php ENDPATH**/ ?>