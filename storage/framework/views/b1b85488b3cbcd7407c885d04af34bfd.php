            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="form-check">
                    <input class="form-check-input payment_method" name="payment_method" id="paypal-payment"
                        type="radio" data-payment-action="<?php echo e(route('property.pay.with.paypal')); ?>">
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Paypal\src\Resources\views\payment\property_payment.blade.php ENDPATH**/ ?>