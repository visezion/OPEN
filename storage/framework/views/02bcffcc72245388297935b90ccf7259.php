<div class="price-summery-card">
    <div class="price-sm-card-top">
        ...
        <div class="price-pay-info" style="width: 495px;">
            <h4><?php echo e(__('Stripe')); ?></h4>
            <p><?php echo e(__('Safe money transfer using your bank account. We support Mastercard, Visa, Maestro and Skrill.')); ?>

            </p>
        </div>
        <form action="<?php echo e(route('booking.stripe.post', $slug)); ?>"
            method="post" class="payment-method-form" id="payment-form">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="firstname"
                class="firstnameforminput">
            <?php if($type == "roombookinginvoice"): ?>
            ...
            <div class="form-group text-right">
                <button type="submit"
                    class="btn"><?php echo e(__('Pay Now')); ?></button>
            </div>
        </form>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Stripe\src\Resources\views\payment\holidayz_nav_containt_div.blade.php ENDPATH**/ ?>