...
<body class="<?php echo e($themeColor); ?><?php echo e(request()->routeIs('login', 'register', 'password.request', 'password.reset') ? ' faith-login-page dms-faith-login' : ''); ?><?php echo $__env->yieldContent('body-class'); ?> ui-border-clean">
    <?php
                ...
                <div class="auth-footer">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <span>
                                    <?php echo e($footerText); ?><?php echo e(date('Y')); ?>
