    ...
    <div class="row justify-content-center">
        <div class="col-sm-12 col-md-10 col-xxl-8">
                        ...
                        <DIV id="dropzone">
                            <FORM class="dropzone needsclick" id="demo-upload">
                                <DIV class="dz-message needsclick">
                                    <?php echo e(__('Drop files here or click here to upload and install.')); ?><BR>
                                </DIV>
                            </FORM>
                        </DIV>
                    </SECTION>
            ...
            <div class="col-lg-12 text-center">
                <a href="<?php echo e(route('module.index')); ?>" class="btn btn-primary"> <?php echo e(__('Back To Add-on Manager')); ?></a>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\resources\views\module\add.blade.php ENDPATH**/ ?>