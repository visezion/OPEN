...
<div class="modal-body">
    ...
    <div class="row domain-setup mt-3">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($custom_domain_request) && $custom_domain_request->status != '0'): ?>
