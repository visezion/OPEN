...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('App Builder')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
    <li class="breadcrumb-item active"><?php echo e(__('App Builder')); ?></li>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-action'); ?>
    <div>
        <a href="<?php echo e(route('app-builder.publish')); ?>" class="btn btn-sm btn-primary">
            <i class="ti ti-upload"></i> <?php echo e(__('Publish Settings')); ?>

        </a>
        <a href="<?php echo e(route('app-builder.layout')); ?>" class="btn btn-sm btn-outline-secondary ms-2">
            <i class="ti ti-apps"></i> <?php echo e(__('Home Layout')); ?>

        </a>
        <a href="<?php echo e(route('churchly.api.docs')); ?>" class="btn btn-sm btn-outline-info ms-2">
            <i class="ti ti-book"></i> <?php echo e(__('API Docs')); ?>

        <a href="<?php echo e(route('churchly.google.credentials')); ?>" class="btn btn-sm btn-outline-success ms-2">
            <i class="ti ti-brand-google"></i> <?php echo e(__("Google Integration")); ?>

        <a href="<?php echo e(route('cms.pages')); ?>" class="btn btn-sm btn-outline-primary ms-2">
            <i class="ti ti-layout"></i> <?php echo e(__("Website CMS")); ?>
...
<div class="row">
            ...
            <div class="card-body">
                ...
                <div class="tab-content" id="appBuilderTabsContent">
                    <div class="tab-pane fade show active" id="branding" role="tabpanel" aria-labelledby="branding-tab">
                        <?php echo $__env->make('churchly::app-builder._branding', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                    <div class="tab-pane fade" id="features" role="tabpanel" aria-labelledby="features-tab">
                        <?php echo $__env->make('churchly::app-builder._features', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                    <div class="tab-pane fade" id="menu" role="tabpanel" aria-labelledby="menu-tab">
                        <?php echo $__env->make('churchly::app-builder._menu', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-4 col-lg-4 col-md-12">
        <div class="card shadow-sm">
            <div class="card-header"><h6><?php echo e(__('Live Preview')); ?></h6></div>
            <div class="card-body text-center">
                <div id="livePreviewContainer" class="phone-frame mx-auto">
                    <div id="phoneScreen" class="phone-screen d-flex flex-column justify-content-between">
                        ...
                        <div class="phone-header text-white p-2 fw-bold" id="previewHeader">
                            <?php echo e(optional($profile)->app_name ?? 'Church App'); ?>
                        ...
                        <div class="phone-body flex-grow-1 d-flex align-items-center justify-content-center">
                            <div id="previewFeatures" class="w-100 px-2 text-center">
                                ...
                                <div class="mt-2 small text-white-50"><?php echo e(__('Toggle features to preview')); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="phone-nav d-flex justify-content-around p-2" id="previewMenu">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->visible): ?>
                                <div class="nav-item text-center">
                                    <i class="<?php echo e($item->icon_name ?? 'ti ti-circle'); ?> text-white"></i><br>
                                    <small class="text-white-50"><?php echo e($item->title); ?></small>
                                </div>
                ...
                <small class="text-muted d-block mt-2"><?php echo e(__('Preview updates live as you edit')); ?></small>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updatePreview() {
        ...
        if (feats) feats.innerHTML = fhtml || '<i class="ti ti-device-mobile text-white-50" style="font-size:64px;"></i><div class="mt-2 small text-white-50">'+"<?php echo e(__('Toggle features to preview')); ?>"+'</div>';
    }
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\app-builder\index.blade.php ENDPATH**/ ?>