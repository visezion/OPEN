<?php $__env->startSection('page-title', __('Home Layout')); ?>

<?php $__env->startSection('page-breadcrumb'); ?>
<li class="breadcrumb-item"><a href="<?php echo e(route('app-builder.index')); ?>"><?php echo e(__('App Builder')); ?></a></li>
<li class="breadcrumb-item active"><?php echo e(__('Home Layout')); ?></li>
        ...
        <form method="POST" action="<?php echo e(route('app-builder.saveLayout')); ?>">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="title" class="form-control" value="<?php echo e($layout->title); ?>" placeholder="Home">
                </div>
                <div class="col-md-6 text-end">
                    <a href="<?php echo e(route('app-builder.index')); ?>" class="btn btn-light mt-4"><?php echo e(__('Back to Builder')); ?></a>
            ...
            <table class="table align-middle">
                <thead>
                    <tr>
                        <th style="width:18%"><?php echo e(__('Type')); ?></th>
                ...
                <tbody id="widgetsTable">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $widgets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php $c = is_array($w->settings) ? $w->settings : (json_decode($w->settings, true) ?: []); ?>
                    <tr class="sortable-item">
                        <td>
                            <select name="widgets[<?php echo e($i); ?>][type]" class="form-select widget-type">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($t); ?>" <?php echo e($w->type==$t ? 'selected':''); ?>><?php echo e(str_replace('_',' ',ucfirst($t))); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </select>
                        </td>
                        <td>
                            <input type="text" name="widgets[<?php echo e($i); ?>][title]" class="form-control" value="<?php echo e($w->title); ?>" placeholder="<?php echo e(__('Optional title')); ?>">
                        </td>
                        <td class="settings-cell">
                            <?php echo $__env->make('churchly::app-builder.widget_fields', ['idx'=>$i,'type'=>$w->type,'settings'=>$c], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </td>
            ...
            <div class="row mt-4">
                ...
                <div class="col-lg-4">
                    <div class="card shadow-sm">
                        <div class="card-header"><h6 class="mb-0"><?php echo e(__('Live Preview')); ?></h6></div>
                        <div class="card-body text-center">
                            <div id="layoutPreview" class="phone-frame mx-auto">
                                <div class="phone-screen d-flex flex-column">
                                    <div class="phone-header text-white p-2 fw-bold" id="layoutPreviewHeader"><?php echo e($layout->title ?? 'Home'); ?></div>
                                    <div id="layoutPreviewBody" class="flex-grow-1 overflow-auto p-2" style="background:#3f5be7;">
                                        <div class="text-white-50 small"><?php echo e(__('Widgets will render here as you edit')); ?></div>
                                    </div>
                                    <div class="phone-nav d-flex justify-content-around p-2"><i class="ti ti-dots text-white-50"></i></div>
                                </div>
                            </div>
                            <small class="text-muted d-block mt-2"><?php echo e(__('Updates live as you change fields and types')); ?></small>
                        </div>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  function addWidgetRow(type){
    ...
    tr.innerHTML = `
      ...
      <td><input type="text" name="widgets[${idx}][title]" class="form-control" placeholder="${'<?php echo e(__('Optional title')); ?>'}"></td>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\app-builder\layout.blade.php ENDPATH**/ ?>