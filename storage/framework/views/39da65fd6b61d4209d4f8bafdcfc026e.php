        ...
        <form method="POST" action="<?php echo e(route('app-builder.saveLayout')); ?>">
            ...
            <table class="table align-middle">
                ...
                <tbody id="widgetsTable">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $widgets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <tr class="sortable-item">
                        ...
                        <td class="settings-cell">
                            <?php echo $__env->make('churchly::app-builder.widget_fields', ['idx'=>$i,'type'=>$w->type,'settings'=>$c], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </td>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\app-builder\layout.blade.php ENDPATH**/ ?>