<?php echo e(Form::open(array('route' => array('purchases.payment.store', $purchase->id),'method'=>'post','enctype' => 'multipart/form-data', 'class' =>'needs-validation', 'novalidate'))); ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                <?php echo e(Form::number('amount',$purchase->getDue(), array('class' => 'form-control','required'=>'required','min'=>'0','placeholder'=> __('Enter Amount'),'step'=>'0.01','max' => $purchase->getDue()))); ?>
...
<?php endif; ?>
            <div class="form-icon-user">
                <?php echo e(Form::text('reference',null, array('class' => 'form-control','required'=>'required','placeholder'=> __('Enter Reference')))); ?>
...
<?php /**PATH C:\xampp\htdocs\OPEN\resources\views\purchases\payment.blade.php ENDPATH**/ ?>