    ...
    cc.run({
                ...
                onAccept: function(cookie) {
                    if (!getCookie('workdo_dash_cookie_status'))
                    {
                        ...
                        $.ajax({
                            url: '<?php echo e(route('landingpage.cookie.consent')); ?>',
                            datType: 'json',
                            data: {
                                cookie: cookie,
                            },
                    ...
                    'en': {
                        ...
                        settings_modal: {
                            ...
                            blocks: [{
                                ...
                                title: "<?php echo e($settings['strictly_cookie_title']); ?>",
                                description: '<?php echo e($settings['strictly_cookie_description']); ?>',
                                toggle: {
                                    value: 'necessary',
                                    enabled: true,
...
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\LandingPage\src\Resources\views\layouts\cookie_consent.blade.php ENDPATH**/ ?>