...
<?php $__env->startPush('scripts'); ?>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var product_select = `<select class="form-control product_id item js-searchBox" name="${itemSelect}"
                                            placeholder="Select Item" data-url="<?php echo e(route('purchases.product')); ?>" required = 'required'>
                                            </select>`;
    ...
    <script>
        ...
        function changeItem(element) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.ajax({
                        url: '<?php echo e(route('purchases.items')); ?>',
                        type: 'post',
                        headers: {
                            'X-CSRF-TOKEN': jQuery('#token').val()
                        },
        ...
        $(document).on('click', '[data-repeater-delete]', function() {
            if (confirm('Are you sure you want to delete this element?')) {
                ...
                $.ajax({
                    url: '<?php echo e(route('purchases.product.destroy')); ?>',
                    type: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': jQuery('#token').val()
                    },
    ...
    <script>
        $(document).ready(function() {
            var vendor_name = '<?php echo e($purchase->vender_name); ?>';
    ...
    <script>
        $(document).ready(function() {
            var valueToMatch = "<?php echo e($purchase->account_type); ?>";
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <?php echo e(Form::model($purchase, ['route' => ['purchases.update', $purchase->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'class' => 'w-100 needs-validation', 'novalidate'])); ?>
                                    ...
                                    <select class="form-control account_type <?php echo e(!empty($errors->first('account_type')) ? 'is-invalid' : ''); ?>"
                                        ...
                                        <option value="Projects"><?php echo e(__('Projects')); ?></option>
                                            <?php if(module_is_active('CMMS')): ?>
                                                <option value="CMMS"><?php echo e(__('CMMS')); ?></option>
                                            <?php endif; ?>
                                    </select>
                                    <input type="hidden" name="account_type" value="<?php echo e($purchase->account_type ?? ''); ?>">
                                </div>
                                <div class="col-md-6">
                                    <?php if(module_is_active('Account')): ?>
                                        <div class="form-group col-md-6 " id="vender_remove">
                                            <?php echo e(Form::label('vender_name', __('Vendor'), ['class' => 'form-label'])); ?>

                                            <div class="form-group price-input input-group search-form" style="width: 160px">
                                                <?php echo e(Form::text('vender_name', null, ['class' => 'form-control  ', 'placeholder' => 'Enter vender name'])); ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                                            <?php echo e(Form::select('vender_id', $venders, $purchase->user_id ?? null, ['class' => 'form-control select ', 'id' => 'vender', 'data-url' => route('purchases.vender'), 'required' => 'required', 'placeholder' => 'Select vender'])); ?>
...
<?php endif; ?>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <?php if(module_is_active('Account') && module_is_active('Taskly')): ?>
                                    <div class="col-md-12">
                                        <div class="form-group">

                                            <div class="form-group col-md-6">
                                                <label
                                                    class="require form-label"><?php echo e(__('Billing Type')); ?></label><?php if (isset($component)) { $__componentOriginalbba606fec37ea04333bc269e3e165587 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbba606fec37ea04333bc269e3e165587 = $attributes; } ?>
<?php $component = App\View\Components\Required::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                                        <?php echo e(Form::select('warehouse_id', $warehouse, null, ['class' => 'form-control select', 'required' => 'required'])); ?>
...
<?php endif; ?>
        ...
        <div class="col-12">
            <h5 class="d-inline-block mb-4"><?php echo e(__('Items')); ?></h5>
                                ...
                                <tr>
                                    ...
                                    <td width="25%" class="form-group pt-0 product_div">
                                        <select name="item" class="form-control product_id item  js-searchBox"
                                            data-url="<?php echo e(route('purchases.product')); ?>" required>
                                    ...
                                    <td>
                                        <div class="form-group price-input input-group search-form" style="width: 160px">
                                            <?php echo e(Form::number('quantity', null, ['class' => 'form-control quantity', 'required' => 'required', 'placeholder' => __('Qty'), 'required' => 'required','step'=>'0.01'])); ?>
                                    ...
                                    <td>
                                        <div class="form-group price-input input-group search-form" style="width: 160px">
                                            <?php echo e(Form::number('price', null, ['class' => 'form-control price', 'required' => 'required', 'placeholder' => __('Price'), 'required' => 'required','step'=>'0.01'])); ?>

                                            <span class="input-group-text bg-transparent"><?php echo e($currancy_symbol); ?></span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                    ...
                                    <td>
                                        <div class="form-group price-input input-group search-form" style="width: 160px">
                                            <?php echo e(Form::number('discount', null, ['class' => 'form-control discount', 'required' => 'required', 'placeholder' => __('Discount'),'step'=>'0.01'])); ?>
                                    ...
                                    <td>
                                        <?php if (app('laratrust')->hasPermission('purchase product delete')) : ?>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td><strong><?php echo e(__('Sub Total')); ?>
                                            ...
                                            (<?php echo e($currancy_symbol); ?>)</strong></td>
        ...
        <div class="modal-footer">
            <input type="button" value="<?php echo e(__('Cancel')); ?>"
                onclick="location.href = '<?php echo e(route('purchases.index')); ?>';" class="btn btn-light me-2">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\resources\views\purchases\edit.blade.php ENDPATH**/ ?>