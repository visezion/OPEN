                    ...
                    <div class="tab-pane fade  show active" id="pills-purchase" role="tabpanel" aria-labelledby="pills-purchase-tab">
                        <div class="bg-none">
                            <div class="row company-setting">
                                ...
                                <div class="col-md-9">
                                    <?php if(isset($company_settings['purchase_template']) && isset($company_settings['purchase_color']) && !empty( $company_settings['purchase_template']) && !empty($company_settings['purchase_color'])): ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\resources\views\purchases\pos.blade.php ENDPATH**/ ?>