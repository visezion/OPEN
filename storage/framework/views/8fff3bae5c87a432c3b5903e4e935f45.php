<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(module_is_active('Account') && !empty($customer)): ?>
    <div class="row row-gap">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($customer['billing_name'])): ?>
        ...
        <?php else: ?>
            <div class="col-md-10">
                <div class="mt-3">
                    <h6><?php echo e($customer['name']); ?></h6>
    ...
    <div class="row">
        <div class="col-md-10">
            <h6 class="">
                ...
                <?php echo e(__('Please Set Customer Details !')); ?>
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH C:\xampp\htdocs\OPEN\resources\views\invoice\customer_detail.blade.php ENDPATH**/ ?>