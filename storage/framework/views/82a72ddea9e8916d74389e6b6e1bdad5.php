            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="form-check form-switch d-inline-block text-end">
                    <input type="checkbox" name="paymentoption[]" id="paypalLabel" data-target="paypal"
                            class="paymentButton form-check-input input-primary" value="paypal" data-payment-action="<?php echo e(route('vcard.enable.paypal',$id)); ?>"
                            <?php echo e(isset($cardPayment_content->paypal) && is_object($cardPayment_content->paypal) && $cardPayment_content->paypal->status === 'on' ? 'checked' : ''); ?>>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Paypal\src\Resources\views\payment\vcard_theme_payment.blade.php ENDPATH**/ ?>