...
<?php $__env->startSection('page-action'); ?>
    <div>
        ...
        <?php if(module_is_active('Retainer')): ?>
            <?php echo $__env->make('retainer::setting.convert_retainer', ['proposal' => $proposal, 'type' => 'view'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
        <div class="action-btn ms-2">
                                    ...
                                    <div class="p-sm-4 p-3 invoice-billed">
                                        <div class="row row-gap">
                                            ...
                                            <div class="col-lg-4 col-sm-6">
                                                ...
                                                <?php if(!empty($company_settings['proposal_shipping_display']) && $company_settings['proposal_shipping_display'] == 'on'): ?>
                                            ...
                                            <?php if(!empty($company_settings['proposal_qr_display']) && $company_settings['proposal_qr_display'] == 'on'): ?>
                                                <div class="col-lg-2 col-sm-6">
                                        ...
                                        <div class="table-responsive mt-2">
                                            <table class="table mb-0 table-striped">
                                                <tr>
                                                    ...
                                                    <?php if($proposal->proposal_module == 'account' || $proposal->proposal_module == 'cmms'): ?>
                                ...
                                <div class="card-body table-border-style">
                                    <div class="table-responsive">
                                        <table class="table mb-0 pc-dt-simple" id="attachment">
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $proposal_attachment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\resources\views\proposal\view.blade.php ENDPATH**/ ?>