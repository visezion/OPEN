                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="mode" class="form-select" required>
                                <option value="onsite" <?php echo e($event->mode == 'onsite' ? 'selected' : ''); ?>>Onsite</option>
                                <option value="online" <?php echo e($event->mode == 'online' ? 'selected' : ''); ?>>Online</option>
                                <option value="hybrid" <?php echo e($event->mode == 'hybrid' ? 'selected' : ''); ?>>Hybrid</option>
                            </select>
                        </div>
                    </div>
