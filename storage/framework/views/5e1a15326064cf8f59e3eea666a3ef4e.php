...
<?php $__env->startSection('page-action'); ?>
    <a href="<?php echo e(route('churchly.events.create')); ?>" class="btn btn-sm btn-outline-success">
        <i class="ti ti-plus"></i> <?php echo e(__('Create New Event')); ?>

    </a>
    <a href="<?php echo e(route('churchly.events.index')); ?>" class="btn btn-sm btn-outline-primary">
    ...
    <div class="col-lg-9">
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body p-4">
                <form method="POST" action="<?php echo e(route('churchly.events.update', $event->id)); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="card bg-light border-0 mb-4">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div>
                                    <h6 class="mb-1"><?php echo e(__('Zoom Meeting')); ?></h6>
                                    <small class="text-muted"><?php echo e(__('Create or update the meeting details members will join from OPEN.')); ?></small>
                                </div>
                                <?php if(optional($attendanceEvent)->meeting_id): ?>
                                    <a href="<?php echo e(route('churchly.zoom.meetings.join', $attendanceEvent->id)); ?>" class="btn btn-sm btn-outline-primary">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="online_platform" id="online_platform" class="form-control" value="<?php echo e(old('online_platform', optional($attendanceEvent)->online_platform)); ?>" placeholder="zoom">
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-3">
                                ...
                                <?php if(!empty($zoomSetting->account_id) && !empty($zoomSetting->client_id) && !empty($zoomSetting->client_secret) && empty(optional($attendanceEvent)->meeting_id)): ?>
                                    <div class="form-check form-switch">
                    ...
                    <div class="mb-4">
                        ...
                        <div id="program-wrapper">
                            <?php $__empty_1 = true; $__currentLoopData = $event->programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="card-body small text-muted">
                ...
                <ul class="ps-3 mb-0">
                    <?php if($attendanceEvent): ?>
                        <a href="<?php echo e(route('churchly.attendance_events.edit', $attendanceEvent->id)); ?>"
                ...
                <ul class="ps-0 mb-0"> 
                <?php if($event->reviewerComments->count() > 0): ?>
                <div class="chat-container bg-light rounded shadow-sm p-3" style="max-height: 350px; overflow-y: auto;">
                    <?php $__empty_1 = true; $__currentLoopData = $event->reviewerComments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="mb-3 d-flex <?php echo e($comment->user_id === Auth::id() ? 'justify-content-end' : 'justify-content-start'); ?>">
                            <div class="p-3 rounded <?php echo e($comment->user_id === Auth::id() ? 'bg-primary text-white' : 'bg-white border'); ?>" style="max-width: 80%;">
                                <div class="small fw-bold mb-1">
                                    <?php echo e($comment->user?->name ?? 'System'); ?>

                                    <span class="text-muted small">
                                        • <?php echo e($comment->commented_at ? \Carbon\Carbon::parse($comment->commented_at)->diffForHumans() : ''); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\attendance\events\edit.blade.php ENDPATH**/ ?>