                            ...
                            <div class="col-xl-10">
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        ...
                                        <?php echo e(Form::month('start_month',isset($_GET['start_month'])?$_GET['start_month']: date('Y-m'),array('class'=>'month-btn form-control','placeholder'=>'Start Month'))); ?>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        ...
                                        <?php echo e(Form::month('end_month',isset($_GET['end_month'])?$_GET['end_month']:date('Y-m'),array('class'=>'month-btn form-control','placeholder'=>'Start Month'))); ?>
                        ...
                        <table class="table mb-0 pc-dt-simple" id="assets">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e(company_date_formate($transaction->date)); ?></td>
                                        <td>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($transaction) && $transaction->holder_name=='Cash'): ?>
                                                <?php echo e($transaction->holder_name); ?>

                                            <?php else: ?>
                                                <?php echo e(!empty($transaction)?$transaction->bank_name.' '.$transaction->holder_name:'-'); ?>
                                        ...
                                        <td><?php echo e(currency_format_with_sym($transaction->amount)); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </tbody>
                        </table>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Account\src\Resources\views\transaction\index.blade.php ENDPATH**/ ?>