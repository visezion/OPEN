...
<?php $__env->startSection('page-action'); ?>
    <a href="<?php echo e(route('churchly.attendance_events.index')); ?>" class="btn btn-sm btn-primary">
...
<div class="col-md-12">
    <div class="row">
        ...
        <div class="<?php if($hasManual && $hasQr): ?> col-md-4 <?php elseif($hasManual || $hasQr): ?>  col-md-8 <?php else: ?> col-md-12 <?php endif; ?>">
            <div class="card shadow-sm p-4 mb-4">
                ...
                <?php if($attendanceEvent->mode !== 'onsite'): ?>
                    <div class="mb-3">
        ...
        <?php if(in_array('manual', $methods)): ?>
        <div class="col-md-4">
            <div class="card p-3 mb-4 shadow-sm">
                ...
                <form action="<?php echo e(route('churchly.attendance.manualCheckIn', $attendanceEvent->id)); ?>" 
        ...
        <?php if(in_array('qr', $methods)): ?>
        <div class="col-md-4">
            <div class="card p-3 mb-4 shadow-sm">
                <h6 class="fw-bold"><?php echo e(__('QR Code Attendance Scanner')); ?></h6>
                <p class="text-muted small mb-3">
                    <?php echo e(__('Scan a member’s unique QR code to mark attendance instantly. 
                    Works online and offline, syncing automatically once reconnected.')); ?>

                </p>

                <div class="text-center mt-5">
                    <a href="<?php echo e(route('churchly.attendance_events.scan', $attendanceEvent->id)); ?>"
    ...
    <div class="card p-3 mb-4 shadow-sm">
        ...
        <table class="table table-bordered align-middle mt-3">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $attendanceEvent->records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
...
$(document).ready(function () {
    $('#member-search').select2({
        ...
        ajax: {
            url: "<?php echo e(route('churchly.attendance.searchMember')); ?>",
            dataType: 'json',
            delay: 250,
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\attendance\attendance_events\show.blade.php ENDPATH**/ ?>