...
<div class="container-fluid py-4">
    <div class="p-4 bg-white shadow rounded-3">
        ...
        <table class="table table-striped table-hover align-middle">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $pendingProgress; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $progress): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><?php echo e($progress->member->name); ?></td>
                        <td><?php echo e($progress->stage->name); ?></td>
                        <td><?php echo e($progress->requirement->title); ?></td>
                        <td>
                            <?php if($progress->evidence): ?>
                                <?php if(Str::startsWith($progress->evidence, 'discipleship/evidence')): ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\discipleship\requirements\approval.blade.php ENDPATH**/ ?>