...
<?php $__env->startSection('page-action'); ?>
    <a href="<?php echo e(route('churchly.attendance_events.create')); ?>" class="btn btn-sm btn-primary">
    ...
    <div class="col-lg-9">
        <div class="card border-0 shadow-sm mb-3">
            ...
            <div class="card-body pt-0">
                <?php if($attendanceEvents->count() > 0): ?>
                    <div class="table-responsive">
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $attendanceEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendanceEvent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <?php if($attendanceEvent->event): ?>
                                                <a href="<?php echo e(route('churchly.events.show', $attendanceEvent->event_id)); ?>" 
                                        ...
                                        <td>
                                            <?php if(!empty($attendanceEvent->enabled_methods)): ?>
                                                <?php $__currentLoopData = $attendanceEvent->enabled_methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a href="<?php echo e(route('churchly.attendance_events.show', $attendanceEvent->id)); ?>" 
                                                ...
                                                <form action="<?php echo e(route('churchly.attendance_events.destroy', $attendanceEvent->id)); ?>" 
                                                    method="POST" 
                ...
                <?php else: ?>
                    <div class="text-center py-5">
                        ...
                        <a href="<?php echo e(route('churchly.attendance_events.create')); ?>" class="btn btn-primary mt-2">
    ...
    <div class="col-lg-3 mt-4 mt-lg-0">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-light py-2 d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('churchly.attendance_events.index')); ?>" class="small text-muted"><?php echo e(__('View All')); ?></a>
            </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\attendance\attendance_events\index.blade.php ENDPATH**/ ?>