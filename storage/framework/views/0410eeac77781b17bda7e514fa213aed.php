        ...
        <div class="container">
            <section class="faith-landing-hero">
                <div class="faith-hero-copy">
                    ...
                    <h2><?php echo e(__('A unified ministry and business control center for every team, task, and report.')); ?></h2>
                    ...
                    <p class="faith-hero-note"><?php echo e(__('This app is free and open source, built to help your team grow with confidence.')); ?></p>
                </div>
...
<br><br>
            ...
            <h2 class="faith-section-title"><?php echo e(__('Why this interface works for your teams')); ?></h2>
            <section class="faith-feature-grid">
                ...
                <article class="faith-feature-card">
                    <div class="faith-feature-dot"></div>
                    <h3><?php echo e(__('Primary color sync')); ?></h3>
                    <p><?php echo e(__('Accent styling reflects super admin branding so every public entry screen remains consistent.')); ?></p>
                </article>
                <article class="faith-feature-card">
                    <div class="faith-feature-dot"></div>
            ...
            <section class="faith-bottom-cta">
                <div>
                    ...
                    <p><?php echo e(__('Start from secure sign-in or create a workspace and move directly into operations.')); ?></p>
                </div>
                <div class="faith-hero-actions">
                    <a class="faith-btn faith-btn-primary" href="<?php echo e(Auth::check() ? route('home') : route('login')); ?>">
                        <?php echo e(Auth::check() ? __('Open Dashboard') : __('Sign In')); ?>
