        ...
        <div class="col-sm-12">
            <div class="row">
                <div class="col-xxl-8 col-xl-7">
                    <div class="row">
                        <?php if($subscriptionDetail['status'] == true): ?>
                            <div class="col-12">
                                <div class="card">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\resources\views\users\modules.blade.php ENDPATH**/ ?>