        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo e(Form::text('other_features_tag',null, ['class' => 'form-control ', 'placeholder' => __('Enter Tag'),'required'=>'required'])); ?>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <?php echo e(Form::textarea('other_featured_description', null, ['class' => 'summernote form-control', 'placeholder' => __('Enter Description'), 'id'=>'other_featured_des','required'=>'required'])); ?>
                ...
                <div id="add-cards1" class="border-bottom row py-2">
                    <div class="col-md-10">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('cards[1][title]', null, ['class' => 'form-control', 'placeholder' => __('Enter Link')])); ?>

                        </div>
                        <div class="form-group">
                            <?php echo e(Form::label('Description', __('Description'), ['class' => 'form-label'])); ?>

                            <?php echo e(Form::text('cards[1][description]',null, ['class' => 'form-control ', 'placeholder' => __('Enter Heading')])); ?>
...
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\LandingPage\src\Resources\views\landingpage\details\features\features_create.blade.php ENDPATH**/ ?>