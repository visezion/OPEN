            ...
            <table>
                <tbody>
                    ...
                    <tr>
                      ...
                      <tr>
                        <td>
                            <strong class="h5 mb-1"><?php echo e(__('Name ')); ?> : </strong><?php echo e(!empty($customer->name) ? $customer->name : ''); ?></br>
                            <strong class="h5 mb-1"><?php echo e(__('Email ')); ?> : </strong><?php echo e(!empty($customer->email) ? $customer->email : ''); ?>
...
<?php /**PATH C:\xampp\htdocs\OPEN\resources\views\proposal\templates\template6.blade.php ENDPATH**/ ?>