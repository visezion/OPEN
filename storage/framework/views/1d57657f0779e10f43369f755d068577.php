    ...
    <div class="col-lg-9">
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body p-4">
                <form method="POST" action="<?php echo e(route('churchly.attendance_events.store')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\attendance\attendance_events\create.blade.php ENDPATH**/ ?>