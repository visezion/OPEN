                    ...
                    <div class="mb-3 d-flex <?php echo e($comment->user_id === Auth::id() ? 'justify-content-end' : 'justify-content-start'); ?>">
                        <div class="p-3 rounded <?php echo e($comment->role === 'Approver' ? 'bg-success text-white' : ($comment->user_id === Auth::id() ? 'bg-primary text-white' : 'bg-white border')); ?>" style="max-width: 80%;">
                            <div class="small fw-bold mb-1">
                                ...
                                <span class="text-muted small">• <?php echo e(\Carbon\Carbon::parse($comment->commented_at)->diffForHumans()); ?></span>
                            </div>
...
<?php if($event->status === 'approved'): ?>
        ...
        <div class="border-top pt-4">
            ...
            <form method="POST" action="<?php echo e(route('churchly.events.approveAction', $event->id)); ?>">
                <?php echo csrf_field(); ?>
                <div class="mb-3">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\attendance\events\approve.blade.php ENDPATH**/ ?>