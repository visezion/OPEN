    ...
    <div class="card-body p-3 pb-0">
        <div class="row">
            <div class="col-xxl-4 col-sm-6">
                <div class="card">
                    <div class="card-header p-3">
                        <label class="paypal-label form-label mb-0" for="company_paypal_mode"><?php echo e(__('Paypal Mode')); ?></label>
                    </div>
            ...
            <div class="col-xxl-4 col-sm-6">
                <div class="form-group">
                    <label for="company_paypal_client_id" class="form-label"><?php echo e(__('Client ID')); ?></label>
            ...
            <div class="col-xxl-4 col-sm-6">
                <div class="form-group">
                    <label for="company_paypal_secret_key" class="form-label"><?php echo e(__('Secret Key')); ?></label>
...
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Paypal\src\Resources\views\company\settings\index.blade.php ENDPATH**/ ?>