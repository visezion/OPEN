...
<?php $__env->startSection('page-action'); ?>
    ...
    <a href="<?php echo e(route('feedback.index')); ?>" class="btn btn-sm btn-danger" data-bs-toggle="tooltip" title="<?php echo e(__('Back to Weekly Reports')); ?>">
...
<?php $__env->startSection('content'); ?>
    <div class="row g-4">
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm">
                <div class="card-header">
                    <h5 class="mb-0"><?php echo e(__('Response to Weekly Report')); ?></h5>
                </div>
                <div class="card-body">
