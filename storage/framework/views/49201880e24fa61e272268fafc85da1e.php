...
<?php $__env->startSection('page-title', __('Edit Events/Meetings')); ?>

<?php $__env->startSection('page-action'); ?>
    <a href="<?php echo e(route('churchmeet.events.create')); ?>" class="btn btn-sm btn-outline-success">
        <i class="ti ti-plus"></i> <?php echo e(__('Create New Events/Meetings')); ?>

    </a>
    <a href="<?php echo e(route('churchmeet.events.index')); ?>" class="btn btn-sm btn-outline-primary">
        <i class="ti ti-list-details"></i> <?php echo e(__('View All Events/Meetings')); ?>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-light py-3">
                <h5 class="fw-bold mb-0">
                    <i class="ti ti-edit text-primary"></i> <?php echo e(__('Edit Events/Meetings Details')); ?>
                ...
                <form method="POST" action="<?php echo e(route('churchmeet.events.update', $event->id)); ?>">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="recurrence" class="form-select">
                            <option value="none" <?php echo e(old('recurrence', $event->recurrence) == 'none' ? 'selected' : ''); ?>>None</option>
                            <option value="daily" <?php echo e(old('recurrence', $event->recurrence) == 'daily' ? 'selected' : ''); ?>>Daily</option>
                            <option value="weekly" <?php echo e(old('recurrence', $event->recurrence) == 'weekly' ? 'selected' : ''); ?>>Weekly</option>
                            <option value="monthly" <?php echo e(old('recurrence', $event->recurrence) == 'monthly' ? 'selected' : ''); ?>>Monthly</option>
                        </select>
                    </div>

                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label class="form-label fw-semibold"><?php echo e(__('Repeat Until')); ?></label>
                            <input type="datetime-local" name="recurrence_until" value="<?php echo e(old('recurrence_until', $event->recurrence_until ? $event->recurrence_until->format('Y-m-d\\TH:i') : '')); ?>" class="form-control">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold"><?php echo e(__('Occurrence Limit')); ?></label>
                            <input type="number" min="1" max="365" name="recurrence_count" value="<?php echo e(old('recurrence_count', $event->recurrence_count)); ?>" class="form-control" placeholder="<?php echo e(__('Optional')); ?>">
                            <small class="text-muted"><?php echo e(__('Use a repeat until date, a limit, or both for recurring events.')); ?></small>
                        </div>
                    </div>
        ...
        <div class="card border-0 shadow-sm h-100">
            ...
            <div class="card-body small text-muted">
                ...
                <ul class="ps-3 mb-0">
                 ...
                 <hr>
                 <p class="fw-semibold text-dark mb-2"><?php echo e(__('Attendance Setup')); ?></p>
                 <div class="mb-0">
                     <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($attendanceEvent): ?>
                         <a href="<?php echo e(route('churchmeet.attendance_events.edit', $attendanceEvent->id)); ?>"
                            ...
                            title="<?php echo e(__('Edit Attendance Event')); ?>">
                             <i class="ti ti-pencil me-1"></i><?php echo e(__('Open Attendance Session')); ?>

                         </a>
                     <?php else: ?>
                         <a href="<?php echo e(route('churchmeet.attendance_events.create', ['event_id' => $event->id])); ?>"
                            class="btn btn-sm btn-outline-primary"
                            title="<?php echo e(__('Create Attendance Event')); ?>">
                             <i class="ti ti-clipboard-check me-1"></i><?php echo e(__('Set Up Attendance For This Event')); ?>
