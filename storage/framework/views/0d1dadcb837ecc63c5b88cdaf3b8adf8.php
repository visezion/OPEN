            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="form-check">
                    <input class="form-check-input payment_method" name="payment_method" id="stripe-payment"
                        type="radio" data-payment-action="<?php echo e(route('beauty.spa.pay.with.stripe',[$slug])); ?>">
                </div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Stripe\src\Resources\views\payment\beauty_payment.blade.php ENDPATH**/ ?>