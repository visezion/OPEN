...
<?php $__env->startSection('page-action'); ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canJoinZoomMeeting): ?>
        <a href="<?php echo e(route('churchly.zoom.meetings.join', $attendanceEvent->id)); ?>" class="btn btn-primary btn-sm">
            <i class="ti ti-video"></i> <?php echo e(__('Join Meeting')); ?>

        </a>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canCreateZoomMeeting && !$canJoinZoomMeeting): ?>
        <form method="POST" action="<?php echo e(route('churchly.zoom.meetings.create', $event->id)); ?>" class="d-inline">
            <?php echo csrf_field(); ?>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <a href="<?php echo e(route('churchly.events.export.pdf', $event->id)); ?>" class="btn btn-danger btn-sm">
        <i class="ti ti-file-type-pdf"></i> Export PDF
    </a>
    <a href="<?php echo e(route('churchly.events.index')); ?>" class="btn btn-light btn-sm">
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($event->status):
                        ...
                        <div class="border-top pt-3 mt-2">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <strong><?php echo e($event->lead->name ?? '—'); ?></strong>
                                </div>
                                <div class="col-md-4">
                                    <p class="mb-1 text-muted small">Assistant / Co-Leader</p>
                                    <strong><?php echo e($event->assistant->name ?? '—'); ?></strong>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($attendanceEvent->meeting_id): ?>
                                            <div class="small text-muted mt-1">
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($attendanceEvent->meeting_passcode): ?>
                                                    • <?php echo e(__('Passcode')); ?>: <?php echo e($attendanceEvent->meeting_passcode); ?>
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <?php elseif($canCreateZoomMeeting): ?>
                                            <form method="POST" action="<?php echo e(route('churchly.zoom.meetings.create', $event->id)); ?>">
                                                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="p-3 rounded <?php echo e($comment->user_id === Auth::id() ? 'bg-primary text-white' : 'bg-white border'); ?>"
                                        ...
                                        <div class="small fw-bold mb-1">
                                            ...
                                            <span class="text-muted small">
                                                • <?php echo e(\Carbon\Carbon::parse($comment->commented_at)->diffForHumans()); ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\attendance\events\show.blade.php ENDPATH**/ ?>