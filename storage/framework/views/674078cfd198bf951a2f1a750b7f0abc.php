<script>
    (function () {
        ...
        const refreshUrl = <?php echo json_encode(route('session.token'), 15, 512) ?>;
...
<?php /**PATH C:\xampp\htdocs\OPEN\resources\views/partials/csrf-keepalive.blade.php ENDPATH**/ ?>