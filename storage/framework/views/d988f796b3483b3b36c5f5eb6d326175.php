<?php
    $path = url("/packages/workdo/Account/src/marketplace");
?>
                            ...
                            <div class="tabs-container">
                                <div class="tab-content active" id="tab-1">
                                    <div class="pricing-content">
                                        ...
                                        <div class="lbl"><?php echo e(__('Billed monthly, or')); ?>

                                            <b><?php echo e(super_currency_format_with_sym($module->monthly_price) . '/'); ?></b><?php echo e(__(' if paid monthly')); ?>
    ...
    <section class="screenshot-section padding-top padding-bottom">
        <div class="container">
            ...
            <div class="screenshot-slider">
                ...
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="<?php echo e($path.'/image4.png'); ?>" target="_blank" class="img-zoom">
                            <img src="<?php echo e($path.'/image4.png'); ?>" alt="">
                        </a>
                    </div>
                </div>
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="<?php echo e($path.'/image5.png'); ?>" target="_blank" class="img-zoom">
                            <img src="<?php echo e($path.'/image5.png'); ?>" alt="">
                        </a>
                    </div>
                </div>
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="<?php echo e($path.'/image6.png'); ?>" target="_blank" class="img-zoom">
...
<?php echo $__env->make('marketplace.marketplace', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Account\src\Resources\views\marketplace\index.blade.php ENDPATH**/ ?>