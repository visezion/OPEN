    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2><?php echo e(__('Stripe')); ?><b><?php echo e(__('Payment')); ?></b><?php echo e(__('Gateway')); ?></h2>
                <p><?php echo e(__('Stripe is an online payment processing and credit card processing platform for businesses. ')); ?></p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2><?php echo e(__('Why use Stripe payment?')); ?></h2>
                        </div>
                        <p><?php echo e(__('Stripe Payments is a powerful payment processor for online sales. It can accept dozens of payment methods and more than 135 currencies. And its advanced developer tools allow you to create a checkout flow that feels custom, provided you know how to use them.')); ?></p>
                    </div>
                </div>
                            ...
                            <div class="tabs-container">
                                <div class="tab-content active" id="tab-1">
                                    <div class="pricing-content">
                                        <div class="price">
                                            <ins><span class="currency-type"><?php echo e(super_currency_format_with_sym($module->yearly_price)); ?></span> <span class="time-lbl text-muted"><?php echo e(__('/Month')); ?></span></ins>
                                        </div>
                                        <div class="lbl"><?php echo e(__('Billed monthly, or')); ?> <b><?php echo e(super_currency_format_with_sym($module->yearly_price).'/'); ?></b><?php echo e(__(' if paid monthly')); ?></div>
                                        <div class="btn-group">
                                ...
                                <div class="tab-content" id="tab-2">
                                    <div class="pricing-content">
                                        ...
                                        <div class="lbl"><?php echo e(__('Billed yearly, or')); ?> <b><?php echo e(super_currency_format_with_sym($module->monthly_price).'/'); ?></b><?php echo e(__(' if paid yearly')); ?></div>
                                        <div class="btn-group">
                                            <a href="<?php echo e(route('apps.pricing')); ?>" class="btn-secondary"><?php echo e(__('Buy Now')); ?> <svg
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    viewBox="0 0 16 16" fill="none">
                        ...
                        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 product-card">
                            <div class="product-card-inner">
                                ...
                                <div class="product-content">
                                    <h4> <a href="#!"><?php echo e($module->alias); ?></a> </h4>
                                    <div class="price">
                                        <ins><span class="currency-type"><?php echo e(super_currency_format_with_sym($module->monthly_price)); ?></span> <span class="time-lbl text-muted"><?php echo e(__('/Month')); ?></span></ins>
                                                    <ins><span class="currency-type"><?php echo e(super_currency_format_with_sym($module->yearly_price)); ?></span> <span class="time-lbl text-muted"><?php echo e(__('/Year')); ?></span></ins>
                                    </div>
...
<?php echo $__env->make('marketplace.marketplace', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Stripe\src\Resources\views\marketplace\index.blade.php ENDPATH**/ ?>