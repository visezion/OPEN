...
<div class="wrapper">
    <!-- product main start -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($marketplace['product_main_status'] == 'on'): ?>
                ...
                <div class="row row-gap align-items-center pdp-summery-row">
                    <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                        <div class="pdp-summery">
                            ...
                            <div class="price">
                                <ins><span class="currency-type"><?php echo e(super_currency_format_with_sym($module->monthly_price)); ?></span> <span class="time-lbl text-muted"><?php echo e(__('/Month')); ?></span></ins>
                                <ins><span class="currency-type"><?php echo e(super_currency_format_with_sym($module->yearly_price)); ?></span> <span class="time-lbl text-muted"><?php echo e(__('/Year')); ?></span></ins>
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                        <div class="pdp-image-wrapper">
                            <div class="pdp-media banner-img-wrapper">
                                ...
                                <img src="<?php echo e(check_file($marketplace['product_main_banner']) ? get_file($marketplace['product_main_banner']) : asset($old_path."/image1.png")); ?>" alt="" class="inner-frame-img">
                        </div>
                        </div>
                    </div>
                </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($marketplace['dedicated_theme_section_status'] == 'on'): ?>
        <section class="dedicated-themes-section ">
            <div class="container">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array(json_decode($marketplace['dedicated_theme_sections'], true)) || is_object(json_decode($marketplace['dedicated_theme_sections'], true))): ?>
                    <?php
                        $img = 2 ;
                    ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = json_decode($marketplace['dedicated_theme_sections'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="row row-gap padding-bottom ">
                                <div class="col-lg-5 col-md-6 col-12">
                                    <div class="abt-theme">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($value['dedicated_theme_section_cards'][1]['title']) && $value['dedicated_theme_section_cards'][1]['title'] != null && $value['dedicated_theme_section_cards'][1]['title'] != ''): ?>
                                            <div class="theme-acnav">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $value['dedicated_theme_section_cards']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-lg-7 col-md-6 col-12">
                                    <div class="dash-theme-preview">
                                        <img src="<?php echo e(check_file($value['dedicated_theme_section_image']) ? get_file($value['dedicated_theme_section_image']) : (check_file($old_path."/image".$img.".png") ? asset($old_path."/image".$img.".png") : asset($old_path."/image1.png"))); ?>" alt="" class="inner-frame-img">
                                    </div>
                                </div>
                            </div>
                        <?php else: ?>
    ...
    <!-- why-choose start -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($marketplace['whychoose_sections_status'] == 'on'): ?>
                    ...
                    <div class="row row-gap">
                        <div class="col-lg-6 col-md-6 col-12">
                            ...
                            <ul class="variable-list">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($marketplace['pricing_plan_text'])): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = json_decode($marketplace['pricing_plan_text'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                ...
                                <div class="tabs-container">
                                    <div class="tab-content active" id="tab-1">
                                        <div class="pricing-content">
                                            ...
                                            <div class="lbl"><?php echo e(__('Billed monthly, or')); ?> <b><?php echo e(super_currency_format_with_sym($module->monthly_price).'/'); ?></b><?php echo e(__(' if paid monthly')); ?></div>
                                            <div class="btn-group">
                                    ...
                                    <div class="tab-content" id="tab-2">
                                        <div class="pricing-content">
                                            ...
                                            <div class="lbl"><?php echo e(__('Billed yearly, or')); ?> <b><?php echo e(super_currency_format_with_sym($module->yearly_price).'/'); ?></b><?php echo e(__(' if paid yearly')); ?></div>
                                            <div class="btn-group">
                                                <a href="<?php echo e(route('apps.pricing')); ?>" class="btn-secondary"><?php echo e(__('Buy Now')); ?> <svg
                                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                        viewBox="0 0 16 16" fill="none">
    ...
    <section class="screenshot-section padding-top">
        <div class="container">
            <div class="screenshot-slider">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array(json_decode($marketplace['screenshots'], true)) || is_object(json_decode($marketplace['screenshots'], true))): ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = json_decode($marketplace['screenshots'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $imageKey = $key + 1 ;
                        ?>
                            <div class="screenshot-itm">
                                <div class="screenshot-image">
                                    <a href="<?php echo e(check_file($value['screenshots']) ? get_file($value['screenshots']) :(check_file($old_path."/image".$imageKey.".png") ? asset($old_path."/image".$imageKey.".png") : asset($old_path."/image3.png"))); ?>" target="_blank" class="img-zoom">
                                        <img src="<?php echo e(check_file($value['screenshots']) ? get_file($value['screenshots']) :(check_file($old_path."/image".$imageKey.".png") ? asset($old_path."/image".$imageKey.".png") : asset($old_path."/image3.png"))); ?>" alt="" class="inner-frame-img">
                                    </a>
                                </div>
                            </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <!-- addon section start -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($marketplace['addon_section_status'] == 'on'): ?>
                            ...
                            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 product-card">
                                <div class="product-card-inner">
                                    ...
                                    <div class="product-content">
                                        <h4> <a href="product.html"><?php echo e($module->alias); ?></a> </h4>
                                        <div class="price">
                                            <ins><span class="currency-type"><?php echo e(super_currency_format_with_sym($module->monthly_price)); ?></span> <span class="time-lbl text-muted"><?php echo e(__('/Month')); ?></span></ins>
                                                        <ins><span class="currency-type"><?php echo e(super_currency_format_with_sym($module->yearly_price)); ?></span> <span class="time-lbl text-muted"><?php echo e(__('/Year')); ?></span></ins>
                                        </div>
                                        <a href="<?php echo e(route('software.details',$module->alias)); ?>" target="_new"  class="btn cart-btn">View Details</a>
                                    </div>
                                </div>
                            </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php echo $__env->make('landingpage::layouts.marketplace', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\LandingPage\src\Resources\views\marketplace\index.blade.php ENDPATH**/ ?>