<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-12 d-flex justify-content-end col-form-label">
            <a href="#" onclick="location.reload();" class="btn btn-secondary btn-light custom-cancel-btn" data-bs-dismiss="modal"><?php echo e(__('Cancel')); ?></a>
...
<script>
    $(document).ready(function()
    {
        ...
        $(document).on('click', '#import', function(event) {
            ...
            $.ajax({
                url: "<?php echo e(route('users.import.data')); ?>",
                method: "POST",
                data: {
                    name: name,
                    email: email,
...
<?php /**PATH C:\xampp\htdocs\OPEN\resources\views\users\import_modal.blade.php ENDPATH**/ ?>