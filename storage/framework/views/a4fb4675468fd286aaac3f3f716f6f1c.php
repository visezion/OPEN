...
<div class="row justify-content-center px-0">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(admin_setting('custome_package') == 'on'): ?>
        <div class=" col-12">
            <div class="card">
                        ...
                        <div class="card <?php echo e(($module->isEnabled()) ? 'enable_module' : 'disable_module'); ?>">
                            <div class="product-img">
                                <div class="theme-avtar">
                                    <img src="<?php echo e($module->image); ?><?php echo e('?'.time()); ?>"
                                        alt="<?php echo e($module->name); ?>" class="img-user"
                                        style="max-width: 100%">
                                    </div>
                                <div class="checkbox-custom">
                                    <div class="btn-group card-option">
                                        <button type="button" class="btn" data-ajax-popup="true" data-size="md" data-title="<?php echo e(__('Customize Logo And Name')); ?>"  data-url="<?php echo e(route('add-one.detail',$module->name)); ?>" data-bs-toggle="tooltip"  data-bs-original-title="<?php echo e(__('Module Setting')); ?>">
                            ...
                            <div class="product-content">
                                ...
                                <div class="price d-flex justify-content-between">
                                    ...
                                    <ins><span><?php echo e(super_currency_format_with_sym(ModulePriceByName($module->name)['monthly_price'])); ?></span> <span class="time-lbl text-muted"><?php echo e(__('/Month')); ?></span></ins>
                                    <ins><span><?php echo e(super_currency_format_with_sym(ModulePriceByName($module->name)['yearly_price'])); ?></span> <span class="time-lbl text-muted"><?php echo e(__('/Year')); ?></span></ins>
                                </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\resources\views\plans\index.blade.php ENDPATH**/ ?>