            ...
            <div class="row dashboard-wrp">
                ...
                <?php
                    ...
                    $feedbackStats = [
                        ...
                        ['label' => 'Resolved Weekly Reports', 'icon' => 'ti ti-check', 'count' => $statswithcount['resolved'] ?? 0, 'color' => 'text-success'],
                        ['label' => 'Reviewed Weekly Reports', 'icon' => 'ti ti-eye-check', 'count' => $statswithcount['reviewed'] ?? 0, 'color' => 'text-warning'],
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\feedback\dashboard.blade.php ENDPATH**/ ?>