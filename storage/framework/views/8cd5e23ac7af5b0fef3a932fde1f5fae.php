<div class="price-summery-card">
    <div class="price-sm-card-top">
        ...
        <div class="price-pay-info">
            ...
            <p><?php echo e(__('Order processing will be longer')); ?></p>
        </div>
        <form method="POST" action="<?php echo e(route('pay.with.paypal', $slug)); ?>"
...
</div><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Paypal\src\Resources\views\payment\holidayz_nav_containt_div.blade.php ENDPATH**/ ?>