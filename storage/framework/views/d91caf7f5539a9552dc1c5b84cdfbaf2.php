    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="form-group col-md-12 page_content">
                <?php echo e(Form::label('name',__('Page Short Description'),['class'=>'form-label'])); ?>

                <?php echo e(Form::text('menubar_page_short_description', (isset($page['menubar_page_short_description']) && !empty($page['menubar_page_short_description'])) ? $page['menubar_page_short_description'] : '',array('class'=>'form-control font-style','placeholder'=>__('Enter Page Short Description')))); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\LandingPage\src\Resources\views\custom_page\edit.blade.php ENDPATH**/ ?>