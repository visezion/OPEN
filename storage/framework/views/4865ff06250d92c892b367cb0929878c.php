...
<?php $__env->startSection('page-breadcrumb'); ?>
    <?php echo e(__('Events/Meetings Details')); ?>
        ...
        <div class="card-body p-4">
            <div class="d-flex flex-wrap justify-content-between align-items-start gap-3">
                ...
                <div class="d-flex flex-wrap align-items-center gap-2">
                    ...
                    <button type="button" class="btn btn-sm btn-outline-secondary churchmeet-copy-trigger" data-copy-text="<?php echo e($eventShareUrl); ?>" data-copy-default="<?php echo e(__('Copy Events/Meetings Link')); ?>" data-copy-success="<?php echo e(__('Copied')); ?>">
                        <i class="ti ti-link me-1"></i><span><?php echo e(__('Copy Events/Meetings Link')); ?></span>
                    </button>
