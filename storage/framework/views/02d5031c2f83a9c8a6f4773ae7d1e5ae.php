...
<body class="<?php echo e(!empty($themeColor)?$themeColor:'theme-1'); ?>" >
    ...
    <?php if( isset($settings['enable_cookie']) && $settings['enable_cookie'] == 'on'): ?>
        <?php echo $__env->make('landingpage::layouts.cookie_consent', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
    ...
    <?php $__currentLoopData = \Workdo\LandingPage\Entities\Pixel::getPixelScript(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $script): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?= $script ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</body>
