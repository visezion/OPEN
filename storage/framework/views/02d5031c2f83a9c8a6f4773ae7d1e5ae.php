...
<head>
    ...
    <title><?php echo $__env->yieldContent('page-title'); ?> | <?php echo e(!empty(admin_setting('title_text')) ? admin_setting('title_text') : config('app.name', 'Openzion')); ?></title>

    <meta name="title" content="<?php echo e(!empty($settings['meta_title']) ? $settings['meta_title'] : config('app.name', 'Openzion')); ?>">
    <meta name="keywords" content="<?php echo e(!empty($settings['meta_keywords']) ? $settings['meta_keywords'] : 'ministry platform,church operations,faith teams'); ?>">
    <meta name="description" content="<?php echo e(!empty($settings['meta_description']) ? $settings['meta_description'] : 'Faith-aligned platform for church administration, ministry teams, and accountable service workflows.'); ?>">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo e(env('APP_URL')); ?>">
    <meta property="og:title" content="<?php echo e(!empty($settings['meta_title']) ? $settings['meta_title'] : config('app.name', 'Openzion')); ?>">
    <meta property="og:description" content="<?php echo e(!empty($settings['meta_description']) ? $settings['meta_description'] : 'Faith-aligned platform for church administration, ministry teams, and accountable service workflows.'); ?> ">
    ...
    <meta property="twitter:title" content="<?php echo e(!empty($settings['meta_title']) ? $settings['meta_title'] : config('app.name', 'Openzion')); ?>">
    <meta property="twitter:description" content="<?php echo e(!empty($settings['meta_description']) ? $settings['meta_description'] : 'Faith-aligned platform for church administration, ministry teams, and accountable service workflows.'); ?> ">
    ...
    <meta name="author" content="<?php echo e(!empty(admin_setting('title_text')) ? admin_setting('title_text') : config('app.name', 'Openzion')); ?>">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(admin_setting('site_rtl') == 'on'): ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(admin_setting('cust_darklayout') == 'on'): ?>
        <link rel="stylesheet" href="<?php echo e(asset('market_assets/css/main-style-dark.css')); ?>" id="main-style-link">
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($settings['body_fontfamily'])): ?>
        <style id="dynamic-fonts">
            <?php echo \Workdo\LandingPage\Entities\LandingPageSetting::generateFontCSSFromJSON($settings['body_fontfamily']); ?>

        </style>
        <style>
            :root {
                --first-font: '<?php echo e($settings['body_fontfamily']); ?>' !important;
            }
        </style>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($settings['is_pwa_store_active'])  && $settings['is_pwa_store_active'] == 'on'): ?>
    ...
    ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($settings['theme_color'])): ?>
        <meta name="theme-color" content="<?php echo e($pwa->theme_color); ?>" />
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($settings['background_color'])): ?>
...
<body class="<?php echo e(!empty($themeColor)?$themeColor:'theme-1'); ?>" >
    ...
    <header class="site-header header-style-one">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['is_top_bar_active'] == 'on'): ?>
                        ...
                        <ul class="main-nav">
                            ...
                            <li class="menu-lnk">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(admin_setting('plan_package') == 'on'): ?>
                                    <a href="<?php echo e(route('apps.pricing.plan')); ?>"><?php echo e(__('Pricing')); ?></a>
                                <?php else: ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array(json_decode($settings['menubar_page'])) || is_object(json_decode($settings['menubar_page']))): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = json_decode($settings['menubar_page']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($value->header == 'on'): ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($value->template_name == 'page_content'): ?>
                                            <li class="menu-lnk">
    ...
    <div class="home-wrapper">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = json_decode( $settings['landing_page_section_sequence'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <!-- [ Banner ] start -->
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['is_banner_section_active'] == 'on' && $value == 'is_banner_section_active'): ?>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="banner-content">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['home_live_demo_link']): ?>
                    ...
                    <div class="exclusive-partners">
                        <div class="container">
                            ...
                            <div class="partners-logo-slider">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(explode(',', $settings['home_logo']) && count(explode(',', $settings['home_logo'])) > 1 ): ?>
                                    ...
                                    <div class="logo-item">
                                        <a href="#">
                                            <img src="<?php echo e(check_file($home_logo) ? get_file($home_logo) : $old_path."/logo-dark.png"); ?>" alt="exclusive partner">
                                        </a>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php else: ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['is_features_section_active'] == 'on' && $value == 'is_features_section_active'): ?>
                <section class="support-section">
                    <div class="container">
                        <div class="row align-items-start justify-content-center ">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array(json_decode($settings['feature_of_features'], true)) ||
                                is_object(json_decode($settings['feature_of_features'], true))): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = json_decode($settings['feature_of_features'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-lg-4 col-md-6 col-12 support-card">
                                        <div class="support-card-inner">
                                            <div class="support-card-media">
                                                <div class="card-icon">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(check_file($value['feature_logo'])): ?>
                ...
                <section class="dedicated-themes-section">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array(json_decode($settings['other_features'], true)) ||
                        is_object(json_decode($settings['other_features'], true))): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = json_decode($settings['other_features'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($key % 2 == 0): ?>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-5 col-md-6 col-12">
                                                    <div class="abt-theme">
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($value['cards'])): ?>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $value['cards']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5 col-md-6 col-12">
                                                    <div class="abt-theme">
                                                        ...
                                                        <p><?php echo $value['other_featured_description']; ?></p>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($value['cards'][1]['title']) && $value['cards'][1]['title'] != null && $value['cards'][1]['title'] != ''): ?>
                                                            <div class="theme-acnav">
                                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $value['cards']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <div class="set has-children">
                                                                        <a href="javascript:;" class="acnav-label">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['is_reviews_section_active'] == 'on' && $value == 'is_reviews_section_active'): ?>
                <section class="review-section">
                    <div class="container">
                        <div class="review-slider">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array(json_decode($settings['reviews'], true)) ||
                            is_object(json_decode($settings['reviews'], true))): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = json_decode($settings['reviews'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <!-- [ Screenshots ] start -->
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['is_screenshots_section_active'] == 'on' && $value == 'is_screenshots_section_active'): ?>
                <section class="theme-preview-section">
                    <div class="container">
                        <div class="theme-preview-slider">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array(json_decode($settings['screenshots'], true)) || is_object(json_decode($settings['screenshots'], true))): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = json_decode($settings['screenshots'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <!-- [ dedicated ] start -->
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['is_dedicated_section_active'] == 'on' && $value == 'is_dedicated_section_active'): ?>
                <section class="dedicated-section">
                    <div class="container">
                        ...
                        <div class="row row-gap justify-content-center ">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array(json_decode($settings['dedicated_card_details'], true)) || is_object(json_decode($settings['dedicated_card_details'], true))): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = json_decode($settings['dedicated_card_details'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['is_buildtech_section_active'] == 'on' && $value == 'is_buildtech_section_active'): ?>
                <section class="built-technology">
                    <div class="container">
                        ...
                        <div class="row row-gap justify-content-center">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array(json_decode($settings['buildtech_card_details'], true)) || is_object(json_decode($settings['buildtech_card_details'], true))): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = json_decode($settings['buildtech_card_details'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['is_package_details_section_active'] == 'on' && $value == 'is_package_details_section_active'): ?>
    ...
    <!-- Footer start here -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['footer_status'] == 'on'): ?>
            ...
            <div class="container">
                <div class="footer-top">
                    ...
                    <div class="footer-top-right">
                        <ul>
                            <li>
                                <a href="<?php echo e($settings['footer_live_demo_link']); ?>" class="btn-secondary"><?php echo e($settings['footer_gotoshop_button_text'] ??  __('Go to Shop')); ?><svg
                            ...
                            <li>
                                <a href="<?php echo e($settings['footer_support_link']); ?>" class="btn-link"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                        ...
                                        <path
                                            ...
                                            fill="#6FD943" />
                                    </svg><?php echo e($settings['footer_support_button_text'] ?? __('Support')); ?></a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="footer-row">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array(json_decode($settings['footer_sections_details'], true)) || is_object(json_decode($settings['footer_sections_details'], true))): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = json_decode($settings['footer_sections_details'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="footer-col footer-link footer-link-1">
                                    <div class="footer-widget">
                                        <h4><?php echo e($value['footer_section_heading']); ?></h4>
                                        <ul>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($value['footer_section_text']) || !empty($value['footer_section_text'])): ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $value['footer_section_text']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <!-- Footer section start here -->
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if( isset($settings['is_newsletter_enabled']) && $settings['is_newsletter_enabled'] == 'on'): ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if( isset($settings['enable_cookie']) && $settings['enable_cookie'] == 'on'): ?>
        <?php echo $__env->make('landingpage::layouts.cookie_consent', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = \Workdo\LandingPage\Entities\Pixel::getPixelScript(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $script): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?= $script ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</body>
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\LandingPage\src\Resources\views\layouts\landingpage.blade.php ENDPATH**/ ?>