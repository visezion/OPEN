...
<?php endif; ?>
                                        ...
                                        <?php endif; ?>
                                        <?php if(module_is_active('RentalManagement')): ?>
                                        ...
                                        <?php endif; ?>
                                        <?php if(module_is_active('RestaurantMenu')): ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <?php if(module_is_active('Account') && $invoice->invoice_module == 'account'): ?>
        <script>
    ...
    <?php if(module_is_active('CMMS') && $invoice->invoice_module == 'cmms'): ?>
        <script>
            $(document).on('change', '.item', function() {
    ...
    <?php if(module_is_active('RentalManagement') && $invoice->invoice_module == 'rent'): ?>
        <script>
            $(document).on('change', '.item', function() {
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\resources\views\invoice\edit.blade.php ENDPATH**/ ?>