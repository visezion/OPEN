...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <?php echo e(Form::model($invoice, ['route' => ['invoice.update', $invoice->id], 'method' => 'PUT', 'class' => 'w-100', 'enctype' => 'multipart/form-data','class' => 'needs-validation', 'novalidate'])); ?>
        ...
        <?php elseif($invoice->invoice_module == 'rent'): ?>
        ...
        <?php elseif($invoice->invoice_module == 'sales'): ?>
            <input type="hidden" name="invoice_type" id="invoice_type" value="sales">
        <?php elseif($invoice->invoice_module == 'newspaper'): ?>
...
<?php endif; ?>
                                    ...
                                    <p class="text-danger d-none" id="account_validation">
                                        <?php echo e(__('Account Type field is required.')); ?></p>
                                </div>
                                <input type="hidden" name="account_type" value="<?php echo e($invoice->account_type ?? ''); ?>">
...
<?php endif; ?>
                                    ...
                                    <select name="customer_id" class="form-control" id="customer" required
                                        data-url="<?php echo e(route('invoice.customer')); ?>">
                                        ...
                                        <select class="form-control" name="invoice_template" id="invoice_template">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = templateData()['templates']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>"
                                                    <?php echo e($invoice->invoice_template == $key ? 'selected' : ''); ?>>
...
<?php endif; ?>
                                        <div class="form-icon-user">
                                            <?php echo e(Form::date('issue_date', null, ['class' => 'form-control ', 'required' => 'required', 'onchange' => 'Calculate()'])); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group invoice_div">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(module_is_active('Account')): ?>
                                            <?php echo e(Form::label('category_id', __('Category'), ['class' => 'form-label category_id'])); ?><?php if (isset($component)) { $__componentOriginalbba606fec37ea04333bc269e3e165587 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbba606fec37ea04333bc269e3e165587 = $attributes; } ?>
<?php $component = App\View\Components\Required::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php endif; ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(module_is_active('Taskly')): ?>
                                            ...
                                            <?php echo e(Form::select('project', $projects, $invoice->category_id, ['class' => 'form-control project_id'])); ?>
                                        ...
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(module_is_active('LMS')): ?>
                                            <?php echo e(Form::label('course_order', __('Course Order'), ['class' => 'form-label course_order'])); ?>

                                            <?php echo e(Form::select('course_order', [], $invoice->category_id, ['class' => 'form-control course_order'])); ?>

                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(module_is_active('RentalManagement')): ?>
                                            <?php echo e(Form::label('rent_type', __('Rent Type'), ['class' => 'form-label'])); ?>

                                            <?php echo e(Form::select('rent_type', $rent_type, null, ['class' => 'form-control rent_type', 'onchange' => 'Calculate()'])); ?>

                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(module_is_active('RestaurantMenu')): ?>
                                            <?php echo e(Form::label('restaurant_order', __('Restaurant Order'), ['class' => 'form-label restaurant_order'])); ?>

                                            <?php echo e(Form::select('restaurant_order', [], $invoice->category_id, ['class' => 'form-control restaurant_order'])); ?>
                                ...
                                <div class="col-md-6 tax_project_div <?php echo e(module_is_active('Account') || module_is_active('CMMS') ? 'd-none' : ''); ?>">
                                    <div class="form-group">
                                        <?php echo e(Form::label('tax_project', __('Tax'), ['class' => 'form-label'])); ?>

                                        <?php echo e(Form::select('tax_project[]', $taxs, !empty($invoice->items->first()->tax) ? explode(',', $invoice->items->first()->tax) : null, ['class' => 'form-control get_tax multi-select choices', 'multiple' => 'multiple', 'id' => 'tax_project', 'placeholder' => 'Select Tax'])); ?>
...
<?php endif; ?>
                                                ...
                                                <optgroup label="<?php echo e($typeName); ?>">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $subtypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subtypeId => $subtypeData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $subtypeData['chart_of_accounts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chartOfAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($chartOfAccount['id']); ?>" <?php echo e($chartOfAccount['id'] == $invoice->account_id ? 'selected' : ''); ?>>
                                                            ...
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $subtypeData['subAccounts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                ...
                                                                <option value="<?php echo e($subAccount['id']); ?>" class="ms-5" <?php echo e($subAccount['id'] == $invoice->account_id ? 'selected' : ''); ?>> &nbsp; &nbsp;&nbsp;&nbsp; <?php echo e(' - '. $subAccount['account_name']); ?></option>
                                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php echo $__env->yieldPushContent('add_invoices_agent_filed_edit'); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(module_is_active('Account') && $invoice->invoice_module == 'account'): ?>
        <script>
    ...
    <?php elseif(module_is_active('Taskly') && $invoice->invoice_module == 'taskly'): ?>
        <script>
            $(document).ready(function() {
    ...
    <?php elseif(module_is_active('CMMS') && $invoice->invoice_module == 'cmms'): ?>
        <script>
            $(document).ready(function() {
                $('.category_id').addClass('d-none');
                $('.project_id').addClass('d-none');
    ...
    <?php elseif(module_is_active('LMS') && $invoice->invoice_module == 'lms'): ?>
        <script>
            $(document).ready(function() {
                $('.tax_project_div').removeClass('d-none');
                $('.category_id').addClass('d-none');
    ...
    <?php elseif(module_is_active('RentalManagement') && $invoice->invoice_module == 'rent'): ?>
        <script>
            $(document).ready(function() {
                $('.category_id').addClass('d-none');
                $('.project_id').addClass('d-none');
    ...
    <?php elseif(module_is_active('Sales') && $invoice->invoice_module == 'sales'): ?>
        <script>
            $(document).ready(function() {
    ...
    <?php elseif(module_is_active('ChildcareManagement') && $invoice->invoice_module == 'childcare'): ?>
        <script>
            $(document).ready(function() {
    ...
    <?php elseif(module_is_active('RestaurantMenu') && $invoice->invoice_module == 'RestaurantMenu'): ?>
        <script>
            $(document).ready(function() {
                $(".tax_project_div").addClass('d-none');
                $('.category_id').addClass('d-none');
                ...
                success: function(response) {
                    ...
                    if (response.label == 'Inspection Request') {
                        <?php $__currentLoopData = $inspectionRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $invoice_id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            options +=
                                `<option value="<?php echo e($id); ?>" <?php echo e($invoice->customer_id == $invoice_id ? 'selected' : ''); ?>> ${formattedInvoice} </option>`;
                        ...
                        $.each(response.customers, function(indexInArray, valueOfElement) {
                            var selected = '<?php echo e($invoice->user_id); ?>' == indexInArray ?
                                'selected' : '';
    ...
    <script>
        ...
        function deleteInvoiceItem($row, id, recalculateTotalsCallback) {
            if (confirm('Are you sure you want to delete this element?')) {
                ...
                var invoice_type = '<?php echo e($invoice->invoice_module); ?>';
                ...
                success: function(data) {
                    ...
                    if ($('#invoice_type').val() == 'childcare') {
                        ...
                        $.each(data.courseorder, function(key, value) {
                            var course = '<?php echo e($invoice->category_id); ?>';
                        ...
                        $.each(data.restaurantorder, function(key, value) {
                            var restaurant = '<?php echo e($invoice->category_id); ?>';
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(module_is_active('CMMS') && $invoice->invoice_module == 'cmms'): ?>
        <script>
            $(document).on('change', '.item', function() {
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(module_is_active('RentalManagement') && $invoice->invoice_module == 'rent'): ?>
        <script>
            $(document).on('change', '.item', function() {
    ...
    <script>
        $(document).on('change', "[name='invoice_type_radio']", function() {
            ...
            $(".invoice_div").empty();
            var invoice_module = '<?php echo e($invoice->invoice_module); ?>';
...
<?php endif; ?> <?php echo e(Form::select('category_id', $category, null, ['class' => 'form-control', 'required' => 'required'])); ?>`;
                ...
                if ('<?php echo e($invoice->invoice_module); ?>' == 'account') {
...
<?php $component = $__componentOriginalbba606fec37ea04333bc269e3e165587; ?>
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?> <?php echo e(Form::select('project', $projects, $invoice->category_id, ['class' => 'form-control', 'required' => 'required'])); ?>`
                $(".invoice_div").append(label);
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                    <?php echo e(Form::select('course_order', [], $invoice->category_id, ['class' => 'form-control', 'required' => 'required'])); ?>`
                $(".invoice_div").append(label);
            ...
            const handleSalesInvoice = () => {
                ...
                <?php $__currentLoopData = $sale_invoice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $invoice_id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    options +=
                        `<option value="<?php echo e($id); ?>" <?php echo e($invoice->category_id == $invoice_id ? 'selected' : ''); ?>> ${formattedInvoice} </option>`;
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                    <?php echo e(Form::number('repair_charge', $invoice->category_id, ['class' => 'form-control service_charge', 'required' => 'required', 'id' => 'repair_charge', 'placeholder' => 'Enter Repair Charge', 'value' => '0'])); ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
                    <?php echo e(Form::number('service_charge', $invoice->category_id, ['class' => 'form-control service_charge', 'required' => 'required', 'id' => 'service_charge', 'placeholder' => 'Enter Service Charge', 'value' => '0'])); ?>
...
<?php $component = $__componentOriginalbba606fec37ea04333bc269e3e165587; ?>
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?> <?php echo e(Form::select('restaurant_order', [], $invoice->category_id, ['class' => 'form-control', 'required' => 'required'])); ?>`
                $(".invoice_div").append(label);
    ...
    <script>
        $(document).ready(function() {
            ...
            var valueToMatch = "<?php echo e($invoice->account_type); ?>";
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\resources\views\invoice\edit.blade.php ENDPATH**/ ?>