            ...
            <div class="card mb-4 shadow-sm border-0">
                <div class="card-body">
                    ...
                    <table class="table table-sm table-hover align-middle">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $reqHeatmap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
            ...
            <div class="card mb-4 shadow-sm border-0">
                <div class="card-body">
                    ...
                    <table class="table table-sm table-hover align-middle">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $leaderboard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
        ...
        <div class="col-md-6">
            <div class="card mb-4 shadow-sm border-0">
                <div class="card-body">
                    ...
                    <?php if($stalledMembers->count()): ?>
                        <ul class="list-group list-group-flush">
                            <?php $__currentLoopData = $stalledMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col-md-6">
            <div class="card mb-4 shadow-sm border-0">
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        <?php $__currentLoopData = $deptStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Providers/../Resources/views/discipleship/dashboard.blade.php ENDPATH**/ ?>