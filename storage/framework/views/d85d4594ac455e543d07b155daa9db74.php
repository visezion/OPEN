<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-12 d-flex justify-content-end col-form-label">
            <input type="button" value="<?php echo e(__('Cancel')); ?>" class="btn btn-secondary btn-light custom-cancel-btn" data-bs-dismiss="modal">
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '#import', function(event) {
            ...
            $.ajax({
                url: "<?php echo e(route('customer.import.data')); ?>",
                method: "POST",
                data: {
                    name: name,
                    email: email,
...
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Account\src\Resources\views\customer\import_modal.blade.php ENDPATH**/ ?>