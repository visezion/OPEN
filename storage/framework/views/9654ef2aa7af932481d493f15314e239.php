                ...
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <div class="price">
                            ...
                            <ins><span class="currency-type"><?php echo e(super_currency_format_with_sym($module->monthly_price)); ?></span> <span class="time-lbl text-muted"><?php echo e(__('/Year')); ?></span></ins>
                        </div>
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2><?php echo e(__('Paypal ')); ?><b><?php echo e(__('Payment ')); ?></b><?php echo e(__(' Getway')); ?></h2>
                <p><?php echo e(__('Compared to credit cards, PayPal can be considered as safe.')); ?></p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2><?php echo e(__('The Advantages of Using PayPal ')); ?></h2>
                        </div>
                        <p><?php echo e(__('Although there are dozens of payment systems online, millions of freelancers across the globe still prefer PayPal. It features a robust, widely accessible system. You can create a free PayPal account and start receiving payments within minutes.
            ...
            <div class="screenshot-slider">
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="<?php echo e($path.'/image2.png'); ?>" target="_blank" class="img-zoom">
                            <img src="<?php echo e(($path.'/image2.png')); ?>" alt="">
                        </a>
                    </div>
                </div>
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="<?php echo e($path.'/image3.png'); ?>" target="_blank" class="img-zoom">
                            <img src="<?php echo e(($path.'/image3.png')); ?>" alt="">
                        </a>
                    </div>
                </div>
                ...
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="<?php echo e($path.'/image1.png'); ?>" target="_blank" class="img-zoom">
...
<?php echo $__env->make('marketplace.marketplace', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Paypal\src\Resources\views\marketplace\index.blade.php ENDPATH**/ ?>