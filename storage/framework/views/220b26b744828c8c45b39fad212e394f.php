        ...
        <section class="expired-frame" aria-labelledby="expired-title">
            <div class="expired-grid">
                <div class="expired-story">
                    ...
                    <h1 class="expired-title" id="expired-title"><?php echo e(__('This page lost its secure session.')); ?></h1>
                    <p class="expired-copy">
                        <?php echo e(__('The form or action you opened is no longer holding a valid security token. This usually means the session sat too long, the page was duplicated in other tabs, or the browser sent an older form state back to the server.')); ?>
                    ...
                    <div class="expired-rail">
                        <article class="expired-note">
                            ...
                            <div>
                                ...
                                <span><?php echo e(__('OPEN blocked the request because the page token expired before submission, which is safer than accepting an outdated form.')); ?></span>
                            </div>
                        </article>
                        ...
                        <article class="expired-note">
                            ...
                            <div>
                                ...
                                <span><?php echo e(__('Refresh this page first, then repeat the action from a fresh screen so the new session token is used.')); ?></span>
                            </div>
                        </article>
                    </div>
                </div>
                ...
                <aside class="expired-panel">
                    <div class="expired-panel__card">
                        <p class="expired-panel__eyebrow"><?php echo e(__('Recover Quickly')); ?></p>
                        <h2 class="expired-panel__title"><?php echo e(__('Get back into the flow')); ?></h2>
                        <p class="expired-panel__copy">
                            <?php echo e(__('Use the actions below to reopen the request safely. If you were editing a long form, refresh first before re-entering anything important.')); ?>

                        </p>

                        <div class="expired-actions">
                            <a href="<?php echo e(url()->current()); ?>" class="btn btn-primary"><?php echo e(__('Refresh This Page')); ?></a>
                            <a href="<?php echo e(url()->previous()); ?>" class="btn btn-outline-light"><?php echo e(__('Return To Previous Page')); ?></a>
                        </div>
                    </div>

                    <div class="expired-panel__card">
                        <p class="expired-panel__eyebrow"><?php echo e(__('Helpful Checks')); ?></p>
                        <ul class="expired-tiplist">
                            ...
                            <li>
                                <span>3</span>
                                <div><?php echo e(__('If this repeats often on one screen, it may be worth reviewing that workflow for long idle form sessions.')); ?></div>
                            </li>
                        </ul>
                    </div>

                    <div class="expired-footer">
                        <?php echo e(__('Status')); ?>: 419 · <?php echo e(__('Page Expired')); ?>
