...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Create Events/Meetings')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-breadcrumb'); ?>
    <?php echo e(__('ChurchMeet')); ?>,<?php echo e(__('Create Events/Meetings')); ?>
        ...
        <div class="card create-hero">
            <div class="card-body p-4">
                <div class="d-flex flex-wrap justify-content-between gap-3 align-items-start">
                    <div>
                        <h4 class="mb-2"><?php echo e(__('Create New Events/Meetings')); ?></h4>
            ...
            <div class="card-body p-4">
                <form method="POST" action="<?php echo e(route('churchmeet.events.store')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            <label class="form-label"><?php echo e(__('Repeat Until')); ?></label>
                            <input type="datetime-local" class="form-control" name="recurrence_until" value="<?php echo e(old('recurrence_until')); ?>">
                        </div>

                        <div class="col-md-3 mb-3">
                            <label class="form-label"><?php echo e(__('Occurrence Limit')); ?></label>
                            <input type="number" min="1" max="365" class="form-control" name="recurrence_count" value="<?php echo e(old('recurrence_count')); ?>" placeholder="<?php echo e(__('Optional')); ?>">
                            <small class="text-muted"><?php echo e(__('Use a repeat until date, a limit, or both.')); ?></small>
                        </div>
                            ...
                            <table class="table table-sm table-hover align-middle mb-0 smart-timeline-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="churchmeet-col-240"><?php echo e(__('Time Slot')); ?></th>
                                    </tr>
                                </thead>
