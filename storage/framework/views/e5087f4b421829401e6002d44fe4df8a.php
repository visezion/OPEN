...
<?php $__env->startSection('page-action'); ?>
    <a href="<?php echo e(route('churchmeet.events.index')); ?>" class="btn btn-secondary btn-sm">
                ...
                <form method="POST" action="<?php echo e(route('churchmeet.events.store')); ?>" enctype="multipart/form-data">
                    ...
                    <?php else: ?>
                        <div class="alert alert-warning">
                            ...
                            <a href="<?php echo e(route('churchmeet.zoom.index')); ?>" class="alert-link"><?php echo e(__('Open Zoom settings')); ?></a>
                        </div>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\ChurchMeet\src\Resources\views\attendance\events\create.blade.php ENDPATH**/ ?>