                                ...
                                <div class="invoice-print">
                                    ...
                                    <div class="p-sm-4 p-3 invoice-billed">
                                        <div class="row row-gap">
                                            ...
                                            <div class="col-lg-4 col-sm-6">
                                                <div class="invoice-billed-inner">
                                                    ...
                                                    <div class="billed-content-top">
                                                        ...
                                                        <div class="invoice-billed-content">
                                                            <?php if(company_setting('bill_shipping_display') == 'on'): ?>
                                                                <p class="mb-2">
                                            ...
                                            <?php if(!empty($company_settings['bill_qr_display']) && $company_settings['bill_qr_display'] == 'on'): ?>
                                                <div class="col-lg-2 col-sm-6">
                                        ...
                                        <div class="mt-2 table-responsive">
                                            <table class="table mb-0 table-striped">
                                                <tr>
                                                    ...
                                                    <?php if($bill->bill_module == 'account' || $bill->bill_module == ''): ?>
                                ...
                                <table class="table mb-0 pc-dt-simple" id="debit-note">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-dark"><?php echo e(__('Amount')); ?></th>
                                            <th class="text-dark"><?php echo e(__('Description')); ?></th>
                                            <?php if(Laratrust::hasPermission('debitnote edit') || Laratrust::hasPermission('debitnote delete')): ?>
                                                <th class="text-dark"><?php echo e(__('Action')); ?></th>
                                            <?php endif; ?>
                                        </tr>
                                    </thead>
                                ...
                                <div class="card-body table-border-style">
                                    <div class="table-responsive">
                                        <table class="table mb-0 pc-dt-simple" id="attachment">
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $bill_attachment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Account\src\Resources\views\bill\view.blade.php ENDPATH**/ ?>