        ...
        <div class="card-body p-3">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="form-check">
                    ...
                    data-payment-action="<?php echo e(route('coworking.pay.payment.with.stripe',[$slug])); ?>">
                </div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Stripe\src\Resources\views\payment\coworking_payment.blade.php ENDPATH**/ ?>