...
<?php $__env->startSection('page-action'); ?>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <a href="<?php echo e(route('churchly.events.show', $attendanceEvent->event_id)); ?>" class="btn btn-light btn-sm">
...
<?php $__env->startSection('content'); ?>
    <div class="zoom-join-page">
        <div class="card zoom-hero mb-4">
            <div class="card-body">
                <span class="zoom-eyebrow"><i class="ti ti-video"></i><?php echo e(__('Church Meeting Room')); ?></span>
                        ...
                        <div class="zoom-readiness <?php echo e($meetingSdkEnabled ? 'is-ready' : 'is-warn'); ?>">
                            ...
                            <div>
                                ...
                                <div class="zoom-actions-inline">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($meeting_link = $attendanceEvent->meeting_link): ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (! ($meetingSdkEnabled)): ?>
                                        <a href="<?php echo e(route('churchly.zoom.index')); ?>" class="btn btn-sm btn-light">
                                            <i class="ti ti-settings me-1"></i><?php echo e(__('Configure Zoom SDK')); ?>
                ...
                <div class="card zoom-room-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="zoom-note mt-3">
                            ...
                            <p><?php echo e(__('If this room cannot load because of SDK or browser restrictions, use the fallback Zoom link from the left panel while keeping event activity managed inside OPEN.')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            document.addEventListener('DOMContentLoaded', async function () {
                ...
                async function joinWithClientView(payload) {
                    ...
                    return await new Promise((resolve, reject) => {
                        ZoomMtg.init({
                            leaveUrl: <?php echo json_encode(route('churchly.events.show', $attendanceEvent->event_id), 512) ?>,
                            patchJsMedia: true,
                ...
                try {
                    ...
                    const response = await fetch(<?php echo json_encode(route('churchly.zoom.meetings.signature', $attendanceEvent->id), 512) ?>, {
                        method: 'POST',
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\integrations\zoom_join.blade.php ENDPATH**/ ?>