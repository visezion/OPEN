    ...
    <div class="card-body p-3 pb-0">
        <div class="row">
            <div class="col-xxl-4 col-sm-6">
                <div class="card">
                    <div class="card-header p-3">
                        <label class="paypal-label form-label mb-0 h6"><?php echo e(__('Paypal Mode')); ?></label>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Paypal\src\Resources\views\super-admin\settings\index.blade.php ENDPATH**/ ?>