...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(trim($__env->yieldContent('template_title'))): ?><?php echo $__env->yieldContent('template_title'); ?> | <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?> <?php echo e(trans('installer_messages.updater.title')); ?></title>
        ...
        <style>
            :root {
                --update-primary: <?php echo e($primary_color); ?>;
            ...
            <section class="update-grid">
                <div class="update-card">
                    <div class="update-main-head">
                        <p class="update-badge"><?php echo e(trans('installer_messages.updater.title')); ?></p>
                        <h1 class="update-title"><?php echo $__env->yieldContent('title'); ?></h1>
                        <p class="update-subtitle"><?php echo e(__('Run updates safely and keep your application stable with the latest database and package changes.')); ?></p>
                    </div>
                    <div class="update-steps">
                        <div class="update-step <?php echo e($is_welcome ? 'active' : ''); ?>">
                            <span class="update-step-index">1</span>
                            <span><?php echo e(__('Welcome')); ?></span>
                        </div>
                        <div class="update-step <?php echo e($is_overview ? 'active' : ''); ?>">
                            <span class="update-step-index">2</span>
                            <span><?php echo e(__('Overview')); ?></span>
                        </div>
                        <div class="update-step <?php echo e($is_final ? 'active' : ''); ?>">
                            <span class="update-step-index">3</span>
                            <span><?php echo e(__('Complete')); ?></span>
                        </div>
                    </div>
                    <div class="update-main-body">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('message')): ?>
                            <div class="update-alert success">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array(session('message')) && isset(session('message')['message'])): ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('errors') || $errors->any()): ?>
                            <div class="update-alert error">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('errors')): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = session('errors')->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <aside class="update-card update-aside">
                    <p class="update-brand"><?php echo e($brand_name); ?></p>
                    <h2 class="update-aside-title"><?php echo e(__('System Upgrade Console')); ?></h2>
                    <p class="update-aside-copy"><?php echo e(__('Apply pending updates to keep modules, migrations, and workspace features running smoothly.')); ?></p>
                    <ul class="update-checklist">
                        <li><?php echo e(__('Review pending updates before running migrations.')); ?></li>
                        <li><?php echo e(__('Keep a fresh backup of your database and uploads.')); ?></li>
                        <li><?php echo e(__('Do not close this window while update tasks are running.')); ?></li>
                    </ul>
                    <p class="update-env">
                        <?php echo e(__('Environment')); ?>: <strong><?php echo e(app()->environment()); ?></strong><br>
                        <?php echo e(__('Date')); ?>: <strong><?php echo e(now()->format('Y-m-d H:i')); ?></strong>
                    </p>
                </aside>
            </section>
        </main>
...
<?php /**PATH C:\xampp\htdocs\OPEN\resources\views/vendor/installer/layouts/master-update.blade.php ENDPATH**/ ?>