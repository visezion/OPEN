        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <form action="<?php echo e(route('discipleship.update', $stage->id)); ?>" method="POST">
                    ...
                    <div id="requirements">
                        <?php $__currentLoopData = $stage->requirements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\discipleship\edit.blade.php ENDPATH**/ ?>