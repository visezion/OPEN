...
<div class="row members-details-page">
    <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs mb-3" role="tablist">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($churchMeetEnabled): ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card p-3 mb-3 shadow-sm border-0">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($completion < 100): ?>
                                <ul class="mt-2 text-danger small">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $missingFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="card p-3 mb-3 shadow-sm border-0" >
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($member->departments && $member->departments->count()): ?>
                                <div class="list-group list-group-flush" >
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $member->departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="list-group-item border-0 px-0 mb-1">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div>
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dept->pivot && $dept->pivot->designation_id): ?>
                                            ...
                                            <div class="mt-2" >
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mates->count()): ?>
                                                    <div class="d-flex align-items-center">
                                                        <div style="margin-left:30px;"></div>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $mates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $mate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dept->members()->count() > 5): ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 mb-3">
                                <div class="card p-4 shadow-sm border-0 text-center h-100">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($birthdayCountdown !== null): ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($birthdayCountdown == 0): ?>
                            ...
                            <div class="col-md-12">
                                <div class="card p-3 shadow-sm border-0">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activities && $activities->count()): ?>
                                        <ul class="timeline list-unstyled small ps-3">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $activities->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $act): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="mb-2">
                ...
                <div class="card p-4 shadow-sm border-0">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($member->departments && $member->departments->count()): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $member->departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="mb-3">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalMates): ?>
                                            <div class="d-flex align-items-center mb-1">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $mates->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $mate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalMates > 5): ?>
                                                    <span class="rounded-circle bg-primary text-white small d-flex align-items-center justify-content-center border border-white"
                                                        style="width:35px; height:35px; margin-left:-10px;">
                    ...
                    <div class="col-md-9 d-flex align-items-center">
                            <div class="p-4 bg-light rounded shadow-sm">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($member->departments && $member->departments->count()): ?>
                                    <p class="small text-muted mb-3">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $member->departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dept->pivot?->designation_id): ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($member->spouse): ?>
                                    <p class="small text-muted mb-3">
    ...
    <div class="card p-3 shadow-sm border-0">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $member->departments ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="mb-4">
                ...
                <!-- Department Members -->
                <div class="row">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $dept->members ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="row g-3">
                        <div class="col-xl-3 col-md-6">
                            <div class="card p-3 shadow-sm border-0 h-100">
                                <div class="small text-muted"><?php echo e(__('Recorded Events')); ?></div>
                                <h3 class="mb-0"><?php echo e($attendanceStats['total']); ?></h3>
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-6">
                            <div class="card p-3 shadow-sm border-0 h-100">
                                <div class="small text-muted"><?php echo e(__('Present')); ?></div>
                                <h3 class="mb-0 text-success"><?php echo e($attendanceStats['present']); ?></h3>
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-6">
                            <div class="card p-3 shadow-sm border-0 h-100">
                                <div class="small text-muted"><?php echo e(__('Late / Absent')); ?></div>
                                <h3 class="mb-0 text-warning"><?php echo e($attendanceStats['late'] + $attendanceStats['absent']); ?></h3>
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-6">
                            <div class="card p-3 shadow-sm border-0 h-100">
                                <div class="small text-muted"><?php echo e(__('No Record Yet')); ?></div>
                                <h3 class="mb-0 text-secondary"><?php echo e($attendanceStats['no_record']); ?></h3>
                            </div>
                        </div>

                        <div class="col-lg-4">
                            <div class="card p-3 shadow-sm border-0 h-100">
                                <h6><?php echo e(__('Related Sessions Without Record')); ?></h6>
                                <div id="attendanceCalendar" class="d-grid gap-2">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $attendancePendingSessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendanceEntry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="border rounded p-3 bg-light">
                                            <div class="d-flex justify-content-between align-items-start gap-2">
                                                <div>
                                                    <div class="fw-semibold"><?php echo e($attendanceEntry->date_label); ?></div>
                                                    <div class="small text-muted"><?php echo e($attendanceEntry->title); ?></div>
                                                </div>
                                                <span class="badge <?php echo e($attendanceEntry->badge_class); ?>"><?php echo e($attendanceEntry->status_label); ?></span>
                                            </div>
                                            <div class="small text-muted mt-2">
                                                <?php echo e($attendanceEntry->scope_label); ?> · <?php echo e($attendanceEntry->mode_label); ?>

                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <p class="text-muted mb-0"><?php echo e(__('Every related session currently has a recorded attendance entry for this member.')); ?></p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-8">
                            <div class="card p-3 shadow-sm border-0 h-100">
                                <h6><?php echo e(__('Recorded Attendance Timeline')); ?></h6>
                                    ...
                                    <table class="table align-middle mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo e(__('Related By')); ?></th>
                                        ...
                                        <tbody>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $attendanceTimeline; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendanceEntry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <tr>
                                                    <td class="fw-semibold"><?php echo e($attendanceEntry->title); ?></td>
                                                    <td><?php echo e($attendanceEntry->date_label); ?></td>
                                                    <td><?php echo e($attendanceEntry->scope_label); ?></td>
                                                    <td><span class="badge <?php echo e($attendanceEntry->badge_class); ?>"><?php echo e($attendanceEntry->status_label); ?></span></td>
                                                    <td><?php echo e($attendanceEntry->check_in_label); ?></td>
                                                    <td><?php echo e($attendanceEntry->device_label); ?></td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                <tr>
                                                <td colspan="6" class="text-center text-muted py-4"><?php echo e(__('No attendance timeline is available for this member yet.')); ?></td>
                                            </tr>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </tbody>
                                </table>
        ...
        <div class="row">
                                ...
                                <ul class="text-muted small ps-3 mb-2">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $stage->requirements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <li>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($req->is_mandatory): ?> 
                                            ...
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($req->points): ?> 
                ...
                <div class="row g-3">
                    <div class="col-xl-6">
                        <div class="card shadow-sm border-0 h-100">
                            ...
                            <div class="card-body">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $households; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $household): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="border rounded p-3 mb-3">
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div>
                                                <strong><?php echo e($household->name); ?></strong>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($household->primaryContact && $household->primaryContact->id === $member->id): ?>
                                                    <span class="badge bg-primary ms-1"><?php echo e(__('Primary contact')); ?></span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($household->phone): ?>
                                                    <div class="small text-muted"><?php echo e($household->phone); ?></div>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($household->email): ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($household->members->isNotEmpty()): ?>
                                            <div class="mt-2 small text-muted">
                                                <?php echo e(__('Members:')); ?>

                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $household->members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $houseMember): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <span class="badge bg-light text-dark me-1 mb-1">
                                                        <?php echo e($houseMember->name); ?>

                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($houseMember->pivot && $houseMember->pivot->relationship): ?>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div class="input-group">
                                            <select class="form-select" name="household_id" required>
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $availableHouseholds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $availableHousehold): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-xl-6">
                        <div class="card shadow-sm border-0 h-100">
                            ...
                            <div class="card-body">
                                <form method="POST" action="<?php echo e(route('members.followups.store', $member->id)); ?>" class="row g-2 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="assigned_to" class="form-select">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $careTeamUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $careUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <hr class="my-3">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $memberFollowUps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $followUp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="border rounded p-3 mb-3">
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div>
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($followUp->due_at): ?>
                                                    <div class="small text-muted"><?php echo e(__('Due')); ?>: <?php echo e($followUp->due_at->format('M d, Y')); ?></div>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($followUp->assignee): ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($followUp->description): ?>
                                        ...
                                        <form method="POST" action="<?php echo e(route('members.followups.update', [$member->id, $followUp->id])); ?>" class="row g-2">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select name="status" class="form-select form-select-sm">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['open','in_progress','completed','cancelled']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="card shadow-sm border-0 h-100">
                            ...
                            <div class="card-body">
                                ...
                                <div class="list-group">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $memberNotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="col-xl-6">
                        <div class="card shadow-sm border-0 h-100">
                            ...
                            <div class="card-body">
                                ...
                                <div class="list-group">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $memberCommunications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $communication): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="list-group-item mb-2">
                                            <div class="d-flex justify-content-between align-items-start">
                                                <div>
                                                    <strong class="text-uppercase"><?php echo e(__($communication->channel)); ?></strong>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($communication->subject): ?>
                                                    ...
                                                    <div class="small text-muted">
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($communication->sender): ?>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($communication->body): ?>
                                ...
                                <p class="small text-muted">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lastContribution): ?>
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $member->smartTags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle">
                                ...
                                <tbody>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $availableSmartTags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $smartTag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <strong><?php echo e($smartTag->name); ?></strong>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($smartTag->description): ?>
                                            ...
                                            <td>
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($smartTag->id, $matchedTagIds)): ?>
            ...
            <div class="tab-pane fade" id="custom">
                <div class="card p-3 shadow-sm border-0">
                    ...
                    <div class="row">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $member->customValues ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $custom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Churchly\src\Resources\views\members\show.blade.php ENDPATH**/ ?>