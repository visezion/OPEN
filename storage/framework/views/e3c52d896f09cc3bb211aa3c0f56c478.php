...
<div class="row justify-content-center">
    <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <?php echo e(Form::open(['route' => array('report.quarterly.cashflow'), 'method' => 'GET', 'id' => 'quarterly_cashflow'])); ?>
                                ...
                                <ul class="nav nav-pills my-3" id="pills-tab" role="tablist">
                                    <li class="nav-item me-2">
                                        <a class="nav-link" id="pills-home-tab" data-bs-toggle="pill"
                                           href="<?php echo e(route('report.cash.flow')); ?>"
                                           onclick="window.location.href = '<?php echo e(route('report.cash.flow')); ?>'" role="tab"
                            ...
                            <div class="col-xl-9">
                                <div class="row justify-content-end align-items-center">
                                    ...
                                    <div class="col-auto mt-4">
                                        <a class="btn btn-sm btn-primary me-1" onclick="document.getElementById('quarterly_cashflow').submit(); return false;" data-bs-toggle="tooltip" title="<?php echo e(__('Apply')); ?>" data-original-title="<?php echo e(__('apply')); ?>">
...
<div id="printableArea1">
    <div class="row mt-1">
        <div class="col">
            <input type="hidden" value="<?php echo e(__('Quarterly Cashflow').' '.'Report of'.' '.$filter['startDateRange'].' to '.$filter['endDateRange']); ?>" id="filenames-quarterly">
                            ...
                            <div class="table-responsive mt-3 mb-3">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <?php $__currentLoopData = $four_month; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $month): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <?php $__currentLoopData = $RevenueTotal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $revenue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <td width="15%"><?php echo e(currency_format_with_sym(!empty($revenue) ?? '0.00')); ?></td>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </tr>
                                        <tr>

                                            <td width="25%" class="font-bold"><?php echo e(__('Invoice : ')); ?></td>
                                            <?php $__currentLoopData = $invoiceTotal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <?php $__currentLoopData = $paymentTotal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <td><?php echo e(currency_format_with_sym($payment)); ?></td>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </tr>
                                            <tr>
                                                <td width="20%" class="font-bold"><?php echo e(__('PaySlip')); ?></td>
                                                <?php $__currentLoopData = $paySlipTotal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$paySlip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <td><?php echo e(currency_format_with_sym($paySlip)); ?></td>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </tr>
                                            <tr>
                                                <td width="20%" class="font-bold"><?php echo e(__('Bill')); ?></td>
                                                <?php $__currentLoopData = $billTotal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$bill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\packages\workdo\Account\src\Resources\views\report\quarterly_cash_flow.blade.php ENDPATH**/ ?>