...
<?php endif; ?> <?php echo e(Form::select('work_order', $work_order, null, ['class' => 'form-control', 'required' => 'required'])); ?>`
    ...
    <?php if(module_is_active('Account') && $proposal->proposal_module == 'account'): ?>
        <script>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OPEN\resources\views\proposal\edit.blade.php ENDPATH**/ ?>