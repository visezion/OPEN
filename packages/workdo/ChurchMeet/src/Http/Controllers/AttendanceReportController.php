...
class AttendanceReportController extends Controller
{
    public function eventReport($attendanceEventId)
    {
        ...
        return view('churchmeet::attendance.reports.event_report', compact('attendanceEvent'));
    }
    ...
    public function memberReport($memberId)
    {
        ...
        return view('churchmeet::attendance.reports.member_report', compact('member'));
    }
    ...
    public function branchReport($branchId)
    {
        ...
        return view('churchmeet::attendance.reports.branch_report', compact('attendance'));
    }
    ...
    public function dashboard(Request $request)
    {
        ...
        return view('churchmeet::attendance.reports.dashboard', compact(
            'summary',
            'trend',
            'eventPerformance',
            'branchBreakdown',
