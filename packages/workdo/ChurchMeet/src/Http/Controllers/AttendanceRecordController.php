...
class AttendanceRecordController extends Controller
{
    ...
    public function searchMember(Request $request)
    {
        ...
        $members = \Workdo\ChurchMeet\Entities\ChurchMember::query()
    ...
    private function syncDiscipleshipProgress($memberId, $attendanceEventId)
    {
        ...
        $stageEvents = \Workdo\ChurchMeet\Entities\DiscipleshipStageEvent::where('event_id', $eventId)->get();

        foreach ($stageEvents as $stageEvent) {
            $progress = \Workdo\ChurchMeet\Entities\DiscipleshipMemberProgress::firstOrNew([
                'member_id' => $memberId,
