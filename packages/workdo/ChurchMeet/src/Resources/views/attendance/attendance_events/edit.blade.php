...
@section('page-action')
    <a href="{{ route('churchmeet.attendance_events.create') }}" class="btn btn-sm btn-outline-success">
    ...
    <div class="col-lg-9">
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body p-4">
                <form method="POST" action="{{ route('churchmeet.attendance_events.update', $attendanceEvent->id) }}">
                    @csrf
                    @method('PUT')
