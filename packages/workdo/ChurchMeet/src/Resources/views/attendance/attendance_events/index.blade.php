...
@section('page-action')
    <a href="{{ route('churchmeet.attendance_events.create') }}" class="btn btn-sm btn-primary">
                                ...
                                @foreach($attendanceEvents as $attendanceEvent)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a href="{{ route('churchmeet.attendance_events.show', $attendanceEvent->id) }}" 
                                                ...
                                                <form action="{{ route('churchmeet.attendance_events.destroy', $attendanceEvent->id) }}" 
                                                    method="POST" 
    ...
    <div class="col-lg-3 mt-4 mt-lg-0">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-light py-2 d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('churchmeet.attendance_events.index') }}" class="small text-muted">{{ __('View All') }}</a>
            </div>
