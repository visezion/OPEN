...
<div class="row">
  <div class="col-lg-6">
    <div class="card shadow-sm mb-3">
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('churchmeet.youtube.save') }}">@csrf
          <div class="mb-3">
  ...
  <div class="col-lg-6">
    <div class="card shadow-sm mb-3">
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ url('api/v1/churchmeet/youtube/videos') }}" target="_blank" class="btn btn-sm btn-outline-secondary">{{ __('Open API') }}</a>
      </div>
      <div class="card-body">
