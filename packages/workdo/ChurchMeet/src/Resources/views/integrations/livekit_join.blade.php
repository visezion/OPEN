...
@section('page-title', __('LiveKit Room'))

@section('page-breadcrumb')
    {{ __('ChurchMeet') }},{{ __('LiveKit Room') }}
@endsection
...
<style>
    ...
    .livekit-room {
        --room-bg: #ffffff;
        --panel-bg: #ffffff;
        --panel-soft: rgba({{ $brandRgbString }}, 0.05);
        --panel-muted: rgba({{ $brandRgbString }}, 0.08);
        --panel-border: rgba({{ $brandRgbString }}, 0.16);
        --text-main: #1f2937;
        --text-soft: #6b7280;
        --accent: {{ $brandPrimary }};
        --accent-soft: rgba({{ $brandRgbString }}, 0.12);
        --success: #20c997;
        --warning: #ffb54c;
        --danger: #ff5f63;
    ...
    .livekit-room-shell {
        ...
        border-radius: 14px;
        background: #ffffff;
        border: 1px solid rgba({{ $brandRgbString }}, 0.12);
        box-shadow: 0 20px 50px rgba({{ $brandRgbString }}, 0.08);
        padding: 1.6rem;
    }
    ...
    .brand-mark {
        ...
        background: rgba({{ $brandRgbString }}, 0.1);
        color: var(--accent);
        border: 1px solid rgba({{ $brandRgbString }}, 0.16);
        font-size: 1.15rem;
    }
    ...
    .meeting-avatar {
        ...
        border-radius: 10px;
        min-height: 48px;
        box-shadow: 0 10px 24px rgba({{ $brandRgbString }}, 0.06);
    }
    ...
    .meeting-pill-live {
        background: rgba({{ $brandRgbString }}, 0.1);
        border-color: rgba({{ $brandRgbString }}, 0.24);
    }
    ...
    .sidebar-card {
        ...
        box-shadow: 0 14px 34px rgba({{ $brandRgbString }}, 0.07);
    }
    ...
    .stage-shell {
        background: #ffffff;
        border-radius: 12px;
        border: 1px solid rgba({{ $brandRgbString }}, 0.1);
        padding: 0.9rem;
    }
    ...
    .stage-indicator {
        ...
        border-radius: 8px;
        border: 1px solid var(--panel-border);
        background: rgba({{ $brandRgbString }}, 0.08);
        color: var(--text-main);
        font-size: 0.9rem;
    }
    ...
    .livekit-room .stage {
        ...
        overflow: auto;
        border-radius: 10px;
        background: linear-gradient(180deg, rgba({{ $brandRgbString }}, 0.04), rgba(15, 23, 42, 0.03));
    }
    ...
    .participant-card {
        ...
        aspect-ratio: 16 / 9;
        box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.7), 0 10px 24px rgba({{ $brandRgbString }}, 0.05);
    }
    ...
    .participant-media {
        ...
        justify-content: center;
        padding: 1rem;
        background: rgba({{ $brandRgbString }}, 0.05);
    }
    ...
    .participant-pin-button:hover {
        ...
        border-color: rgba({{ $brandRgbString }}, 0.26);
    }
    ...
    .participant-card.is-pinned {
        box-shadow: 0 0 0 2px rgba({{ $brandRgbString }}, 0.18), 0 20px 42px rgba({{ $brandRgbString }}, 0.12);
    }
    ...
    .stage-dots span {
        ...
        height: 7px;
        border-radius: 50%;
        background: rgba({{ $brandRgbString }}, 0.2);
    }

    .stage-dots span.is-active {
        width: 24px;
        border-radius: 999px;
        background: rgba({{ $brandRgbString }}, 0.75);
    }
    ...
    .meeting-control:hover:not(:disabled) {
        transform: translateY(-1px);
        border-color: rgba({{ $brandRgbString }}, 0.28);
    }
    ...
    .sidebar-live-pill {
        ...
        background: rgba({{ $brandRgbString }}, 0.08);
        color: var(--accent);
        border: 1px solid rgba({{ $brandRgbString }}, 0.14);
        font-size: 0.8rem;
        font-weight: 600;
    }
    ...
    .sidebar-tab-badge {
        ...
        justify-content: center;
        border-radius: 999px;
        background: rgba({{ $brandRgbString }}, 0.12);
        color: var(--accent);
        font-size: 0.72rem;
        font-weight: 700;
    }
    ...
    .chat-bubble {
        ...
        font-size: 0.86rem;
        line-height: 1.5;
        box-shadow: 0 8px 18px rgba({{ $brandRgbString }}, 0.04);
    }
    ...
    .chat-bubble.is-private {
        border-style: dashed;
        background: rgba({{ $brandRgbString }}, 0.04);
    }
    ...
    .chat-empty {
        ...
        min-height: 240px;
        color: var(--text-soft);
        border: 1px dashed rgba({{ $brandRgbString }}, 0.18);
        border-radius: 10px;
        background: rgba({{ $brandRgbString }}, 0.03);
        padding: 1rem;
    }
    ...
    .compose-chip {
        ...
        color: var(--accent);
        font-size: 0.78rem;
        border: 1px solid rgba({{ $brandRgbString }}, 0.22);
    }
    ...
    .compose-input-control:focus {
        border-color: rgba({{ $brandRgbString }}, 0.4);
        box-shadow: 0 0 0 3px rgba({{ $brandRgbString }}, 0.12);
    }
    ...
    <div class="livekit-room-shell">
        <div class="meeting-topbar">
            ...
            <div class="meeting-status-cluster">
                ...
                <a href="{{ route('churchmeet.events.show', $attendanceEvent->event_id) }}" class="meeting-pill text-decoration-none">
                    <i class="ti ti-external-link"></i>
                    <span>{{ __('Open Event') }}</span>
                </a>

                <div class="meeting-avatar">{{ $participantBadge ?: 'LK' }}</div>
            </div>
        </div>
        ...
        <div class="meeting-layout">
                    ...
                    <div>
                        <div class="meta-tags">
                            <span class="meta-tag">
                                ...
                                <span id="room-short-name">{{ \Illuminate\Support\Str::limit($livekitRoomName, 18, '...') }}</span>
                            </span>
                            <span class="meta-tag">
                        ...
                        <h3 class="mt-3">{{ __('Meeting Stage') }}</h3>
                        <p>{{ __('Live tiles with quick controls below.') }}</p>
                    </div>

                    <div class="meta-stats">
                        <div class="meta-stat">
                            <span>{{ __('Attendance') }}</span>
                            <strong id="attendance-percent">{{ __('Pending') }}</strong>
                        </div>
                        <div class="meta-stat">
                        ...
                        <div class="participant-grid" id="participant-grid">
                            <div class="participant-card" data-participant="placeholder">
                                ...
                                <div class="participant-footer">
                                    ...
                                    <span class="participant-chip">{{ __('Lobby') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="stage-footer">
                    ...
                    <div class="control-dock">
                        ...
                        <button type="button" class="meeting-control" id="toggle-sidebar">
                            ...
                            <span class="control-label">{{ __('Hide Sidebar') }}</span>
                        </button>
            ...
            <aside class="sidebar-panel">
                ...
                <div class="sidebar-card sidebar-card-compact">
                    <div class="sidebar-note">{{ __('Session overview') }}</div>

                    <div class="sidebar-stats">
                        <div class="sidebar-stat">
                            <span>{{ __('In Room') }}</span>
                        ...
                        <div class="sidebar-stat">
                            <span>{{ __('Room') }}</span>
                            <strong>{{ \Illuminate\Support\Str::limit($livekitRoomName, 14, '...') }}</strong>
                        </div>
                        <div class="sidebar-stat">
                            <span>{{ __('Mode') }}</span>
                    ...
                    <p class="sidebar-note mb-0">{{ __('Presence is tracked automatically while the room is connected.') }}</p>
                </div>
            </aside>
        </div>
    </div>
...
const presenceUrl = @json(route('churchmeet.meetings.presence', $attendanceEvent->id));
