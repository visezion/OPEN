...
@section('page-title', __('Create Church Member'))
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group mb-3 text-center">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-primary" onclick="document.getElementById('profile-photo-input').click()">
                                <i class="ti ti-upload"></i> {{ __('Choose Photo') }}
                            </button>
                        ...
                        <div class="form-group mb-3">
                            ...
                            {{ Form::date('dob', null, ['class' => 'form-control', 'max' => date('Y-m-d')]) }}
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group mb-3">
                            {{ Form::label('emergency_phone', __('Emergency Contact Phone Number')) }}<x-required />
                        ...
                        <div class="form-group mb-3">
                            ...
                            {{ Form::select('family_id', $members, null, [
                                'class'=>'form-control',
                        ...
                        <div class="form-group mb-3">
                            ...
                            {{ Form::select('spouse_id', $members, null, [
                                'class'=>'form-control',
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group mb-3">
                            ...
                            {{ Form::select('membership_status', ['Active'=>'Active','Inactive'=>'Inactive','Visitor'=>'Visitor','New Convert'=>'New Convert'], 'Active', ['class'=>'form-control']) }}
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            {{ Form::select('role', $role, null, ['class'=>'form-control','required','placeholder'=>'Select Role']) }}
                        </div>
                        <div class="form-group mb-3">
                            {{ Form::label('church_doj', __('Date of Joining')) }}
                            {{ Form::date('church_doj', now()->toDateString(), ['class'=>'form-control','max'=>date('Y-m-d')]) }}
                        </div>
                        <div class="form-group mb-3">
                            {{ Form::label('is_active', __('Account Status')) }}
                            {{ Form::select('is_active', ['1'=>'Active','0'=>'Inactive'], '1', ['class'=>'form-control']) }}
                        </div>
                    </div>
                            ...
                            @foreach($customFields as $field)
                                <div class="col-md-4 mb-3">
                                    ...
                                    @if($field->field_type == 'text')
                                        {{ Form::text("custom[{$field->field_key}]", null, ['class'=>'form-control']) }}
                                    @elseif($field->field_type == 'textarea')
                                        {{ Form::textarea("custom[{$field->field_key}]", null, ['class'=>'form-control','rows'=>2]) }}
                                    @elseif($field->field_type == 'date')
                                        {{ Form::date("custom[{$field->field_key}]", null, ['class'=>'form-control']) }}
                                    ...
                                    @elseif($field->field_type == 'checkbox')
                                        <div class="form-check">
                                            <input type="checkbox" name="custom[{{ $field->field_key }}]" value="1" class="form-check-input">
                ...
                <div class="d-flex justify-content-between mt-4">
                    ...
                    <button type="submit" class="btn btn-primary">{{ __('Create Member') }}</button>
                </div>
