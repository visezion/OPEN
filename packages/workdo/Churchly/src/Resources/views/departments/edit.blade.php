                ...
                {{ Form::model($department, ['route' => ['churchly.departments.update', $department->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) }}
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group mb-3">
                            ...
                            {{ Form::select('branch_id', $branches, null, ['class' => 'form-control select', 'required']) }}
                        </div>
                    </div>
                </div>
            </div>
