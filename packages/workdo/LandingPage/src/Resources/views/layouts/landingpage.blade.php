...
<head>
    ...
    <meta name="title" content="{{ !empty($settings['meta_title']) ? $settings['meta_title'] : config('app.name', 'Openzion') }}">
    <meta name="keywords" content="{{ !empty($settings['meta_keywords']) ? $settings['meta_keywords'] : 'ministry platform,church operations,faith teams' }}">
    <meta name="description" content="{{ !empty($settings['meta_description']) ? $settings['meta_description'] : 'Faith-aligned platform for church administration, ministry teams, and accountable service workflows.'}}">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ env('APP_URL') }}">
    <meta property="og:title" content="{{ !empty($settings['meta_title']) ? $settings['meta_title'] : config('app.name', 'Openzion') }}">
    <meta property="og:description" content="{{ !empty($settings['meta_description']) ? $settings['meta_description'] : 'Faith-aligned platform for church administration, ministry teams, and accountable service workflows.'}} ">
    ...
    <meta property="twitter:title" content="{{ !empty($settings['meta_title']) ? $settings['meta_title'] : config('app.name', 'Openzion') }}">
    <meta property="twitter:description" content="{{ !empty($settings['meta_description']) ? $settings['meta_description'] : 'Faith-aligned platform for church administration, ministry teams, and accountable service workflows.'}} ">
