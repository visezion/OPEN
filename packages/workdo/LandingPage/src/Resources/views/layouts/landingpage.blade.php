                        ...
                        <div class="row row-gap align-items-center">
                            <div class="col-md-6 col-12">
                                <div class="banner-content">
                                    ...
                                    <p style="font-size: 20px;">{{ $settings['home_description'] }}</p><br>
                                    <div class="btn-group">
                                        <a href="{{ route('apps.pricing') }}" class="btn">{{ __('GET STARTED')}} <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <a href="{{ $settings['home_live_demo_link'] }}" style="color:#fff" class="link-btn">{{ $settings['home_link_button_text']}} <svg xmlns="http://www.w3.org/2000/svg"
                                                width="20" height="20" viewBox="0 0 20 20" fill="#ffffffff">
                            ...
                            <div class="image-wrapper">
                                ...
                                <div class="banner-img-wrapper">
                                    ...
                                    <div style="
                                        ...
                                        margin-right: 40px; ">
                                        <video 
                                        src="https://s41008.pcdn.co/wp-content/uploads/2024/02/staqroll1.mp4" 
                                        autoplay 
                                        loop 
                                        muted 
                                        playsinline 
                                        preload="metadata" 
                                        poster="" 
                                        style="border-radius: 25px; height: 420px; width: auto;"
                                        class="main-banner">
                                        </video>
                                    </div>
