...
<head>
    ...
    <title>{{ config('app.name', 'Openzion') }} - {{ __('Public Portal') }}</title>
    ...
    <style>
        :root {
            ...
            --portal-primary-rgb: {{ $primaryRgbString }};
    ...
    <div class="workspace-portal-wrap">
        <div class="workspace-portal-shell">
            <aside class="workspace-portal-aside">
                <a href="{{ $workspaceLink }}" class="workspace-logo-wrap" title="{{ $workspaceName }}">
                    <img src="{{ $logoUrl }}" alt="{{ $workspaceName }}">
                </a>
                <span class="workspace-badge">{{ __('Workspace Portal') }}</span>
                <h1 class="workspace-title">{{ $workspaceName }}</h1>
                <p class="workspace-subtitle">{{ $workspaceDescription }}</p>
                <ul class="workspace-feature-list">
                    <li>{{ __('Secure public forms') }}</li>
                    <li>{{ __('Workspace-branded experience') }}</li>
                    <li>{{ __('Clear communication with your team') }}</li>
                </ul>
            </aside>
